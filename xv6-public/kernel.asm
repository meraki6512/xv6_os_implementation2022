...
80100048:	bb 54 b6 10 80       	mov    $0x8010b654,%ebx
{
8010004d:	83 ec 0c             	sub    $0xc,%esp
  initlock(&bcache.lock, "bcache");
80100050:	68 e0 72 10 80       	push   $0x801072e0
80100055:	68 20 b6 10 80       	push   $0x8010b620
8010005a:	e8 d1 44 00 00       	call   80104530 <initlock>
  bcache.head.next = &bcache.head;
8010005f:	83 c4 10             	add    $0x10,%esp
80100062:	b8 1c fd 10 80       	mov    $0x8010fd1c,%eax
  bcache.head.prev = &bcache.head;
80100067:	c7 05 6c fd 10 80 1c 	movl   $0x8010fd1c,0x8010fd6c
8010006e:	fd 10 80 
  bcache.head.next = &bcache.head;
80100071:	c7 05 70 fd 10 80 1c 	movl   $0x8010fd1c,0x8010fd70
80100078:	fd 10 80 
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
...
801000b0:	89 1d 70 fd 10 80    	mov    %ebx,0x8010fd70
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
801000b6:	81 fb c0 fa 10 80    	cmp    $0x8010fac0,%ebx
...
801000e0:	8b 75 0c             	mov    0xc(%ebp),%esi
  acquire(&bcache.lock);
801000e3:	68 20 b6 10 80       	push   $0x8010b620
801000e8:	e8 c3 45 00 00       	call   801046b0 <acquire>
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
801000ed:	8b 1d 70 fd 10 80    	mov    0x8010fd70,%ebx
801000f3:	83 c4 10             	add    $0x10,%esp
801000f6:	81 fb 1c fd 10 80    	cmp    $0x8010fd1c,%ebx
...
80100213:	e8 78 42 00 00       	call   80104490 <releasesleep>
  ...
  acquire(&bcache.lock);
80100218:	c7 04 24 20 b6 10 80 	movl   $0x8010b620,(%esp)
...
80100243:	89 50 54             	mov    %edx,0x54(%eax)
    b->next = bcache.head.next;
80100246:	a1 70 fd 10 80       	mov    0x8010fd70,%eax
    b->prev = &bcache.head;
8010024b:	c7 43 50 1c fd 10 80 	movl   $0x8010fd1c,0x50(%ebx)
    b->next = bcache.head.next;
80100252:	89 43 54             	mov    %eax,0x54(%ebx)
    bcache.head.next->prev = b;
80100255:	a1 70 fd 10 80       	mov    0x8010fd70,%eax
8010025a:	89 58 50             	mov    %ebx,0x50(%eax)
    bcache.head.next = b;
8010025d:	89 1d 70 fd 10 80    	mov    %ebx,0x8010fd70
  }
  
  release(&bcache.lock);
80100263:	c7 45 08 20 b6 10 80 	movl   $0x8010b620,0x8(%ebp)
}
...
801002a5:	e8 96 15 00 00       	call   80101840 <iunlock>
  acquire(&cons.lock);
801002aa:	c7 04 24 80 a5 10 80 	movl   $0x8010a580,(%esp)
...
801002c6:	a1 00 00 11 80       	mov    0x80110000,%eax
801002cb:	3b 05 04 00 11 80    	cmp    0x80110004,%eax
801002d1:	74 27                	je     801002fa <consoleread+0x6a>
801002d3:	eb 5b                	jmp    80100330 <consoleread+0xa0>
801002d5:	8d 76 00             	lea    0x0(%esi),%esi
      sleep(&input.r, &cons.lock);
801002d8:	83 ec 08             	sub    $0x8,%esp
801002db:	68 80 a5 10 80       	push   $0x8010a580
801002e0:	68 00 00 11 80       	push   $0x80110000
801002e5:	e8 16 3d 00 00       	call   80104000 <sleep>
    while(input.r == input.w){
801002ea:	a1 00 00 11 80       	mov    0x80110000,%eax
801002ef:	83 c4 10             	add    $0x10,%esp
801002f2:	3b 05 04 00 11 80    	cmp    0x80110004,%eax
...
80100309:	68 80 a5 10 80       	push   $0x8010a580
...
80100333:	89 15 00 00 11 80    	mov    %edx,0x80110000
80100339:	89 c2                	mov    %eax,%edx
8010033b:	83 e2 7f             	and    $0x7f,%edx
8010033e:	0f be 8a 80 ff 10 80 	movsbl -0x7fef0080(%edx),%ecx
    if(c == C('D')){  // EOF
...
80100360:	68 80 a5 10 80       	push   $0x8010a580
...
80100384:	73 d7                	jae    8010035d <consoleread+0xcd>
        input.r--;
80100386:	a3 00 00 11 80       	mov    %eax,0x80110000
...
8010039c:	fa                   	cli    
  cons.locking = 0;
8010039d:	c7 05 b4 a5 10 80 00 	movl   $0x0,0x8010a5b4
801003a4:	00 00 00 
  getcallerpcs(&s, pcs);
...
801003fd:	c7 05 b8 a5 10 80 01 	movl   $0x1,0x8010a5b8
80100404:	00 00 00 
  for(;;)
...
80100600:	0f be c2             	movsbl %dl,%eax
  if(panicked){
80100603:	8b 15 b8 a5 10 80    	mov    0x8010a5b8,%edx
...
80100653:	e8 e8 11 00 00       	call   80101840 <iunlock>
  acquire(&cons.lock);
80100658:	c7 04 24 80 a5 10 80 	movl   $0x8010a580,(%esp)
...
8010066e:	8d 34 1f             	lea    (%edi,%ebx,1),%esi
  if(panicked){
80100671:	8b 15 b8 a5 10 80    	mov    0x8010a5b8,%edx
...
80100692:	68 80 a5 10 80       	push   $0x8010a580
...
801006bd:	a1 b4 a5 10 80       	mov    0x8010a5b4,%eax
...
801006ea:	74 44                	je     80100730 <cprintf+0x80>
  if(panicked){
801006ec:	8b 0d b8 a5 10 80    	mov    0x8010a5b8,%ecx
...
80100782:	b8 28 00 00 00       	mov    $0x28,%eax
  if(panicked){
80100787:	8b 15 b8 a5 10 80    	mov    0x8010a5b8,%edx
...
801007b8:	68 80 a5 10 80       	push   $0x8010a580
...
801007db:	e9 2a ff ff ff       	jmp    8010070a <cprintf+0x5a>
  if(panicked){
801007e0:	8b 3d b8 a5 10 80    	mov    0x8010a5b8,%edi
...
801007f1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(panicked){
801007f8:	8b 0d b8 a5 10 80    	mov    0x8010a5b8,%ecx
...
8010080d:	e8 fe fb ff ff       	call   80100410 <consputc.part.0>
  if(panicked){
80100812:	8b 15 b8 a5 10 80    	mov    0x8010a5b8,%edx
...
8010086f:	8b 7d 08             	mov    0x8(%ebp),%edi
  acquire(&cons.lock);
80100872:	68 80 a5 10 80       	push   $0x8010a580
...
801008b4:	a1 08 00 11 80       	mov    0x80110008,%eax
801008b9:	89 c2                	mov    %eax,%edx
801008bb:	2b 15 00 00 11 80    	sub    0x80110000,%edx
801008c1:	83 fa 7f             	cmp    $0x7f,%edx
801008c4:	77 d2                	ja     80100898 <consoleintr+0x38>
        c = (c == '\r') ? '\n' : c;
801008c6:	8d 48 01             	lea    0x1(%eax),%ecx
801008c9:	8b 15 b8 a5 10 80    	mov    0x8010a5b8,%edx
801008cf:	83 e0 7f             	and    $0x7f,%eax
        input.buf[input.e++ % INPUT_BUF] = c;
801008d2:	89 0d 08 00 11 80    	mov    %ecx,0x80110008
        c = (c == '\r') ? '\n' : c;
801008d8:	83 fb 0d             	cmp    $0xd,%ebx
801008db:	0f 84 02 01 00 00    	je     801009e3 <consoleintr+0x183>
        input.buf[input.e++ % INPUT_BUF] = c;
801008e1:	88 98 80 ff 10 80    	mov    %bl,-0x7fef0080(%eax)
  if(panicked){
...
80100908:	a1 00 00 11 80       	mov    0x80110000,%eax
8010090d:	83 e8 80             	sub    $0xffffff80,%eax
80100910:	39 05 08 00 11 80    	cmp    %eax,0x80110008
80100916:	75 80                	jne    80100898 <consoleintr+0x38>
80100918:	e9 f6 00 00 00       	jmp    80100a13 <consoleintr+0x1b3>
8010091d:	8d 76 00             	lea    0x0(%esi),%esi
      while(input.e != input.w &&
80100920:	a1 08 00 11 80       	mov    0x80110008,%eax
80100925:	39 05 04 00 11 80    	cmp    %eax,0x80110004
...
80100936:	83 e2 7f             	and    $0x7f,%edx
      while(input.e != input.w &&
80100939:	80 ba 80 ff 10 80 0a 	cmpb   $0xa,-0x7fef0080(%edx)
80100940:	0f 84 52 ff ff ff    	je     80100898 <consoleintr+0x38>
  if(panicked){
80100946:	8b 15 b8 a5 10 80    	mov    0x8010a5b8,%edx
        input.e--;
8010094c:	a3 08 00 11 80       	mov    %eax,0x80110008
  if(panicked){
...
80100965:	e8 a6 fa ff ff       	call   80100410 <consputc.part.0>
      while(input.e != input.w &&
8010096a:	a1 08 00 11 80       	mov    0x80110008,%eax
8010096f:	3b 05 04 00 11 80    	cmp    0x80110004,%eax
80100975:	75 ba                	jne    80100931 <consoleintr+0xd1>
80100977:	e9 1c ff ff ff       	jmp    80100898 <consoleintr+0x38>
8010097c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      if(input.e != input.w){
80100980:	a1 08 00 11 80       	mov    0x80110008,%eax
80100985:	3b 05 04 00 11 80    	cmp    0x80110004,%eax
8010098b:	0f 84 07 ff ff ff    	je     80100898 <consoleintr+0x38>
        input.e--;
80100991:	83 e8 01             	sub    $0x1,%eax
80100994:	a3 08 00 11 80       	mov    %eax,0x80110008
  if(panicked){
80100999:	a1 b8 a5 10 80       	mov    0x8010a5b8,%eax
...
801009ca:	68 80 a5 10 80       	push   $0x8010a580
...
801009e2:	c3                   	ret    
        input.buf[input.e++ % INPUT_BUF] = c;
801009e3:	c6 80 80 ff 10 80 0a 	movb   $0xa,-0x7fef0080(%eax)
  if(panicked){
...
801009ff:	e9 bc 38 00 00       	jmp    801042c0 <procdump>
80100a04:	b8 0a 00 00 00       	mov    $0xa,%eax
80100a09:	e8 02 fa ff ff       	call   80100410 <consputc.part.0>
        if(c == '\n' || c == C('D') || input.e == input.r+INPUT_BUF){
80100a0e:	a1 08 00 11 80       	mov    0x80110008,%eax
          wakeup(&input.r);
80100a13:	83 ec 0c             	sub    $0xc,%esp
          input.w = input.e;
80100a16:	a3 04 00 11 80       	mov    %eax,0x80110004
          wakeup(&input.r);
80100a1b:	68 00 00 11 80       	push   $0x80110000
80100a20:	e8 9b 37 00 00       	call   801041c0 <wakeup>
...
80100a3f:	68 80 a5 10 80       	push   $0x8010a580
...
80100a4d:	6a 01                	push   $0x1
  devsw[CONSOLE].write = consolewrite;
80100a4f:	c7 05 cc 09 11 80 40 	movl   $0x80100640,0x801109cc
80100a56:	06 10 80 
  devsw[CONSOLE].read = consoleread;
80100a59:	c7 05 c8 09 11 80 90 	movl   $0x80100290,0x801109c8
80100a60:	02 10 80 
  cons.locking = 1;
80100a63:	c7 05 b4 a5 10 80 01 	movl   $0x1,0x8010a5b4
80100a6a:	00 00 00 
  ioapicenable(IRQ_KBD, 0);
...
80100b0a:	75 ce                	jne    80100ada <exec+0x5a>
  if((pgdir = setupkvm()) == 0)
80100b0c:	e8 2f 65 00 00       	call   80107040 <setupkvm>
...
80100b73:	e8 e8 62 00 00       	call   80106e60 <allocuvm>
...
80100ba9:	e8 e2 61 00 00       	call   80106d90 <loaduvm>
...
80100beb:	e8 d0 63 00 00       	call   80106fc0 <freevm>
  if(ip){
...
80100c32:	e8 29 62 00 00       	call   80106e60 <allocuvm>
...
80100c51:	31 ff                	xor    %edi,%edi
  clearpteu(pgdir, (char*)(sz - 2*PGSIZE));
80100c53:	e8 88 64 00 00       	call   801070e0 <clearpteu>
  for(argc = 0; argv[argc]; argc++) {
...
80100cc7:	e8 74 65 00 00       	call   80107240 <copyout>
...
80100ce1:	e8 da 62 00 00       	call   80106fc0 <freevm>
...
80100d2d:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100d33:	e8 08 65 00 00       	call   80107240 <copyout>
...
80100d9d:	e8 5e 5e 00 00       	call   80106c00 <switchuvm>
  freevm(oldpgdir);
80100da2:	89 3c 24             	mov    %edi,(%esp)
80100da5:	e8 16 62 00 00       	call   80106fc0 <freevm>
  return 0;
...
80100def:	68 20 00 11 80       	push   $0x80110020
...
80100e08:	bb 54 00 11 80       	mov    $0x80110054,%ebx
{
80100e0d:	83 ec 10             	sub    $0x10,%esp
  acquire(&ftable.lock);
80100e10:	68 20 00 11 80       	push   $0x80110020
...
80100e23:	81 fb b4 09 11 80    	cmp    $0x801109b4,%ebx
...
80100e53:	31 db                	xor    %ebx,%ebx
  release(&ftable.lock);
80100e55:	68 20 00 11 80       	push   $0x80110020
...
80100e7b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ftable.lock);
80100e7e:	68 20 00 11 80       	push   $0x80110020
...
80100e98:	89 43 04             	mov    %eax,0x4(%ebx)
  release(&ftable.lock);
80100e9b:	68 20 00 11 80       	push   $0x80110020
...
80100ecd:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&ftable.lock);
80100ed0:	68 20 00 11 80       	push   $0x80110020
...
80100f05:	8b 43 10             	mov    0x10(%ebx),%eax
  release(&ftable.lock);
80100f08:	68 20 00 11 80       	push   $0x80110020
  ff = *f;
...
80100f2a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    release(&ftable.lock);
80100f30:	c7 45 08 20 00 11 80 	movl   $0x80110020,0x8(%ebp)
}
...
801011b8:	03 05 38 0a 11 80    	add    0x80110a38,%eax
{
...
80101239:	8b 0d 20 0a 11 80    	mov    0x80110a20,%ecx
{
...
8010125c:	03 05 38 0a 11 80    	add    0x80110a38,%eax
...
80101271:	a1 20 0a 11 80       	mov    0x80110a20,%eax
...
801012c9:	39 05 20 0a 11 80    	cmp    %eax,0x80110a20
...
80101315:	e8 a6 34 00 00       	call   801047c0 <memset>
  log_write(bp);
...
8010134a:	bb 74 0a 11 80       	mov    $0x80110a74,%ebx
{
8010134f:	83 ec 28             	sub    $0x28,%esp
80101352:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  acquire(&icache.lock);
80101355:	68 40 0a 11 80       	push   $0x80110a40
8010135a:	e8 51 33 00 00       	call   801046b0 <acquire>
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
...
80101374:	81 c3 90 00 00 00    	add    $0x90,%ebx
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
8010137a:	81 fb 94 26 11 80    	cmp    $0x80112694,%ebx
...
80101399:	89 c6                	mov    %eax,%esi
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
8010139b:	81 fb 94 26 11 80    	cmp    $0x80112694,%ebx
...
801013bb:	c7 46 4c 00 00 00 00 	movl   $0x0,0x4c(%esi)
  release(&icache.lock);
801013c2:	68 40 0a 11 80       	push   $0x80110a40
801013c7:	e8 a4 33 00 00       	call   80104770 <release>
...
801013eb:	89 de                	mov    %ebx,%esi
      release(&icache.lock);
801013ed:	68 40 0a 11 80       	push   $0x80110a40
      ip->ref++;
801013f2:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
801013f5:	e8 76 33 00 00       	call   80104770 <release>
      return ip;
...
80101406:	c3                   	ret    
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
80101407:	81 fb 94 26 11 80    	cmp    $0x80112694,%ebx
...
80101525:	e8 36 33 00 00       	call   80104860 <memmove>
  brelse(bp);
...
80101548:	bb 80 0a 11 80       	mov    $0x80110a80,%ebx
8010154d:	83 ec 0c             	sub    $0xc,%esp
  initlock(&icache.lock, "icache");
80101550:	68 eb 73 10 80       	push   $0x801073eb
80101555:	68 40 0a 11 80       	push   $0x80110a40
...
8010157f:	81 fb a0 26 11 80    	cmp    $0x801126a0,%ebx
80101585:	75 e1                	jne    80101568 <iinit+0x28>
  readsb(dev, &sb);
80101587:	83 ec 08             	sub    $0x8,%esp
8010158a:	68 20 0a 11 80       	push   $0x80110a20
8010158f:	ff 75 08             	pushl  0x8(%ebp)
80101592:	e8 69 ff ff ff       	call   80101500 <readsb>
  cprintf("sb: size %d nblocks %d ninodes %d nlog %d logstart %d\
80101597:	ff 35 38 0a 11 80    	pushl  0x80110a38
8010159d:	ff 35 34 0a 11 80    	pushl  0x80110a34
801015a3:	ff 35 30 0a 11 80    	pushl  0x80110a30
801015a9:	ff 35 2c 0a 11 80    	pushl  0x80110a2c
801015af:	ff 35 28 0a 11 80    	pushl  0x80110a28
801015b5:	ff 35 24 0a 11 80    	pushl  0x80110a24
801015bb:	ff 35 20 0a 11 80    	pushl  0x80110a20
...
801015f0:	83 3d 28 0a 11 80 01 	cmpl   $0x1,0x80110a28
{
...
8010161f:	3b 3d 28 0a 11 80    	cmp    0x80110a28,%edi
...
801016b8:	03 05 34 0a 11 80    	add    0x80110a34,%eax
...
8010173b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&icache.lock);
8010173e:	68 40 0a 11 80       	push   $0x80110a40
80101743:	e8 68 2f 00 00       	call   801046b0 <acquire>
  ip->ref++;
80101748:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
8010174c:	c7 04 24 40 0a 11 80 	movl   $0x80110a40,(%esp)
...
801017a9:	03 05 34 0a 11 80    	add    0x80110a34,%eax
...
801018be:	e8 cd 2b 00 00       	call   80104490 <releasesleep>
  acquire(&icache.lock);
801018c3:	c7 04 24 40 0a 11 80 	movl   $0x80110a40,(%esp)
801018ca:	e8 e1 2d 00 00       	call   801046b0 <acquire>
  ip->ref--;
801018cf:	83 6b 08 01          	subl   $0x1,0x8(%ebx)
  release(&icache.lock);
801018d3:	83 c4 10             	add    $0x10,%esp
801018d6:	c7 45 08 40 0a 11 80 	movl   $0x80110a40,0x8(%ebp)
}
...
801018f3:	68 40 0a 11 80       	push   $0x80110a40
801018f8:	e8 b3 2d 00 00       	call   801046b0 <acquire>
    int r = ip->ref;
801018fd:	8b 73 08             	mov    0x8(%ebx),%esi
    release(&icache.lock);
80101900:	c7 04 24 40 0a 11 80 	movl   $0x80110a40,(%esp)
...
80101b3a:	8b 04 c5 c0 09 11 80 	mov    -0x7feef640(,%eax,8),%eax
...
80101c4a:	8b 04 c5 c4 09 11 80 	mov    -0x7feef63c(,%eax,8),%eax
...
80101d94:	8b 70 68             	mov    0x68(%eax),%esi
  acquire(&icache.lock);
80101d97:	68 40 0a 11 80       	push   $0x80110a40
80101d9c:	e8 0f 29 00 00       	call   801046b0 <acquire>
  ip->ref++;
80101da1:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101da5:	c7 04 24 40 0a 11 80 	movl   $0x80110a40,(%esp)
...
8010215f:	68 e0 a5 10 80       	push   $0x8010a5e0
80102164:	e8 c7 23 00 00       	call   80104530 <initlock>
  ioapicenable(IRQ_IDE, ncpu - 1);
80102169:	58                   	pop    %eax
8010216a:	a1 60 2d 11 80       	mov    0x80112d60,%eax
8010216f:	5a                   	pop    %edx
...
801021b8:	74 f6                	je     801021b0 <ideinit+0x60>
      havedisk1 = 1;
801021ba:	c7 05 c0 a5 10 80 01 	movl   $0x1,0x8010a5c0
801021c1:	00 00 00 
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
...
801021ea:	83 ec 18             	sub    $0x18,%esp
  ...
  acquire(&idelock);
801021ed:	68 e0 a5 10 80       	push   $0x8010a5e0
801021f2:	e8 b9 24 00 00       	call   801046b0 <acquire>

  if((b = idequeue) == 0){
801021f7:	8b 1d c4 a5 10 80    	mov    0x8010a5c4,%ebx
...
80102207:	a3 c4 a5 10 80       	mov    %eax,0x8010a5c4
...
8010224d:	e8 6e 1f 00 00       	call   801041c0 <wakeup>

  // Start disk on next buf in queue.
  if(idequeue != 0)
80102252:	a1 c4 a5 10 80       	mov    0x8010a5c4,%eax
...
80102266:	68 e0 a5 10 80       	push   $0x8010a5e0
...
801022b7:	a1 c0 a5 10 80       	mov    0x8010a5c0,%eax
...
801022c7:	68 e0 a5 10 80       	push   $0x8010a5e0
801022cc:	e8 df 23 00 00       	call   801046b0 <acquire>

  // Append b to idequeue.
  b->qnext = 0;
  for(pp=&idequeue; *pp; pp=&(*pp)->qnext)  //DOC:insert-queue
801022d1:	a1 c4 a5 10 80       	mov    0x8010a5c4,%eax
  b->qnext = 0;
...
801022f4:	89 1a                	mov    %ebx,(%edx)
  ...
  if(idequeue == b)
801022f6:	39 1d c4 a5 10 80    	cmp    %ebx,0x8010a5c4
...
80102313:	68 e0 a5 10 80       	push   $0x8010a5e0
...
80102329:	75 e5                	jne    80102310 <iderw+0x90>
  ...
  release(&idelock);
8010232b:	c7 45 08 e0 a5 10 80 	movl   $0x8010a5e0,0x8(%ebp)
}
...
80102349:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  for(pp=&idequeue; *pp; pp=&(*pp)->qnext)  //DOC:insert-queue
80102350:	ba c4 a5 10 80       	mov    $0x8010a5c4,%edx
...
80102385:	c7 05 94 26 11 80 00 	movl   $0xfec00000,0x80112694
8010238c:	00 c0 fe 
{
...
8010239a:	00 00 00 
  return ioapic->data;
8010239d:	8b 15 94 26 11 80    	mov    0x80112694,%edx
801023a3:	8b 72 10             	mov    0x10(%edx),%esi
  ioapic->reg = reg;
801023a6:	c7 02 00 00 00 00    	movl   $0x0,(%edx)
  return ioapic->data;
801023ac:	8b 0d 94 26 11 80    	mov    0x80112694,%ecx
  maxintr = (ioapicread(REG_VER) >> 16) & 0xFF;
  id = ioapicread(REG_ID) >> 24;
  if(id != ioapicid)
801023b2:	0f b6 15 c0 27 11 80 	movzbl 0x801127c0,%edx
  maxintr = (ioapicread(REG_VER) >> 16) & 0xFF;
...
801023d8:	8b 0d 94 26 11 80    	mov    0x80112694,%ecx
...
801023f2:	89 c3                	mov    %eax,%ebx
  ioapic->data = data;
801023f4:	8b 0d 94 26 11 80    	mov    0x80112694,%ecx
...
8010240c:	89 19                	mov    %ebx,(%ecx)
  ioapic->data = data;
8010240e:	8b 0d 94 26 11 80    	mov    0x80112694,%ecx
...
80102434:	55                   	push   %ebp
  ioapic->reg = reg;
80102435:	8b 0d 94 26 11 80    	mov    0x80112694,%ecx
{
...
80102447:	89 01                	mov    %eax,(%ecx)
  ioapic->data = data;
80102449:	8b 0d 94 26 11 80    	mov    0x80112694,%ecx
...
80102458:	89 01                	mov    %eax,(%ecx)
  ioapic->data = data;
8010245a:	a1 94 26 11 80       	mov    0x80112694,%eax
  ioapicwrite(REG_TABLE+2*irq+1, cpunum << 24);
...
80102486:	81 fb 08 58 11 80    	cmp    $0x80115808,%ebx
...
801024a6:	e8 15 23 00 00       	call   801047c0 <memset>
  ...
  if(kmem.use_lock)
801024ab:	8b 15 d4 26 11 80    	mov    0x801126d4,%edx
...
801024b8:	a1 d8 26 11 80       	mov    0x801126d8,%eax
801024bd:	89 03                	mov    %eax,(%ebx)
  kmem.freelist = r;
  if(kmem.use_lock)
801024bf:	a1 d4 26 11 80       	mov    0x801126d4,%eax
  kmem.freelist = r;
801024c4:	89 1d d8 26 11 80    	mov    %ebx,0x801126d8
  if(kmem.use_lock)
...
801024db:	68 a0 26 11 80       	push   $0x801126a0
801024e0:	e8 cb 21 00 00       	call   801046b0 <acquire>
801024e5:	83 c4 10             	add    $0x10,%esp
801024e8:	eb ce                	jmp    801024b8 <kfree+0x48>
801024ea:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    release(&kmem.lock);
801024f0:	c7 45 08 a0 26 11 80 	movl   $0x801126a0,0x8(%ebp)
}
...
80102574:	68 a0 26 11 80       	push   $0x801126a0
...
80102581:	83 c4 10             	add    $0x10,%esp
  kmem.use_lock = 0;
80102584:	c7 05 d4 26 11 80 00 	movl   $0x0,0x801126d4
8010258b:	00 00 00 
  p = (char*)PGROUNDUP((uint)vstart);
...
80102612:	73 e4                	jae    801025f8 <kinit2+0x28>
  kmem.use_lock = 1;
80102614:	c7 05 d4 26 11 80 01 	movl   $0x1,0x801126d4
8010261b:	00 00 00 
}
...
80102630:	f3 0f 1e fb          	endbr32 
  ...
  if(kmem.use_lock)
80102634:	a1 d4 26 11 80       	mov    0x801126d4,%eax
80102639:	85 c0                	test   %eax,%eax
8010263b:	75 1b                	jne    80102658 <kalloc+0x28>
    acquire(&kmem.lock);
  r = kmem.freelist;
8010263d:	a1 d8 26 11 80       	mov    0x801126d8,%eax
  if(r)
80102642:	85 c0                	test   %eax,%eax
80102644:	74 0a                	je     80102650 <kalloc+0x20>
    kmem.freelist = r->next;
80102646:	8b 10                	mov    (%eax),%edx
80102648:	89 15 d8 26 11 80    	mov    %edx,0x801126d8
  if(kmem.use_lock)
8010264e:	c3                   	ret    
8010264f:	90                   	nop
    release(&kmem.lock);
...
8010265b:	83 ec 24             	sub    $0x24,%esp
    acquire(&kmem.lock);
8010265e:	68 a0 26 11 80       	push   $0x801126a0
80102663:	e8 48 20 00 00       	call   801046b0 <acquire>
  r = kmem.freelist;
80102668:	a1 d8 26 11 80       	mov    0x801126d8,%eax
  if(r)
8010266d:	8b 15 d4 26 11 80    	mov    0x801126d4,%edx
80102673:	83 c4 10             	add    $0x10,%esp
80102676:	85 c0                	test   %eax,%eax
80102678:	74 08                	je     80102682 <kalloc+0x52>
    kmem.freelist = r->next;
8010267a:	8b 08                	mov    (%eax),%ecx
8010267c:	89 0d d8 26 11 80    	mov    %ecx,0x801126d8
  if(kmem.use_lock)
...
8010268c:	68 a0 26 11 80       	push   $0x801126a0
...
801026bb:	ec                   	in     (%dx),%al
  return data;
801026bc:	8b 1d 14 a6 10 80    	mov    0x8010a614,%ebx
    return -1;
  data = inb(KBDATAP);
...
801026f1:	89 c8                	mov    %ecx,%eax
  shift ^= togglecode[data];
801026f3:	89 0d 14 a6 10 80    	mov    %ecx,0x8010a614
  c = charcode[shift & (CTL | SHIFT)][data];
...
80102723:	31 c0                	xor    %eax,%eax
    shift |= E0ESC;
80102725:	89 1d 14 a6 10 80    	mov    %ebx,0x8010a614
}
8010272b:	5b                   	pop    %ebx
8010272c:	5d                   	pop    %ebp
8010272d:	c3                   	ret    
...
8010274c:	5d                   	pop    %ebp
    shift &= ~(shiftcode[data] | E0ESC);
8010274d:	89 0d 14 a6 10 80    	mov    %ecx,0x8010a614
}
80102753:	c3                   	ret    
...
801027a0:	f3 0f 1e fb          	endbr32 
  if(!lapic)
801027a4:	a1 dc 26 11 80       	mov    0x801126dc,%eax
...
801028a0:	f3 0f 1e fb          	endbr32 
  if (!lapic)
801028a4:	a1 dc 26 11 80       	mov    0x801126dc,%eax
...
801028c0:	f3 0f 1e fb          	endbr32 
  if(lapic)
801028c4:	a1 dc 26 11 80       	mov    0x801126dc,%eax
...
8010292c:	66 a3 69 04 00 80    	mov    %ax,0x80000469
  lapic[index] = value;
80102932:	a1 dc 26 11 80       	mov    0x801126dc,%eax
...
80102b90:	8b 0d 28 27 11 80    	mov    0x80112728,%ecx
...
80102bb0:	a1 14 27 11 80       	mov    0x80112714,%eax
80102bb5:	83 ec 08             	sub    $0x8,%esp
80102bb8:	01 f8                	add    %edi,%eax
80102bba:	83 c0 01             	add    $0x1,%eax
80102bbd:	50                   	push   %eax
80102bbe:	ff 35 24 27 11 80    	pushl  0x80112724
80102bc4:	e8 07 d5 ff ff       	call   801000d0 <bread>
80102bc9:	89 c6                	mov    %eax,%esi
    struct buf *dbuf = bread(log.dev, log.lh.block[tail]); // read dst
80102bcb:	58                   	pop    %eax
80102bcc:	5a                   	pop    %edx
80102bcd:	ff 34 bd 2c 27 11 80 	pushl  -0x7feed8d4(,%edi,4)
80102bd4:	ff 35 24 27 11 80    	pushl  0x80112724
  for (tail = 0; tail < log.lh.n; tail++) {
...
80102c14:	39 3d 28 27 11 80    	cmp    %edi,0x80112728
...
80102c37:	ff 35 14 27 11 80    	pushl  0x80112714
80102c3d:	ff 35 24 27 11 80    	pushl  0x80112724
...
80102c4b:	89 c3                	mov    %eax,%ebx
  hb->n = log.lh.n;
80102c4d:	a1 28 27 11 80       	mov    0x80112728,%eax
...
80102c60:	8b 0c 95 2c 27 11 80 	mov    -0x7feed8d4(,%edx,4),%ecx
...
80102ca3:	68 e0 26 11 80       	push   $0x801126e0
...
80102cbc:	59                   	pop    %ecx
  log.dev = dev;
80102cbd:	89 1d 24 27 11 80    	mov    %ebx,0x80112724
  log.size = sb.nlog;
80102cc3:	8b 55 e8             	mov    -0x18(%ebp),%edx
  log.start = sb.logstart;
80102cc6:	a3 14 27 11 80       	mov    %eax,0x80112714
  log.size = sb.nlog;
80102ccb:	89 15 18 27 11 80    	mov    %edx,0x80112718
  struct buf *buf = bread(log.dev, log.start);
80102cd1:	5a                   	pop    %edx
...
80102cdf:	89 0d 28 27 11 80    	mov    %ecx,0x80112728
  for (i = 0; i < log.lh.n; i++) {
...
80102cf4:	89 1c 95 2c 27 11 80 	mov    %ebx,-0x7feed8d4(,%edx,4)
  for (i = 0; i < log.lh.n; i++) {
...
80102d0b:	e8 80 fe ff ff       	call   80102b90 <install_trans>
  log.lh.n = 0;
80102d10:	c7 05 28 27 11 80 00 	movl   $0x0,0x80112728
80102d17:	00 00 00 
...
80102d37:	83 ec 14             	sub    $0x14,%esp
  acquire(&log.lock);
80102d3a:	68 e0 26 11 80       	push   $0x801126e0
...
80102d53:	68 e0 26 11 80       	push   $0x801126e0
80102d58:	68 e0 26 11 80       	push   $0x801126e0
80102d5d:	e8 9e 12 00 00       	call   80104000 <sleep>
80102d62:	83 c4 10             	add    $0x10,%esp
    if(log.committing){
80102d65:	a1 20 27 11 80       	mov    0x80112720,%eax
80102d6a:	85 c0                	test   %eax,%eax
80102d6c:	75 e2                	jne    80102d50 <begin_op+0x20>
    } else if(log.lh.n + (log.outstanding+1)*MAXOPBLOCKS > LOGSIZE){
80102d6e:	a1 1c 27 11 80       	mov    0x8011271c,%eax
80102d73:	8b 15 28 27 11 80    	mov    0x80112728,%edx
...
80102d87:	83 ec 0c             	sub    $0xc,%esp
      log.outstanding += 1;
80102d8a:	a3 1c 27 11 80       	mov    %eax,0x8011271c
      release(&log.lock);
80102d8f:	68 e0 26 11 80       	push   $0x801126e0
...
80102daa:	83 ec 18             	sub    $0x18,%esp
  ...
  acquire(&log.lock);
80102dad:	68 e0 26 11 80       	push   $0x801126e0
80102db2:	e8 f9 18 00 00       	call   801046b0 <acquire>
  log.outstanding -= 1;
80102db7:	a1 1c 27 11 80       	mov    0x8011271c,%eax
  if(log.committing)
80102dbc:	8b 35 20 27 11 80    	mov    0x80112720,%esi
80102dc2:	83 c4 10             	add    $0x10,%esp
  log.outstanding -= 1;
80102dc5:	8d 58 ff             	lea    -0x1(%eax),%ebx
80102dc8:	89 1d 1c 27 11 80    	mov    %ebx,0x8011271c
  if(log.committing)
...
80102dd8:	0f 85 f2 00 00 00    	jne    80102ed0 <end_op+0x130>
    do_commit = 1;
    log.committing = 1;
80102dde:	c7 05 20 27 11 80 01 	movl   $0x1,0x80112720
80102de5:	00 00 00 
...
80102deb:	68 e0 26 11 80       	push   $0x801126e0
...
{
  if (log.lh.n > 0) {
80102df5:	8b 0d 28 27 11 80    	mov    0x80112728,%ecx
80102dfb:	83 c4 10             	add    $0x10,%esp
80102dfe:	85 c9                	test   %ecx,%ecx
80102e00:	7f 3e                	jg     80102e40 <end_op+0xa0>
    acquire(&log.lock);
80102e02:	83 ec 0c             	sub    $0xc,%esp
80102e05:	68 e0 26 11 80       	push   $0x801126e0
80102e0a:	e8 a1 18 00 00       	call   801046b0 <acquire>
    wakeup(&log);
80102e0f:	c7 04 24 e0 26 11 80 	movl   $0x801126e0,(%esp)
    log.committing = 0;
80102e16:	c7 05 20 27 11 80 00 	movl   $0x0,0x80112720
80102e1d:	00 00 00 
    wakeup(&log);
80102e20:	e8 9b 13 00 00       	call   801041c0 <wakeup>
    release(&log.lock);
80102e25:	c7 04 24 e0 26 11 80 	movl   $0x801126e0,(%esp)
...
80102e40:	a1 14 27 11 80       	mov    0x80112714,%eax
80102e45:	83 ec 08             	sub    $0x8,%esp
80102e48:	01 d8                	add    %ebx,%eax
80102e4a:	83 c0 01             	add    $0x1,%eax
80102e4d:	50                   	push   %eax
80102e4e:	ff 35 24 27 11 80    	pushl  0x80112724
80102e54:	e8 77 d2 ff ff       	call   801000d0 <bread>
80102e59:	89 c6                	mov    %eax,%esi
    struct buf *from = bread(log.dev, log.lh.block[tail]); // cache block
80102e5b:	58                   	pop    %eax
80102e5c:	5a                   	pop    %edx
80102e5d:	ff 34 9d 2c 27 11 80 	pushl  -0x7feed8d4(,%ebx,4)
80102e64:	ff 35 24 27 11 80    	pushl  0x80112724
  for (tail = 0; tail < log.lh.n; tail++) {
...
80102ea4:	3b 1d 28 27 11 80    	cmp    0x80112728,%ebx
...
80102eb1:	e8 da fc ff ff       	call   80102b90 <install_trans>
    log.lh.n = 0;
80102eb6:	c7 05 28 27 11 80 00 	movl   $0x0,0x80112728
80102ebd:	00 00 00 
...
80102ed3:	68 e0 26 11 80       	push   $0x801126e0
80102ed8:	e8 e3 12 00 00       	call   801041c0 <wakeup>
  release(&log.lock);
80102edd:	c7 04 24 e0 26 11 80 	movl   $0x801126e0,(%esp)
...
80102f1b:	8b 15 28 27 11 80    	mov    0x80112728,%edx
{
80102f21:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if (log.lh.n >= LOGSIZE || log.lh.n >= log.size - 1)
80102f24:	83 fa 1d             	cmp    $0x1d,%edx
80102f27:	0f 8f 91 00 00 00    	jg     80102fbe <log_write+0xae>
80102f2d:	a1 18 27 11 80       	mov    0x80112718,%eax
80102f32:	83 e8 01             	sub    $0x1,%eax
80102f35:	39 c2                	cmp    %eax,%edx
80102f37:	0f 8d 81 00 00 00    	jge    80102fbe <log_write+0xae>
    panic("too big a transaction");
  if (log.outstanding < 1)
80102f3d:	a1 1c 27 11 80       	mov    0x8011271c,%eax
...
80102f4d:	68 e0 26 11 80       	push   $0x801126e0
80102f52:	e8 59 17 00 00       	call   801046b0 <acquire>
  for (i = 0; i < log.lh.n; i++) {
80102f57:	8b 15 28 27 11 80    	mov    0x80112728,%edx
...
80102f75:	74 29                	je     80102fa0 <log_write+0x90>
    if (log.lh.block[i] == b->blockno)   // log absorbtion
80102f77:	39 0c 85 2c 27 11 80 	cmp    %ecx,-0x7feed8d4(,%eax,4)
80102f7e:	75 f0                	jne    80102f70 <log_write+0x60>
      break;
  }
  log.lh.block[i] = b->blockno;
80102f80:	89 0c 85 2c 27 11 80 	mov    %ecx,-0x7feed8d4(,%eax,4)
  if (i == log.lh.n)
    log.lh.n++;
...
80102f8a:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  release(&log.lock);
80102f8d:	c7 45 08 e0 26 11 80 	movl   $0x801126e0,0x8(%ebp)
}
80102f94:	c9                   	leave  
  release(&log.lock);
...
80102f9a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  log.lh.block[i] = b->blockno;
80102fa0:	89 0c 95 2c 27 11 80 	mov    %ecx,-0x7feed8d4(,%edx,4)
    log.lh.n++;
80102fa7:	83 c2 01             	add    $0x1,%edx
80102faa:	89 15 28 27 11 80    	mov    %edx,0x80112728
80102fb0:	eb d5                	jmp    80102f87 <log_write+0x77>
  log.lh.block[i] = b->blockno;
80102fb2:	8b 43 08             	mov    0x8(%ebx),%eax
80102fb5:	a3 2c 27 11 80       	mov    %eax,0x8011272c
  if (i == log.lh.n)
...
80103027:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
8010302a:	e8 b1 3b 00 00       	call   80106be0 <switchkvm>
  seginit();
8010302f:	e8 1c 3b 00 00       	call   80106b50 <seginit>
  lapicinit();
...
8010305b:	68 08 58 11 80       	push   $0x80115808
80103060:	e8 fb f4 ff ff       	call   80102560 <kinit1>
  kvmalloc();      // kernel page table
80103065:	e8 56 40 00 00       	call   801070c0 <kvmalloc>
  mpinit();        // detect other processors
8010306a:	e8 81 01 00 00       	call   801031f0 <mpinit>
  lapicinit();     // interrupt controller
8010306f:	e8 2c f7 ff ff       	call   801027a0 <lapicinit>
  seginit();       // segment descriptors
80103074:	e8 d7 3a 00 00       	call   80106b50 <seginit>
  picinit();       // disable pic
...
80103088:	e8 83 2d 00 00       	call   80105e10 <uartinit>
  pinit();         // process table
...
801030ae:	68 ec a4 10 80       	push   $0x8010a4ec
801030b3:	68 00 70 00 80       	push   $0x80007000
801030b8:	e8 a3 17 00 00       	call   80104860 <memmove>

  for(c = cpus; c < cpus+ncpu; c++){
801030bd:	83 c4 10             	add    $0x10,%esp
801030c0:	69 05 60 2d 11 80 b0 	imul   $0xb0,0x80112d60,%eax
801030c7:	00 00 00 
801030ca:	05 e0 27 11 80       	add    $0x801127e0,%eax
801030cf:	3d e0 27 11 80       	cmp    $0x801127e0,%eax
801030d4:	76 7a                	jbe    80103150 <main+0x110>
801030d6:	bb e0 27 11 80       	mov    $0x801127e0,%ebx
801030db:	eb 1c                	jmp    801030f9 <main+0xb9>
801030dd:	8d 76 00             	lea    0x0(%esi),%esi
801030e0:	69 05 60 2d 11 80 b0 	imul   $0xb0,0x80112d60,%eax
801030e7:	00 00 00 
801030ea:	81 c3 b0 00 00 00    	add    $0xb0,%ebx
801030f0:	05 e0 27 11 80       	add    $0x801127e0,%eax
...
801032be:	a3 dc 26 11 80       	mov    %eax,0x801126dc
...
8010334c:	83 c0 08             	add    $0x8,%eax
      ioapicid = ioapic->apicno;
8010334f:	88 0d c0 27 11 80    	mov    %cl,0x801127c0
      continue;
80103355:	eb 89                	jmp    801032e0 <mpinit+0xf0>
80103357:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010335e:	66 90                	xchg   %ax,%ax
      if(ncpu < NCPU) {
80103360:	8b 0d 60 2d 11 80    	mov    0x80112d60,%ecx
...
80103378:	89 0d 60 2d 11 80    	mov    %ecx,0x80112d60
        cpus[ncpu].apicid = proc->apicid;  // apicid may differ from ncpu
8010337e:	88 9f e0 27 11 80    	mov    %bl,-0x7feed820(%edi)
...
80103533:	e8 88 0c 00 00       	call   801041c0 <wakeup>
...
80103574:	e8 47 0c 00 00       	call   801041c0 <wakeup>
...
80103608:	e8 b3 0b 00 00       	call   801041c0 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
8010360d:	58                   	pop    %eax
8010360e:	5a                   	pop    %edx
...
8010368a:	e8 31 0b 00 00       	call   801041c0 <wakeup>
  release(&p->lock);
...
80103756:	e8 65 0a 00 00       	call   801041c0 <wakeup>
  release(&p->lock);
...
80103794:	bb b4 2d 11 80       	mov    $0x80112db4,%ebx
{
80103799:	83 ec 10             	sub    $0x10,%esp
  acquire(&ptable.lock);
8010379c:	68 80 2d 11 80       	push   $0x80112d80
...
801037b6:	81 fb b4 4f 11 80    	cmp    $0x80114fb4,%ebx
...
801037ce:	c7 43 0c 01 00 00 00 	movl   $0x1,0xc(%ebx)
  //added here by jw (hw3)
  p->weight = weight++; //가중치 = 생성 순서에 따라 1부터 증가 
  p->priority = ptable.min_priority; //관리 프로세스 중 가장 작은 priority값
...
801037db:	8d 50 01             	lea    0x1(%eax),%edx
  p->weight = weight++; //가중치 = 생성 순서에 따라 1부터 증가 
801037de:	a1 08 a0 10 80       	mov    0x8010a008,%eax
  p->pid = nextpid++;
801037e3:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  p->weight = weight++; //가중치 = 생성 순서에 따라 1부터 증가 
801037e9:	89 83 84 00 00 00    	mov    %eax,0x84(%ebx)
801037ef:	8d 50 01             	lea    0x1(%eax),%edx
  p->priority = ptable.min_priority; //관리 프로세스 중 가장 작은 priority값
801037f2:	a1 b4 4f 11 80       	mov    0x80114fb4,%eax
  p->weight = weight++; //가중치 = 생성 순서에 따라 1부터 증가 
801037f7:	89 15 08 a0 10 80    	mov    %edx,0x8010a008
  p->priority = ptable.min_priority; //관리 프로세스 중 가장 작은 priority값
801037fd:	89 83 80 00 00 00    	mov    %eax,0x80(%ebx)
  release(&ptable.lock);
80103803:	68 80 2d 11 80       	push   $0x80112d80
80103808:	e8 63 0f 00 00       	call   80104770 <release>

  // Allocate kernel stack.
  if((p->kstack = kalloc()) == 0){
8010380d:	e8 1e ee ff ff       	call   80102630 <kalloc>
80103812:	83 c4 10             	add    $0x10,%esp
80103815:	89 43 08             	mov    %eax,0x8(%ebx)
80103818:	85 c0                	test   %eax,%eax
8010381a:	74 5d                	je     80103879 <allocproc+0xe9>
    return 0;
  }
...
80103822:	83 ec 04             	sub    $0x4,%esp
  sp -= sizeof *p->context;
80103825:	05 9c 0f 00 00       	add    $0xf9c,%eax
  sp -= sizeof *p->tf;
8010382a:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
8010382d:	c7 40 14 7c 5a 10 80 	movl   $0x80105a7c,0x14(%eax)
  p->context = (struct context*)sp;
80103834:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
80103837:	6a 14                	push   $0x14
80103839:	6a 00                	push   $0x0
8010383b:	50                   	push   %eax
8010383c:	e8 7f 0f 00 00       	call   801047c0 <memset>
  p->context->eip = (uint)forkret;
80103841:	8b 43 1c             	mov    0x1c(%ebx),%eax
  p->trace = 0; //add /*jw*/

  return p;
80103844:	83 c4 10             	add    $0x10,%esp
  p->context->eip = (uint)forkret;
80103847:	c7 40 10 90 38 10 80 	movl   $0x80103890,0x10(%eax)
}
8010384e:	89 d8                	mov    %ebx,%eax
  p->trace = 0; //add /*jw*/
80103850:	c7 43 7c 00 00 00 00 	movl   $0x0,0x7c(%ebx)
}
...
80103863:	31 db                	xor    %ebx,%ebx
  release(&ptable.lock);
80103865:	68 80 2d 11 80       	push   $0x80112d80
8010386a:	e8 01 0f 00 00       	call   80104770 <release>
}
...
80103897:	83 ec 14             	sub    $0x14,%esp
  ...
  release(&ptable.lock);
8010389a:	68 80 2d 11 80       	push   $0x80112d80
8010389f:	e8 cc 0e 00 00       	call   80104770 <release>
...
801038ea:	68 20 78 10 80       	push   $0x80107820
801038ef:	68 80 2d 11 80       	push   $0x80112d80
801038f4:	e8 37 0c 00 00       	call   80104530 <initlock>
}
...
80103910:	e8 8b ef ff ff       	call   801028a0 <lapicid>
  for (i = 0; i < ncpu; ++i) {
80103915:	8b 35 60 2d 11 80    	mov    0x80112d60,%esi
  apicid = lapicid();
...
80103935:	0f b6 81 e0 27 11 80 	movzbl -0x7feed820(%ecx),%eax
8010393c:	39 d8                	cmp    %ebx,%eax
8010393e:	75 e8                	jne    80103928 <mycpu+0x28>
}
80103940:	8d 65 f8             	lea    -0x8(%ebp),%esp
      return &cpus[i];
80103943:	8d 81 e0 27 11 80    	lea    -0x7feed820(%ecx),%eax
}
80103949:	5b                   	pop    %ebx
8010394a:	5e                   	pop    %esi
8010394b:	5d                   	pop    %ebp
...
8010397f:	c9                   	leave  
  return mycpu()-cpus;
80103980:	2d e0 27 11 80       	sub    $0x801127e0,%eax
...
80103998:	83 ec 04             	sub    $0x4,%esp
  pushcli();
8010399b:	e8 10 0c 00 00       	call   801045b0 <pushcli>
  c = mycpu();
801039a0:	e8 5b ff ff ff       	call   80103900 <mycpu>
  p = c->proc;
801039a5:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801039ab:	e8 50 0c 00 00       	call   80104600 <popcli>
}
...
801039c8:	83 ec 04             	sub    $0x4,%esp
  ptable.min_priority = 3; //add by jw (hw3)
801039cb:	c7 05 b4 4f 11 80 03 	movl   $0x3,0x80114fb4
801039d2:	00 00 00 
  p = allocproc();
801039d5:	e8 b6 fd ff ff       	call   80103790 <allocproc>
801039da:	89 c3                	mov    %eax,%ebx
  initproc = p;
801039dc:	a3 18 a6 10 80       	mov    %eax,0x8010a618
  if((p->pgdir = setupkvm()) == 0)
801039e1:	e8 5a 36 00 00       	call   80107040 <setupkvm>
801039e6:	89 43 04             	mov    %eax,0x4(%ebx)
801039e9:	85 c0                	test   %eax,%eax
801039eb:	0f 84 bd 00 00 00    	je     80103aae <userinit+0xee>
  inituvm(p->pgdir, _binary_initcode_start, (int)_binary_initcode_size);
801039f1:	83 ec 04             	sub    $0x4,%esp
801039f4:	68 2c 00 00 00       	push   $0x2c
801039f9:	68 c0 a4 10 80       	push   $0x8010a4c0
801039fe:	50                   	push   %eax
801039ff:	e8 0c 33 00 00       	call   80106d10 <inituvm>
  memset(p->tf, 0, sizeof(*p->tf));
80103a04:	83 c4 0c             	add    $0xc,%esp
  p->sz = PGSIZE;
80103a07:	c7 03 00 10 00 00    	movl   $0x1000,(%ebx)
  memset(p->tf, 0, sizeof(*p->tf));
80103a0d:	6a 4c                	push   $0x4c
80103a0f:	6a 00                	push   $0x0
80103a11:	ff 73 18             	pushl  0x18(%ebx)
80103a14:	e8 a7 0d 00 00       	call   801047c0 <memset>
  p->tf->cs = (SEG_UCODE << 3) | DPL_USER;
80103a19:	8b 43 18             	mov    0x18(%ebx),%eax
80103a1c:	ba 1b 00 00 00       	mov    $0x1b,%edx
  safestrcpy(p->name, "initcode", sizeof(p->name));
80103a21:	83 c4 0c             	add    $0xc,%esp
  p->tf->ds = (SEG_UDATA << 3) | DPL_USER;
80103a24:	b9 23 00 00 00       	mov    $0x23,%ecx
  p->tf->cs = (SEG_UCODE << 3) | DPL_USER;
80103a29:	66 89 50 3c          	mov    %dx,0x3c(%eax)
  p->tf->ds = (SEG_UDATA << 3) | DPL_USER;
80103a2d:	8b 43 18             	mov    0x18(%ebx),%eax
80103a30:	66 89 48 2c          	mov    %cx,0x2c(%eax)
  p->tf->es = p->tf->ds;
80103a34:	8b 43 18             	mov    0x18(%ebx),%eax
80103a37:	0f b7 50 2c          	movzwl 0x2c(%eax),%edx
80103a3b:	66 89 50 28          	mov    %dx,0x28(%eax)
  p->tf->ss = p->tf->ds;
80103a3f:	8b 43 18             	mov    0x18(%ebx),%eax
80103a42:	0f b7 50 2c          	movzwl 0x2c(%eax),%edx
80103a46:	66 89 50 48          	mov    %dx,0x48(%eax)
  p->tf->eflags = FL_IF;
80103a4a:	8b 43 18             	mov    0x18(%ebx),%eax
80103a4d:	c7 40 40 00 02 00 00 	movl   $0x200,0x40(%eax)
  p->tf->esp = PGSIZE;
80103a54:	8b 43 18             	mov    0x18(%ebx),%eax
80103a57:	c7 40 44 00 10 00 00 	movl   $0x1000,0x44(%eax)
  p->tf->eip = 0;  // beginning of initcode.S
80103a5e:	8b 43 18             	mov    0x18(%ebx),%eax
80103a61:	c7 40 38 00 00 00 00 	movl   $0x0,0x38(%eax)
  safestrcpy(p->name, "initcode", sizeof(p->name));
80103a68:	8d 43 6c             	lea    0x6c(%ebx),%eax
80103a6b:	6a 10                	push   $0x10
80103a6d:	68 50 78 10 80       	push   $0x80107850
80103a72:	50                   	push   %eax
80103a73:	e8 08 0f 00 00       	call   80104980 <safestrcpy>
  p->cwd = namei("/");
80103a78:	c7 04 24 59 78 10 80 	movl   $0x80107859,(%esp)
80103a7f:	e8 ac e5 ff ff       	call   80102030 <namei>
80103a84:	89 43 68             	mov    %eax,0x68(%ebx)
  acquire(&ptable.lock);
80103a87:	c7 04 24 80 2d 11 80 	movl   $0x80112d80,(%esp)
80103a8e:	e8 1d 0c 00 00       	call   801046b0 <acquire>
  p->state = RUNNABLE;
80103a93:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  release(&ptable.lock);
80103a9a:	c7 04 24 80 2d 11 80 	movl   $0x80112d80,(%esp)
80103aa1:	e8 ca 0c 00 00       	call   80104770 <release>
}
...
80103ab1:	68 37 78 10 80       	push   $0x80107837
80103ab6:	e8 d5 c8 ff ff       	call   80100390 <panic>
...
80103ac9:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103acc:	e8 df 0a 00 00       	call   801045b0 <pushcli>
  c = mycpu();
80103ad1:	e8 2a fe ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103ad6:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103adc:	e8 1f 0b 00 00       	call   80104600 <popcli>
  sz = curproc->sz;
...
80103aef:	e8 0c 31 00 00       	call   80106c00 <switchuvm>
  return 0;
...
80103b0a:	e8 51 33 00 00       	call   80106e60 <allocuvm>
...
80103b2a:	e8 61 34 00 00       	call   80106f90 <deallocuvm>
...
80103b4a:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103b4d:	e8 5e 0a 00 00       	call   801045b0 <pushcli>
  c = mycpu();
80103b52:	e8 a9 fd ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103b57:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b5d:	e8 9e 0a 00 00       	call   80104600 <popcli>
  if((np = allocproc()) == 0){
...
80103b7c:	e8 8f 35 00 00       	call   80107110 <copyuvm>
...
80103b99:	89 02                	mov    %eax,(%edx)
  *np->tf = *curproc->tf;
80103b9b:	8b 7a 18             	mov    0x18(%edx),%edi
  np->parent = curproc;
80103b9e:	89 5a 14             	mov    %ebx,0x14(%edx)
  *np->tf = *curproc->tf;
80103ba1:	8b 73 18             	mov    0x18(%ebx),%esi
80103ba4:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  for(i = 0; i < NOFILE; i++)
80103ba6:	31 f6                	xor    %esi,%esi
  np->trace = curproc->trace; /* add (jw) */
80103ba8:	8b 43 7c             	mov    0x7c(%ebx),%eax
80103bab:	89 42 7c             	mov    %eax,0x7c(%edx)
  np->tf->eax = 0;
80103bae:	8b 42 18             	mov    0x18(%edx),%eax
...
80103c01:	e8 7a 0d 00 00       	call   80104980 <safestrcpy>
  pid = np->pid;
80103c06:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103c09:	c7 04 24 80 2d 11 80 	movl   $0x80112d80,(%esp)
80103c10:	e8 9b 0a 00 00       	call   801046b0 <acquire>
  np->state = RUNNABLE;
80103c15:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  release(&ptable.lock);
80103c1c:	c7 04 24 80 2d 11 80 	movl   $0x80112d80,(%esp)
...
80103c99:	83 ec 0c             	sub    $0xc,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c9c:	bf b4 2d 11 80       	mov    $0x80112db4,%edi
    acquire(&ptable.lock);
80103ca1:	68 80 2d 11 80       	push   $0x80112d80
80103ca6:	e8 05 0a 00 00       	call   801046b0 <acquire>
		if(p->priority == ptable.min_priority)
80103cab:	8b 15 b4 4f 11 80    	mov    0x80114fb4,%edx
80103cb1:	83 c4 10             	add    $0x10,%esp
80103cb4:	eb 1e                	jmp    80103cd4 <scheduler+0x64>
80103cb6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80103cbd:	8d 76 00             	lea    0x0(%esi),%esi
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103cc0:	8d 87 88 00 00 00    	lea    0x88(%edi),%eax
80103cc6:	81 ff 2c 4f 11 80    	cmp    $0x80114f2c,%edi
80103ccc:	0f 84 b8 00 00 00    	je     80103d8a <scheduler+0x11a>
80103cd2:	89 c7                	mov    %eax,%edi
		if(p->state != RUNNABLE)
80103cd4:	83 7f 0c 03          	cmpl   $0x3,0xc(%edi)
80103cd8:	75 e6                	jne    80103cc0 <scheduler+0x50>
		if(p->priority == ptable.min_priority)
80103cda:	39 97 80 00 00 00    	cmp    %edx,0x80(%edi)
80103ce0:	75 de                	jne    80103cc0 <scheduler+0x50>
			cprintf("PID: %d, NAME: %s, WEIGHT: %d, PRIORITY: %d\n", p->pid, p->name, p->weight, p->priority);
80103ce2:	83 ec 0c             	sub    $0xc,%esp
80103ce5:	8d 47 6c             	lea    0x6c(%edi),%eax
80103ce8:	52                   	push   %edx
80103ce9:	ff b7 84 00 00 00    	pushl  0x84(%edi)
80103cef:	50                   	push   %eax
80103cf0:	ff 77 10             	pushl  0x10(%edi)
80103cf3:	68 2c 79 10 80       	push   $0x8010792c
80103cf8:	e8 b3 c9 ff ff       	call   801006b0 <cprintf>
	switchuvm(p);
80103cfd:	83 c4 14             	add    $0x14,%esp
	c->proc = p;
80103d00:	89 bb ac 00 00 00    	mov    %edi,0xac(%ebx)
	switchuvm(p);
80103d06:	57                   	push   %edi
80103d07:	e8 f4 2e 00 00       	call   80106c00 <switchuvm>
	p->state = RUNNING;
80103d0c:	c7 47 0c 04 00 00 00 	movl   $0x4,0xc(%edi)
	swtch(&(c->scheduler), p->context);
80103d13:	58                   	pop    %eax
80103d14:	5a                   	pop    %edx
80103d15:	ff 77 1c             	pushl  0x1c(%edi)
80103d18:	56                   	push   %esi
80103d19:	e8 c5 0c 00 00       	call   801049e3 <swtch>
	switchkvm();
80103d1e:	e8 bd 2e 00 00       	call   80106be0 <switchkvm>
	p->priority = p->priority + TIME_SLICE/(p->weight);
80103d23:	b8 80 96 98 00       	mov    $0x989680,%eax
	for (minp = ptable.proc, min = minp->priority; minp<&ptable.proc[NPROC]; minp++){
80103d28:	83 c4 10             	add    $0x10,%esp
	p->priority = p->priority + TIME_SLICE/(p->weight);
80103d2b:	99                   	cltd   
80103d2c:	f7 bf 84 00 00 00    	idivl  0x84(%edi)
80103d32:	01 87 80 00 00 00    	add    %eax,0x80(%edi)
	for (minp = ptable.proc, min = minp->priority; minp<&ptable.proc[NPROC]; minp++){
80103d38:	8b 15 34 2e 11 80    	mov    0x80112e34,%edx
80103d3e:	b8 b4 2d 11 80       	mov    $0x80112db4,%eax
80103d43:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103d47:	90                   	nop
		if (minp->state != RUNNABLE) continue;
80103d48:	83 78 0c 03          	cmpl   $0x3,0xc(%eax)
80103d4c:	75 0b                	jne    80103d59 <scheduler+0xe9>
		if (min > minp->priority){
80103d4e:	8b 88 80 00 00 00    	mov    0x80(%eax),%ecx
80103d54:	39 ca                	cmp    %ecx,%edx
80103d56:	0f 4f d1             	cmovg  %ecx,%edx
	for (minp = ptable.proc, min = minp->priority; minp<&ptable.proc[NPROC]; minp++){
80103d59:	05 88 00 00 00       	add    $0x88,%eax
80103d5e:	3d b4 4f 11 80       	cmp    $0x80114fb4,%eax
80103d63:	75 e3                	jne    80103d48 <scheduler+0xd8>
	release(&ptable.lock);
80103d65:	83 ec 0c             	sub    $0xc,%esp
	ptable.min_priority = min; 
80103d68:	89 15 b4 4f 11 80    	mov    %edx,0x80114fb4
	c->proc = 0;
80103d6e:	c7 83 ac 00 00 00 00 	movl   $0x0,0xac(%ebx)
80103d75:	00 00 00 
	release(&ptable.lock);
80103d78:	68 80 2d 11 80       	push   $0x80112d80
80103d7d:	e8 ee 09 00 00       	call   80104770 <release>
80103d82:	83 c4 10             	add    $0x10,%esp
80103d85:	e9 0e ff ff ff       	jmp    80103c98 <scheduler+0x28>
80103d8a:	8b 97 08 01 00 00    	mov    0x108(%edi),%edx
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103d90:	bf b4 4f 11 80       	mov    $0x80114fb4,%edi
80103d95:	e9 48 ff ff ff       	jmp    80103ce2 <scheduler+0x72>
...
80103da8:	53                   	push   %ebx
  pushcli();
80103da9:	e8 02 08 00 00       	call   801045b0 <pushcli>
  c = mycpu();
80103dae:	e8 4d fb ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103db3:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103db9:	e8 42 08 00 00       	call   80104600 <popcli>
  if(!holding(&ptable.lock))
80103dbe:	83 ec 0c             	sub    $0xc,%esp
80103dc1:	68 80 2d 11 80       	push   $0x80112d80
80103dc6:	e8 95 08 00 00       	call   80104660 <holding>
...
80103deb:	75 41                	jne    80103e2e <sched+0x8e>
  intena = mycpu()->intena;
80103ded:	e8 0e fb ff ff       	call   80103900 <mycpu>
  swtch(&p->context, mycpu()->scheduler);
80103df2:	83 c3 1c             	add    $0x1c,%ebx
  intena = mycpu()->intena;
80103df5:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103dfb:	e8 00 fb ff ff       	call   80103900 <mycpu>
80103e00:	83 ec 08             	sub    $0x8,%esp
80103e03:	ff 70 04             	pushl  0x4(%eax)
80103e06:	53                   	push   %ebx
80103e07:	e8 d7 0b 00 00       	call   801049e3 <swtch>
  mycpu()->intena = intena;
80103e0c:	e8 ef fa ff ff       	call   80103900 <mycpu>
}
...
80103e6a:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103e6d:	e8 3e 07 00 00       	call   801045b0 <pushcli>
  c = mycpu();
80103e72:	e8 89 fa ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103e77:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103e7d:	e8 7e 07 00 00       	call   80104600 <popcli>
  if(curproc == initproc)
80103e82:	8d 5e 28             	lea    0x28(%esi),%ebx
80103e85:	8d 7e 68             	lea    0x68(%esi),%edi
80103e88:	39 35 18 a6 10 80    	cmp    %esi,0x8010a618
80103e8e:	0f 84 09 01 00 00    	je     80103f9d <exit+0x13d>
...
80103ec7:	e8 d4 ee ff ff       	call   80102da0 <end_op>
  curproc->cwd = 0;
80103ecc:	c7 46 68 00 00 00 00 	movl   $0x0,0x68(%esi)
  acquire(&ptable.lock);
80103ed3:	c7 04 24 80 2d 11 80 	movl   $0x80112d80,(%esp)
80103eda:	e8 d1 07 00 00       	call   801046b0 <acquire>
  wakeup1(curproc->parent);
80103edf:	8b 56 14             	mov    0x14(%esi),%edx
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103ee5:	b8 b4 2d 11 80       	mov    $0x80112db4,%eax
80103eea:	eb 10                	jmp    80103efc <exit+0x9c>
80103eec:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103ef0:	05 88 00 00 00       	add    $0x88,%eax
80103ef5:	3d b4 4f 11 80       	cmp    $0x80114fb4,%eax
80103efa:	74 27                	je     80103f23 <exit+0xc3>
...
80103f05:	75 e9                	jne    80103ef0 <exit+0x90>
      p->state = RUNNABLE; //SLEEPING -> RUNNABLE로 상태 전이
80103f07:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
	  p->priority = ptable.min_priority; //관리 프로세스 중 가장 작은 priority값. //add by jw (hw3)
80103f0e:	8b 0d b4 4f 11 80    	mov    0x80114fb4,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103f14:	05 88 00 00 00       	add    $0x88,%eax
	  p->priority = ptable.min_priority; //관리 프로세스 중 가장 작은 priority값. //add by jw (hw3)
80103f19:	89 48 f8             	mov    %ecx,-0x8(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103f1c:	3d b4 4f 11 80       	cmp    $0x80114fb4,%eax
80103f21:	75 d9                	jne    80103efc <exit+0x9c>
      p->parent = initproc;
80103f23:	8b 0d 18 a6 10 80    	mov    0x8010a618,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f29:	ba b4 2d 11 80       	mov    $0x80112db4,%edx
80103f2e:	eb 0e                	jmp    80103f3e <exit+0xde>
80103f30:	81 c2 88 00 00 00    	add    $0x88,%edx
80103f36:	81 fa b4 4f 11 80    	cmp    $0x80114fb4,%edx
80103f3c:	74 46                	je     80103f84 <exit+0x124>
    if(p->parent == curproc){
...
80103f4a:	75 e4                	jne    80103f30 <exit+0xd0>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103f4c:	b8 b4 2d 11 80       	mov    $0x80112db4,%eax
80103f51:	eb 11                	jmp    80103f64 <exit+0x104>
80103f53:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103f57:	90                   	nop
80103f58:	05 88 00 00 00       	add    $0x88,%eax
80103f5d:	3d b4 4f 11 80       	cmp    $0x80114fb4,%eax
...
80103f6f:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
	  p->priority = ptable.min_priority; //관리 프로세스 중 가장 작은 priority값. //add by jw (hw3)
80103f76:	8b 1d b4 4f 11 80    	mov    0x80114fb4,%ebx
80103f7c:	89 98 80 00 00 00    	mov    %ebx,0x80(%eax)
80103f82:	eb d4                	jmp    80103f58 <exit+0xf8>
  curproc->state = ZOMBIE;
80103f84:	c7 46 0c 05 00 00 00 	movl   $0x5,0xc(%esi)
  sched();
80103f8b:	e8 10 fe ff ff       	call   80103da0 <sched>
  panic("zombie exit");
80103f90:	83 ec 0c             	sub    $0xc,%esp
80103f93:	68 a8 78 10 80       	push   $0x801078a8
80103f98:	e8 f3 c3 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103f9d:	83 ec 0c             	sub    $0xc,%esp
80103fa0:	68 9b 78 10 80       	push   $0x8010789b
...
80103fbb:	68 80 2d 11 80       	push   $0x80112d80
80103fc0:	e8 eb 06 00 00       	call   801046b0 <acquire>
  pushcli();
80103fc5:	e8 e6 05 00 00       	call   801045b0 <pushcli>
  c = mycpu();
80103fca:	e8 31 f9 ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103fcf:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103fd5:	e8 26 06 00 00       	call   80104600 <popcli>
  myproc()->state = RUNNABLE;
80103fda:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  sched();
80103fe1:	e8 ba fd ff ff       	call   80103da0 <sched>
  release(&ptable.lock);
80103fe6:	c7 04 24 80 2d 11 80 	movl   $0x80112d80,(%esp)
80103fed:	e8 7e 07 00 00       	call   80104770 <release>
}
...
80104010:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80104013:	e8 98 05 00 00       	call   801045b0 <pushcli>
  c = mycpu();
80104018:	e8 e3 f8 ff ff       	call   80103900 <mycpu>
  p = c->proc;
8010401d:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104023:	e8 d8 05 00 00       	call   80104600 <popcli>
  if(p == 0)
...
80104034:	81 fe 80 2d 11 80    	cmp    $0x80112d80,%esi
8010403a:	74 4c                	je     80104088 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
8010403c:	83 ec 0c             	sub    $0xc,%esp
8010403f:	68 80 2d 11 80       	push   $0x80112d80
80104044:	e8 67 06 00 00       	call   801046b0 <acquire>
    release(lk);
80104049:	89 34 24             	mov    %esi,(%esp)
8010404c:	e8 1f 07 00 00       	call   80104770 <release>
  p->chan = chan;
...
80104060:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
    release(&ptable.lock);
80104067:	c7 04 24 80 2d 11 80 	movl   $0x80112d80,(%esp)
8010406e:	e8 fd 06 00 00       	call   80104770 <release>
    acquire(lk);
...
8010407f:	5d                   	pop    %ebp
    acquire(lk);
80104080:	e9 2b 06 00 00       	jmp    801046b0 <acquire>
...
801040a9:	68 ba 78 10 80       	push   $0x801078ba
801040ae:	e8 dd c2 ff ff       	call   80100390 <panic>
    panic("sleep");
801040b3:	83 ec 0c             	sub    $0xc,%esp
801040b6:	68 b4 78 10 80       	push   $0x801078b4
...
801040c8:	53                   	push   %ebx
  pushcli();
801040c9:	e8 e2 04 00 00       	call   801045b0 <pushcli>
  c = mycpu();
801040ce:	e8 2d f8 ff ff       	call   80103900 <mycpu>
  p = c->proc;
801040d3:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
801040d9:	e8 22 05 00 00       	call   80104600 <popcli>
  acquire(&ptable.lock);
801040de:	83 ec 0c             	sub    $0xc,%esp
801040e1:	68 80 2d 11 80       	push   $0x80112d80
801040e6:	e8 c5 05 00 00       	call   801046b0 <acquire>
801040eb:	83 c4 10             	add    $0x10,%esp
    havekids = 0;
801040ee:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801040f0:	bb b4 2d 11 80       	mov    $0x80112db4,%ebx
801040f5:	eb 17                	jmp    8010410e <wait+0x4e>
801040f7:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801040fe:	66 90                	xchg   %ax,%ax
80104100:	81 c3 88 00 00 00    	add    $0x88,%ebx
80104106:	81 fb b4 4f 11 80    	cmp    $0x80114fb4,%ebx
...
80104117:	74 37                	je     80104150 <wait+0x90>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104119:	81 c3 88 00 00 00    	add    $0x88,%ebx
      havekids = 1;
8010411f:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104124:	81 fb b4 4f 11 80    	cmp    $0x80114fb4,%ebx
...
8010413a:	68 80 2d 11 80       	push   $0x80112d80
...
80104162:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80104169:	e8 52 2e 00 00       	call   80106fc0 <freevm>
        release(&ptable.lock);
8010416e:	c7 04 24 80 2d 11 80 	movl   $0x80112d80,(%esp)
        p->pid = 0;
...
8010418e:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80104195:	e8 d6 05 00 00       	call   80104770 <release>
        return pid;
...
801041a9:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
801041ae:	68 80 2d 11 80       	push   $0x80112d80
801041b3:	e8 b8 05 00 00       	call   80104770 <release>
      return -1;
...
801041cb:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ptable.lock);
801041ce:	68 80 2d 11 80       	push   $0x80112d80
801041d3:	e8 d8 04 00 00       	call   801046b0 <acquire>
801041d8:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801041db:	b8 b4 2d 11 80       	mov    $0x80112db4,%eax
801041e0:	eb 12                	jmp    801041f4 <wakeup+0x34>
801041e2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
801041e8:	05 88 00 00 00       	add    $0x88,%eax
801041ed:	3d b4 4f 11 80       	cmp    $0x80114fb4,%eax
801041f2:	74 27                	je     8010421b <wakeup+0x5b>
    if(p->state == SLEEPING && p->chan == chan){
801041f4:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
801041f8:	75 ee                	jne    801041e8 <wakeup+0x28>
801041fa:	3b 58 20             	cmp    0x20(%eax),%ebx
801041fd:	75 e9                	jne    801041e8 <wakeup+0x28>
      p->state = RUNNABLE; //SLEEPING -> RUNNABLE로 상태 전이
801041ff:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
	  p->priority = ptable.min_priority; //관리 프로세스 중 가장 작은 priority값. //add by jw (hw3)
80104206:	8b 15 b4 4f 11 80    	mov    0x80114fb4,%edx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010420c:	05 88 00 00 00       	add    $0x88,%eax
	  p->priority = ptable.min_priority; //관리 프로세스 중 가장 작은 priority값. //add by jw (hw3)
80104211:	89 50 f8             	mov    %edx,-0x8(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104214:	3d b4 4f 11 80       	cmp    $0x80114fb4,%eax
80104219:	75 d9                	jne    801041f4 <wakeup+0x34>
  wakeup1(chan);
  release(&ptable.lock);
8010421b:	c7 45 08 80 2d 11 80 	movl   $0x80112d80,0x8(%ebp)
}
80104222:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104225:	c9                   	leave  
  release(&ptable.lock);
80104226:	e9 45 05 00 00       	jmp    80104770 <release>
8010422b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
8010422f:	90                   	nop
...
80104238:	83 ec 10             	sub    $0x10,%esp
8010423b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *p;

  acquire(&ptable.lock);
8010423e:	68 80 2d 11 80       	push   $0x80112d80
80104243:	e8 68 04 00 00       	call   801046b0 <acquire>
80104248:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010424b:	b8 b4 2d 11 80       	mov    $0x80112db4,%eax
80104250:	eb 12                	jmp    80104264 <kill+0x34>
80104252:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80104258:	05 88 00 00 00       	add    $0x88,%eax
8010425d:	3d b4 4f 11 80       	cmp    $0x80114fb4,%eax
80104262:	74 34                	je     80104298 <kill+0x68>
    if(p->pid == pid){
80104264:	39 58 10             	cmp    %ebx,0x10(%eax)
80104267:	75 ef                	jne    80104258 <kill+0x28>
      p->killed = 1;
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
80104269:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
      p->killed = 1;
8010426d:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
      if(p->state == SLEEPING)
80104274:	75 07                	jne    8010427d <kill+0x4d>
        p->state = RUNNABLE;
80104276:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
      release(&ptable.lock);
8010427d:	83 ec 0c             	sub    $0xc,%esp
80104280:	68 80 2d 11 80       	push   $0x80112d80
80104285:	e8 e6 04 00 00       	call   80104770 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
8010429b:	68 80 2d 11 80       	push   $0x80112d80
801042a0:	e8 cb 04 00 00       	call   80104770 <release>
}
...
801042c9:	8d 75 e8             	lea    -0x18(%ebp),%esi
801042cc:	53                   	push   %ebx
801042cd:	bb 20 2e 11 80       	mov    $0x80112e20,%ebx
801042d2:	83 ec 3c             	sub    $0x3c,%esp
801042d5:	eb 2b                	jmp    80104302 <procdump+0x42>
...
801042e3:	68 df 7c 10 80       	push   $0x80107cdf
801042e8:	e8 c3 c3 ff ff       	call   801006b0 <cprintf>
801042ed:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801042f0:	81 c3 88 00 00 00    	add    $0x88,%ebx
801042f6:	81 fb 20 50 11 80    	cmp    $0x80115020,%ebx
801042fc:	0f 84 8e 00 00 00    	je     80104390 <procdump+0xd0>
    if(p->state == UNUSED)
80104302:	8b 43 a0             	mov    -0x60(%ebx),%eax
80104305:	85 c0                	test   %eax,%eax
80104307:	74 e7                	je     801042f0 <procdump+0x30>
      state = "???";
80104309:	ba cb 78 10 80       	mov    $0x801078cb,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
8010430e:	83 f8 05             	cmp    $0x5,%eax
80104311:	77 11                	ja     80104324 <procdump+0x64>
80104313:	8b 14 85 5c 79 10 80 	mov    -0x7fef86a4(,%eax,4),%edx
      state = "???";
8010431a:	b8 cb 78 10 80       	mov    $0x801078cb,%eax
8010431f:	85 d2                	test   %edx,%edx
80104321:	0f 44 d0             	cmove  %eax,%edx
    cprintf("%d %s %s", p->pid, state, p->name);
80104324:	53                   	push   %ebx
80104325:	52                   	push   %edx
80104326:	ff 73 a4             	pushl  -0x5c(%ebx)
80104329:	68 cf 78 10 80       	push   $0x801078cf
8010432e:	e8 7d c3 ff ff       	call   801006b0 <cprintf>
    if(p->state == SLEEPING){
80104333:	83 c4 10             	add    $0x10,%esp
80104336:	83 7b a0 02          	cmpl   $0x2,-0x60(%ebx)
8010433a:	75 a4                	jne    801042e0 <procdump+0x20>
      getcallerpcs((uint*)p->context->ebp+2, pc);
8010433c:	83 ec 08             	sub    $0x8,%esp
8010433f:	8d 45 c0             	lea    -0x40(%ebp),%eax
80104342:	8d 7d c0             	lea    -0x40(%ebp),%edi
80104345:	50                   	push   %eax
80104346:	8b 43 b0             	mov    -0x50(%ebx),%eax
80104349:	8b 40 0c             	mov    0xc(%eax),%eax
8010434c:	83 c0 08             	add    $0x8,%eax
8010434f:	50                   	push   %eax
80104350:	e8 fb 01 00 00       	call   80104550 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
80104364:	0f 84 76 ff ff ff    	je     801042e0 <procdump+0x20>
        cprintf(" %p", pc[i]);
8010436a:	83 ec 08             	sub    $0x8,%esp
8010436d:	83 c7 04             	add    $0x4,%edi
80104370:	52                   	push   %edx
80104371:	68 21 73 10 80       	push   $0x80107321
80104376:	e8 35 c3 ff ff       	call   801006b0 <cprintf>
      for(i=0; i<10 && pc[i] != 0; i++)
8010437b:	83 c4 10             	add    $0x10,%esp
8010437e:	39 fe                	cmp    %edi,%esi
80104380:	75 de                	jne    80104360 <procdump+0xa0>
80104382:	e9 59 ff ff ff       	jmp    801042e0 <procdump+0x20>
...
801043af:	68 80 2d 11 80       	push   $0x80112d80
801043b4:	e8 f7 02 00 00       	call   801046b0 <acquire>
  pushcli();
801043b9:	e8 f2 01 00 00       	call   801045b0 <pushcli>
  c = mycpu();
801043be:	e8 3d f5 ff ff       	call   80103900 <mycpu>
  p = c->proc;
801043c3:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801043c9:	e8 32 02 00 00       	call   80104600 <popcli>
...
801043ce:	83 c4 10             	add    $0x10,%esp
	myproc()->weight = weight;
801043d1:	89 b3 84 00 00 00    	mov    %esi,0x84(%ebx)
	release(&ptable.lock);
801043d7:	c7 45 08 80 2d 11 80 	movl   $0x80112d80,0x8(%ebp)
...
801043e3:	5d                   	pop    %ebp
	release(&ptable.lock);
801043e4:	e9 87 03 00 00       	jmp    80104770 <release>
...
801043fe:	68 74 79 10 80       	push   $0x80107974
...
8010445d:	e8 9e fb ff ff       	call   80104000 <sleep>
  while (lk->locked) {
...
8010446b:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104471:	e8 1a f5 ff ff       	call   80103990 <myproc>
...
801044b8:	e8 03 fd ff ff       	call   801041c0 <wakeup>
  release(&lk->lk);
...
80104513:	e8 78 f4 ff ff       	call   80103990 <myproc>
...
801045bd:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
801045be:	e8 3d f3 ff ff       	call   80103900 <mycpu>
...
8010461f:	e8 dc f2 ff ff       	call   80103900 <mycpu>
...
80104645:	68 7f 79 10 80       	push   $0x8010797f
8010464a:	e8 41 bd ff ff       	call   80100390 <panic>
    panic("popcli");
8010464f:	83 ec 0c             	sub    $0xc,%esp
80104652:	68 96 79 10 80       	push   $0x80107996
...
801046f4:	e8 07 f2 ff ff       	call   80103900 <mycpu>
...
80104757:	68 9d 79 10 80       	push   $0x8010799d
...
801047b0:	68 a5 79 10 80       	push   $0x801079a5
...
80104a0b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
80104a0e:	e8 7d ef ff ff       	call   80103990 <myproc>
...
80104ab7:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104aba:	e8 d1 ee ff ff       	call   80103990 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104afc:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
80104aff:	e8 8c ee ff ff       	call   80103990 <myproc>
...
80104b98:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104b9b:	e8 f0 ed ff ff       	call   80103990 <myproc>
...
80104bab:	83 fa 17             	cmp    $0x17,%edx
80104bae:	77 30                	ja     80104be0 <syscall+0x50>
80104bb0:	8b 14 85 40 7a 10 80 	mov    -0x7fef85c0(,%eax,4),%edx
80104bb7:	85 d2                	test   %edx,%edx
80104bb9:	74 25                	je     80104be0 <syscall+0x50>
    curproc->tf->eax = syscalls[num]();
80104bbb:	ff d2                	call   *%edx
80104bbd:	8b 53 18             	mov    0x18(%ebx),%edx
80104bc0:	89 42 1c             	mov    %eax,0x1c(%edx)
	if (curproc->trace >> num) {
		cprintf("syscall traced: pid=%d, syscall=%s, %d returned\n", curproc->pid, syscall_names[num-1], curproc->tf->eax);
	}
	*/

	if (curproc->weight){
80104bc3:	8b 83 84 00 00 00    	mov    0x84(%ebx),%eax
80104bc9:	85 c0                	test   %eax,%eax
80104bcb:	74 3b                	je     80104c08 <syscall+0x78>
		do_weightset(curproc->weight);
80104bcd:	83 ec 0c             	sub    $0xc,%esp
80104bd0:	50                   	push   %eax
80104bd1:	e8 ca f7 ff ff       	call   801043a0 <do_weightset>
...
80104bd6:	8b 5d fc             	mov    -0x4(%ebp),%ebx
...
80104be8:	68 b7 79 10 80       	push   $0x801079b7
...
80104c0b:	68 ad 79 10 80       	push   $0x801079ad
80104c10:	e8 9b ba ff ff       	call   801006b0 <cprintf>
		curproc->tf->eax = -1;
80104c15:	8b 43 18             	mov    0x18(%ebx),%eax
80104c18:	83 c4 10             	add    $0x10,%esp
80104c1b:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
}
...
80104c47:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  if((dp = nameiparent(path, name)) == 0)
80104c4a:	e8 01 d4 ff ff       	call   80102050 <nameiparent>
...
80104c60:	e8 fb ca ff ff       	call   80101760 <ilock>
...
80104c6c:	e8 3f d0 ff ff       	call   80101cb0 <dirlookup>
...
80104c7e:	e8 7d cd ff ff       	call   80101a00 <iunlockput>
    ilock(ip);
80104c83:	89 34 24             	mov    %esi,(%esp)
80104c86:	e8 d5 ca ff ff       	call   80101760 <ilock>
...
80104cb4:	31 f6                	xor    %esi,%esi
    iunlockput(ip);
80104cb6:	e8 45 cd ff ff       	call   80101a00 <iunlockput>
    return 0;
...
80104cd8:	ff 33                	pushl  (%ebx)
80104cda:	e8 01 c9 ff ff       	call   801015e0 <ialloc>
...
80104cf0:	e8 6b ca ff ff       	call   80101760 <ilock>
  ip->major = major;
...
80104d11:	e8 8a c9 ff ff       	call   801016a0 <iupdate>
...
80104d23:	ff 76 04             	pushl  0x4(%esi)
80104d26:	57                   	push   %edi
80104d27:	53                   	push   %ebx
80104d28:	e8 43 d2 ff ff       	call   80101f70 <dirlink>
...
80104d38:	e8 c3 cc ff ff       	call   80101a00 <iunlockput>
  return ip;
...
80104d59:	e8 42 c9 ff ff       	call   801016a0 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80104d5e:	83 c4 0c             	add    $0xc,%esp
80104d61:	ff 76 04             	pushl  0x4(%esi)
80104d64:	68 c0 7a 10 80       	push   $0x80107ac0
80104d69:	56                   	push   %esi
80104d6a:	e8 01 d2 ff ff       	call   80101f70 <dirlink>
...
80104d79:	ff 73 04             	pushl  0x4(%ebx)
80104d7c:	68 bf 7a 10 80       	push   $0x80107abf
80104d81:	56                   	push   %esi
80104d82:	e8 e9 d1 ff ff       	call   80101f70 <dirlink>
...
80104d91:	68 b3 7a 10 80       	push   $0x80107ab3
...
80104daf:	68 c2 7a 10 80       	push   $0x80107ac2
80104db4:	e8 d7 b5 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104db9:	83 ec 0c             	sub    $0xc,%esp
80104dbc:	68 a4 7a 10 80       	push   $0x80107aa4
...
80104dd0 <argfd.constprop.0>:
argfd(int n, int *pfd, struct file **pf)
80104dd0:	55                   	push   %ebp
80104dd1:	89 e5                	mov    %esp,%ebp
80104dd3:	56                   	push   %esi
80104dd4:	89 d6                	mov    %edx,%esi
80104dd6:	53                   	push   %ebx
80104dd7:	89 c3                	mov    %eax,%ebx
  if(argint(n, &fd) < 0)
...
80104de2:	e8 b9 fc ff ff       	call   80104aa0 <argint>
80104de7:	83 c4 10             	add    $0x10,%esp
80104dea:	85 c0                	test   %eax,%eax
80104dec:	78 2a                	js     80104e18 <argfd.constprop.0+0x48>
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
80104dee:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
80104df2:	77 24                	ja     80104e18 <argfd.constprop.0+0x48>
80104df4:	e8 97 eb ff ff       	call   80103990 <myproc>
80104df9:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104dfc:	8b 44 90 28          	mov    0x28(%eax,%edx,4),%eax
80104e00:	85 c0                	test   %eax,%eax
80104e02:	74 14                	je     80104e18 <argfd.constprop.0+0x48>
  if(pfd)
80104e04:	85 db                	test   %ebx,%ebx
80104e06:	74 02                	je     80104e0a <argfd.constprop.0+0x3a>
    *pfd = fd;
80104e08:	89 13                	mov    %edx,(%ebx)
    *pf = f;
80104e0a:	89 06                	mov    %eax,(%esi)
  return 0;
80104e0c:	31 c0                	xor    %eax,%eax
}
80104e0e:	8d 65 f8             	lea    -0x8(%ebp),%esp
80104e11:	5b                   	pop    %ebx
80104e12:	5e                   	pop    %esi
80104e13:	5d                   	pop    %ebp
80104e14:	c3                   	ret    
...
80104e1d:	eb ef                	jmp    80104e0e <argfd.constprop.0+0x3e>
80104e1f:	90                   	nop
...
80104e2a:	53                   	push   %ebx
  if(argfd(0, 0, &f) < 0)
80104e2b:	8d 55 f4             	lea    -0xc(%ebp),%edx
{
80104e2e:	83 ec 10             	sub    $0x10,%esp
  if(argfd(0, 0, &f) < 0)
80104e31:	e8 9a ff ff ff       	call   80104dd0 <argfd.constprop.0>
80104e36:	85 c0                	test   %eax,%eax
80104e38:	78 1e                	js     80104e58 <sys_dup+0x38>
  if((fd=fdalloc(f)) < 0)
80104e3a:	8b 75 f4             	mov    -0xc(%ebp),%esi
  for(fd = 0; fd < NOFILE; fd++){
80104e3d:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104e3f:	e8 4c eb ff ff       	call   80103990 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
80104e44:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(curproc->ofile[fd] == 0){
80104e48:	8b 54 98 28          	mov    0x28(%eax,%ebx,4),%edx
80104e4c:	85 d2                	test   %edx,%edx
80104e4e:	74 20                	je     80104e70 <sys_dup+0x50>
  for(fd = 0; fd < NOFILE; fd++){
80104e50:	83 c3 01             	add    $0x1,%ebx
80104e53:	83 fb 10             	cmp    $0x10,%ebx
80104e56:	75 f0                	jne    80104e48 <sys_dup+0x28>
}
...
80104ec9:	e8 22 fc ff ff       	call   80104af0 <argptr>
80104ece:	83 c4 10             	add    $0x10,%esp
80104ed1:	85 c0                	test   %eax,%eax
80104ed3:	78 1b                	js     80104ef0 <sys_read+0x60>
...
80104ee1:	e8 0a c1 ff ff       	call   80100ff0 <fileread>
...
80104f09:	83 ec 18             	sub    $0x18,%esp
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argptr(1, &p, n) < 0)
80104f0c:	8d 55 ec             	lea    -0x14(%ebp),%edx
80104f0f:	e8 bc fe ff ff       	call   80104dd0 <argfd.constprop.0>
80104f14:	85 c0                	test   %eax,%eax
80104f16:	78 48                	js     80104f60 <sys_write+0x60>
80104f18:	83 ec 08             	sub    $0x8,%esp
80104f1b:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104f1e:	50                   	push   %eax
80104f1f:	6a 02                	push   $0x2
80104f21:	e8 7a fb ff ff       	call   80104aa0 <argint>
80104f26:	83 c4 10             	add    $0x10,%esp
80104f29:	85 c0                	test   %eax,%eax
80104f2b:	78 33                	js     80104f60 <sys_write+0x60>
80104f2d:	83 ec 04             	sub    $0x4,%esp
80104f30:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104f33:	ff 75 f0             	pushl  -0x10(%ebp)
80104f36:	50                   	push   %eax
80104f37:	6a 01                	push   $0x1
80104f39:	e8 b2 fb ff ff       	call   80104af0 <argptr>
80104f3e:	83 c4 10             	add    $0x10,%esp
80104f41:	85 c0                	test   %eax,%eax
80104f43:	78 1b                	js     80104f60 <sys_write+0x60>
  return filewrite(f, p, n);
80104f45:	83 ec 04             	sub    $0x4,%esp
80104f48:	ff 75 f0             	pushl  -0x10(%ebp)
80104f4b:	ff 75 f4             	pushl  -0xc(%ebp)
80104f4e:	ff 75 ec             	pushl  -0x14(%ebp)
80104f51:	e8 3a c1 ff ff       	call   80101090 <filewrite>
...
80104f77:	83 ec 18             	sub    $0x18,%esp
  if(argfd(0, &fd, &f) < 0)
80104f7a:	8d 55 f4             	lea    -0xc(%ebp),%edx
80104f7d:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104f80:	e8 4b fe ff ff       	call   80104dd0 <argfd.constprop.0>
80104f85:	85 c0                	test   %eax,%eax
80104f87:	78 27                	js     80104fb0 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80104f89:	e8 02 ea ff ff       	call   80103990 <myproc>
80104f8e:	8b 55 f0             	mov    -0x10(%ebp),%edx
  fileclose(f);
80104f91:	83 ec 0c             	sub    $0xc,%esp
  myproc()->ofile[fd] = 0;
80104f94:	c7 44 90 28 00 00 00 	movl   $0x0,0x28(%eax,%edx,4)
80104f9b:	00 
  fileclose(f);
80104f9c:	ff 75 f4             	pushl  -0xc(%ebp)
80104f9f:	e8 1c bf ff ff       	call   80100ec0 <fileclose>
  return 0;
...
80104fc9:	83 ec 18             	sub    $0x18,%esp
  if(argfd(0, 0, &f) < 0 || argptr(1, (void*)&st, sizeof(*st)) < 0)
80104fcc:	8d 55 f0             	lea    -0x10(%ebp),%edx
80104fcf:	e8 fc fd ff ff       	call   80104dd0 <argfd.constprop.0>
80104fd4:	85 c0                	test   %eax,%eax
80104fd6:	78 30                	js     80105008 <sys_fstat+0x48>
80104fd8:	83 ec 04             	sub    $0x4,%esp
80104fdb:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104fde:	6a 14                	push   $0x14
80104fe0:	50                   	push   %eax
80104fe1:	6a 01                	push   $0x1
80104fe3:	e8 08 fb ff ff       	call   80104af0 <argptr>
80104fe8:	83 c4 10             	add    $0x10,%esp
80104feb:	85 c0                	test   %eax,%eax
80104fed:	78 19                	js     80105008 <sys_fstat+0x48>
  return filestat(f, st);
80104fef:	83 ec 08             	sub    $0x8,%esp
80104ff2:	ff 75 f4             	pushl  -0xc(%ebp)
80104ff5:	ff 75 f0             	pushl  -0x10(%ebp)
80104ff8:	e8 a3 bf ff ff       	call   80100fa0 <filestat>
...
80105019:	8d 45 d4             	lea    -0x2c(%ebp),%eax
{
8010501c:	53                   	push   %ebx
8010501d:	83 ec 34             	sub    $0x34,%esp
  if(argstr(0, &old) < 0 || argstr(1, &new) < 0)
80105020:	50                   	push   %eax
80105021:	6a 00                	push   $0x0
80105023:	e8 28 fb ff ff       	call   80104b50 <argstr>
80105028:	83 c4 10             	add    $0x10,%esp
8010502b:	85 c0                	test   %eax,%eax
8010502d:	0f 88 ff 00 00 00    	js     80105132 <sys_link+0x122>
80105033:	83 ec 08             	sub    $0x8,%esp
80105036:	8d 45 d0             	lea    -0x30(%ebp),%eax
80105039:	50                   	push   %eax
8010503a:	6a 01                	push   $0x1
8010503c:	e8 0f fb ff ff       	call   80104b50 <argstr>
80105041:	83 c4 10             	add    $0x10,%esp
80105044:	85 c0                	test   %eax,%eax
80105046:	0f 88 e6 00 00 00    	js     80105132 <sys_link+0x122>
  begin_op();
8010504c:	e8 df dc ff ff       	call   80102d30 <begin_op>
  if((ip = namei(old)) == 0){
80105051:	83 ec 0c             	sub    $0xc,%esp
80105054:	ff 75 d4             	pushl  -0x2c(%ebp)
80105057:	e8 d4 cf ff ff       	call   80102030 <namei>
8010505c:	83 c4 10             	add    $0x10,%esp
8010505f:	89 c3                	mov    %eax,%ebx
80105061:	85 c0                	test   %eax,%eax
80105063:	0f 84 e8 00 00 00    	je     80105151 <sys_link+0x141>
  ilock(ip);
80105069:	83 ec 0c             	sub    $0xc,%esp
8010506c:	50                   	push   %eax
8010506d:	e8 ee c6 ff ff       	call   80101760 <ilock>
  if(ip->type == T_DIR){
80105072:	83 c4 10             	add    $0x10,%esp
80105075:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
8010507a:	0f 84 b9 00 00 00    	je     80105139 <sys_link+0x129>
  iupdate(ip);
80105080:	83 ec 0c             	sub    $0xc,%esp
  ip->nlink++;
80105083:	66 83 43 56 01       	addw   $0x1,0x56(%ebx)
  if((dp = nameiparent(new, name)) == 0)
80105088:	8d 7d da             	lea    -0x26(%ebp),%edi
  iupdate(ip);
8010508b:	53                   	push   %ebx
8010508c:	e8 0f c6 ff ff       	call   801016a0 <iupdate>
  iunlock(ip);
80105091:	89 1c 24             	mov    %ebx,(%esp)
80105094:	e8 a7 c7 ff ff       	call   80101840 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80105099:	58                   	pop    %eax
8010509a:	5a                   	pop    %edx
8010509b:	57                   	push   %edi
8010509c:	ff 75 d0             	pushl  -0x30(%ebp)
8010509f:	e8 ac cf ff ff       	call   80102050 <nameiparent>
801050a4:	83 c4 10             	add    $0x10,%esp
801050a7:	89 c6                	mov    %eax,%esi
801050a9:	85 c0                	test   %eax,%eax
801050ab:	74 5f                	je     8010510c <sys_link+0xfc>
  ilock(dp);
801050ad:	83 ec 0c             	sub    $0xc,%esp
801050b0:	50                   	push   %eax
801050b1:	e8 aa c6 ff ff       	call   80101760 <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
801050b6:	8b 03                	mov    (%ebx),%eax
801050b8:	83 c4 10             	add    $0x10,%esp
801050bb:	39 06                	cmp    %eax,(%esi)
801050bd:	75 41                	jne    80105100 <sys_link+0xf0>
801050bf:	83 ec 04             	sub    $0x4,%esp
801050c2:	ff 73 04             	pushl  0x4(%ebx)
801050c5:	57                   	push   %edi
801050c6:	56                   	push   %esi
801050c7:	e8 a4 ce ff ff       	call   80101f70 <dirlink>
801050cc:	83 c4 10             	add    $0x10,%esp
801050cf:	85 c0                	test   %eax,%eax
801050d1:	78 2d                	js     80105100 <sys_link+0xf0>
  iunlockput(dp);
801050d3:	83 ec 0c             	sub    $0xc,%esp
801050d6:	56                   	push   %esi
801050d7:	e8 24 c9 ff ff       	call   80101a00 <iunlockput>
  iput(ip);
801050dc:	89 1c 24             	mov    %ebx,(%esp)
801050df:	e8 ac c7 ff ff       	call   80101890 <iput>
  end_op();
801050e4:	e8 b7 dc ff ff       	call   80102da0 <end_op>
  return 0;
...
80105104:	e8 f7 c8 ff ff       	call   80101a00 <iunlockput>
    goto bad;
...
80105110:	e8 4b c6 ff ff       	call   80101760 <ilock>
  ip->nlink--;
80105115:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
8010511a:	89 1c 24             	mov    %ebx,(%esp)
8010511d:	e8 7e c5 ff ff       	call   801016a0 <iupdate>
  iunlockput(ip);
80105122:	89 1c 24             	mov    %ebx,(%esp)
80105125:	e8 d6 c8 ff ff       	call   80101a00 <iunlockput>
  end_op();
8010512a:	e8 71 dc ff ff       	call   80102da0 <end_op>
  return -1;
8010512f:	83 c4 10             	add    $0x10,%esp
80105132:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105137:	eb b5                	jmp    801050ee <sys_link+0xde>
    iunlockput(ip);
80105139:	83 ec 0c             	sub    $0xc,%esp
8010513c:	53                   	push   %ebx
8010513d:	e8 be c8 ff ff       	call   80101a00 <iunlockput>
    end_op();
80105142:	e8 59 dc ff ff       	call   80102da0 <end_op>
    return -1;
80105147:	83 c4 10             	add    $0x10,%esp
8010514a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010514f:	eb 9d                	jmp    801050ee <sys_link+0xde>
    end_op();
80105151:	e8 4a dc ff ff       	call   80102da0 <end_op>
    return -1;
80105156:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010515b:	eb 91                	jmp    801050ee <sys_link+0xde>
...
80105168:	56                   	push   %esi
  if(argstr(0, &path) < 0)
80105169:	8d 45 c0             	lea    -0x40(%ebp),%eax
{
8010516c:	53                   	push   %ebx
8010516d:	83 ec 54             	sub    $0x54,%esp
  if(argstr(0, &path) < 0)
80105170:	50                   	push   %eax
80105171:	6a 00                	push   $0x0
80105173:	e8 d8 f9 ff ff       	call   80104b50 <argstr>
80105178:	83 c4 10             	add    $0x10,%esp
8010517b:	85 c0                	test   %eax,%eax
8010517d:	0f 88 7d 01 00 00    	js     80105300 <sys_unlink+0x1a0>
  begin_op();
80105183:	e8 a8 db ff ff       	call   80102d30 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80105188:	8d 5d ca             	lea    -0x36(%ebp),%ebx
8010518b:	83 ec 08             	sub    $0x8,%esp
8010518e:	53                   	push   %ebx
8010518f:	ff 75 c0             	pushl  -0x40(%ebp)
80105192:	e8 b9 ce ff ff       	call   80102050 <nameiparent>
80105197:	83 c4 10             	add    $0x10,%esp
8010519a:	89 c6                	mov    %eax,%esi
8010519c:	85 c0                	test   %eax,%eax
8010519e:	0f 84 66 01 00 00    	je     8010530a <sys_unlink+0x1aa>
  ilock(dp);
801051a4:	83 ec 0c             	sub    $0xc,%esp
801051a7:	50                   	push   %eax
801051a8:	e8 b3 c5 ff ff       	call   80101760 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
801051ad:	58                   	pop    %eax
801051ae:	5a                   	pop    %edx
801051af:	68 c0 7a 10 80       	push   $0x80107ac0
801051b4:	53                   	push   %ebx
801051b5:	e8 d6 ca ff ff       	call   80101c90 <namecmp>
801051ba:	83 c4 10             	add    $0x10,%esp
801051bd:	85 c0                	test   %eax,%eax
801051bf:	0f 84 03 01 00 00    	je     801052c8 <sys_unlink+0x168>
801051c5:	83 ec 08             	sub    $0x8,%esp
801051c8:	68 bf 7a 10 80       	push   $0x80107abf
801051cd:	53                   	push   %ebx
801051ce:	e8 bd ca ff ff       	call   80101c90 <namecmp>
801051d3:	83 c4 10             	add    $0x10,%esp
801051d6:	85 c0                	test   %eax,%eax
801051d8:	0f 84 ea 00 00 00    	je     801052c8 <sys_unlink+0x168>
...
801051e7:	e8 c4 ca ff ff       	call   80101cb0 <dirlookup>
801051ec:	83 c4 10             	add    $0x10,%esp
801051ef:	89 c3                	mov    %eax,%ebx
801051f1:	85 c0                	test   %eax,%eax
801051f3:	0f 84 cf 00 00 00    	je     801052c8 <sys_unlink+0x168>
  ilock(ip);
...
8010520a:	0f 8e 23 01 00 00    	jle    80105333 <sys_unlink+0x1d3>
...
80105222:	e8 99 f5 ff ff       	call   801047c0 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105227:	6a 10                	push   $0x10
80105229:	ff 75 c4             	pushl  -0x3c(%ebp)
8010522c:	57                   	push   %edi
8010522d:	56                   	push   %esi
8010522e:	e8 2d c9 ff ff       	call   80101b60 <writei>
80105233:	83 c4 20             	add    $0x20,%esp
80105236:	83 f8 10             	cmp    $0x10,%eax
80105239:	0f 85 e7 00 00 00    	jne    80105326 <sys_unlink+0x1c6>
  if(ip->type == T_DIR){
8010523f:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80105244:	0f 84 96 00 00 00    	je     801052e0 <sys_unlink+0x180>
  iunlockput(dp);
8010524a:	83 ec 0c             	sub    $0xc,%esp
8010524d:	56                   	push   %esi
8010524e:	e8 ad c7 ff ff       	call   80101a00 <iunlockput>
  ip->nlink--;
80105253:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80105258:	89 1c 24             	mov    %ebx,(%esp)
8010525b:	e8 40 c4 ff ff       	call   801016a0 <iupdate>
  iunlockput(ip);
80105260:	89 1c 24             	mov    %ebx,(%esp)
80105263:	e8 98 c7 ff ff       	call   80101a00 <iunlockput>
  end_op();
80105268:	e8 33 db ff ff       	call   80102da0 <end_op>
  return 0;
8010526d:	83 c4 10             	add    $0x10,%esp
80105270:	31 c0                	xor    %eax,%eax
}
80105272:	8d 65 f4             	lea    -0xc(%ebp),%esp
80105275:	5b                   	pop    %ebx
80105276:	5e                   	pop    %esi
80105277:	5f                   	pop    %edi
80105278:	5d                   	pop    %ebp
...
80105296:	76 82                	jbe    8010521a <sys_unlink+0xba>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105298:	6a 10                	push   $0x10
8010529a:	52                   	push   %edx
8010529b:	57                   	push   %edi
8010529c:	53                   	push   %ebx
8010529d:	89 55 b4             	mov    %edx,-0x4c(%ebp)
801052a0:	e8 bb c7 ff ff       	call   80101a60 <readi>
801052a5:	83 c4 10             	add    $0x10,%esp
801052a8:	8b 55 b4             	mov    -0x4c(%ebp),%edx
801052ab:	83 f8 10             	cmp    $0x10,%eax
801052ae:	75 69                	jne    80105319 <sys_unlink+0x1b9>
    if(de.inum != 0)
801052b0:	66 83 7d d8 00       	cmpw   $0x0,-0x28(%ebp)
801052b5:	74 d9                	je     80105290 <sys_unlink+0x130>
    iunlockput(ip);
801052b7:	83 ec 0c             	sub    $0xc,%esp
801052ba:	53                   	push   %ebx
801052bb:	e8 40 c7 ff ff       	call   80101a00 <iunlockput>
    goto bad;
...
801052cc:	e8 2f c7 ff ff       	call   80101a00 <iunlockput>
  end_op();
801052d1:	e8 ca da ff ff       	call   80102da0 <end_op>
  return -1;
801052d6:	83 c4 10             	add    $0x10,%esp
801052d9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801052de:	eb 92                	jmp    80105272 <sys_unlink+0x112>
    iupdate(dp);
801052e0:	83 ec 0c             	sub    $0xc,%esp
    dp->nlink--;
801052e3:	66 83 6e 56 01       	subw   $0x1,0x56(%esi)
    iupdate(dp);
801052e8:	56                   	push   %esi
801052e9:	e8 b2 c3 ff ff       	call   801016a0 <iupdate>
801052ee:	83 c4 10             	add    $0x10,%esp
801052f1:	e9 54 ff ff ff       	jmp    8010524a <sys_unlink+0xea>
...
80105305:	e9 68 ff ff ff       	jmp    80105272 <sys_unlink+0x112>
    end_op();
8010530a:	e8 91 da ff ff       	call   80102da0 <end_op>
    return -1;
8010530f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105314:	e9 59 ff ff ff       	jmp    80105272 <sys_unlink+0x112>
      panic("isdirempty: readi");
80105319:	83 ec 0c             	sub    $0xc,%esp
8010531c:	68 e4 7a 10 80       	push   $0x80107ae4
80105321:	e8 6a b0 ff ff       	call   80100390 <panic>
    panic("unlink: writei");
80105326:	83 ec 0c             	sub    $0xc,%esp
80105329:	68 f6 7a 10 80       	push   $0x80107af6
8010532e:	e8 5d b0 ff ff       	call   80100390 <panic>
    panic("unlink: nlink < 1");
80105333:	83 ec 0c             	sub    $0xc,%esp
80105336:	68 d2 7a 10 80       	push   $0x80107ad2
8010533b:	e8 50 b0 ff ff       	call   80100390 <panic>
...
80105349:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
8010534c:	53                   	push   %ebx
8010534d:	83 ec 24             	sub    $0x24,%esp
  if(argstr(0, &path) < 0 || argint(1, &omode) < 0)
80105350:	50                   	push   %eax
80105351:	6a 00                	push   $0x0
80105353:	e8 f8 f7 ff ff       	call   80104b50 <argstr>
80105358:	83 c4 10             	add    $0x10,%esp
8010535b:	85 c0                	test   %eax,%eax
8010535d:	0f 88 8a 00 00 00    	js     801053ed <sys_open+0xad>
80105363:	83 ec 08             	sub    $0x8,%esp
80105366:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105369:	50                   	push   %eax
8010536a:	6a 01                	push   $0x1
8010536c:	e8 2f f7 ff ff       	call   80104aa0 <argint>
80105371:	83 c4 10             	add    $0x10,%esp
80105374:	85 c0                	test   %eax,%eax
80105376:	78 75                	js     801053ed <sys_open+0xad>
    return -1;

  begin_op();
80105378:	e8 b3 d9 ff ff       	call   80102d30 <begin_op>

  if(omode & O_CREATE){
8010537d:	f6 45 e5 02          	testb  $0x2,-0x1b(%ebp)
80105381:	75 75                	jne    801053f8 <sys_open+0xb8>
    if(ip == 0){
      end_op();
      return -1;
    }
...
80105386:	ff 75 e0             	pushl  -0x20(%ebp)
80105389:	e8 a2 cc ff ff       	call   80102030 <namei>
8010538e:	83 c4 10             	add    $0x10,%esp
80105391:	89 c6                	mov    %eax,%esi
80105393:	85 c0                	test   %eax,%eax
80105395:	74 7e                	je     80105415 <sys_open+0xd5>
      end_op();
      return -1;
    }
    ilock(ip);
...
8010539b:	e8 c0 c3 ff ff       	call   80101760 <ilock>
...
801053ae:	e8 4d ba ff ff       	call   80100e00 <filealloc>
...
801053d4:	e8 e7 ba ff ff       	call   80100ec0 <fileclose>
801053d9:	83 c4 10             	add    $0x10,%esp
    iunlockput(ip);
801053dc:	83 ec 0c             	sub    $0xc,%esp
801053df:	56                   	push   %esi
801053e0:	e8 1b c6 ff ff       	call   80101a00 <iunlockput>
    end_op();
...
80105407:	e8 24 f8 ff ff       	call   80104c30 <create>
    if(ip == 0){
...
80105430:	e8 0b c4 ff ff       	call   80101840 <iunlock>
  end_op();
...
801054e2:	c9                   	leave  
801054e3:	c3                   	ret    
801054e4:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
80105562:	e8 99 c4 ff ff       	call   80101a00 <iunlockput>
  end_op();
80105567:	e8 34 d8 ff ff       	call   80102da0 <end_op>
  return 0;
...
801055d5:	e8 86 c1 ff ff       	call   80101760 <ilock>
  if(ip->type != T_DIR){
801055da:	83 c4 10             	add    $0x10,%esp
801055dd:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
801055e2:	75 2c                	jne    80105610 <sys_chdir+0x80>
    iunlockput(ip);
    end_op();
    return -1;
  }
...
801055e8:	e8 53 c2 ff ff       	call   80101840 <iunlock>
  iput(curproc->cwd);
801055ed:	58                   	pop    %eax
801055ee:	ff 76 68             	pushl  0x68(%esi)
801055f1:	e8 9a c2 ff ff       	call   80101890 <iput>
  end_op();
801055f6:	e8 a5 d7 ff ff       	call   80102da0 <end_op>
  curproc->cwd = ip;
801055fb:	89 5e 68             	mov    %ebx,0x68(%esi)
  return 0;
801055fe:	83 c4 10             	add    $0x10,%esp
80105601:	31 c0                	xor    %eax,%eax
}
80105603:	8d 65 f8             	lea    -0x8(%ebp),%esp
80105606:	5b                   	pop    %ebx
80105607:	5e                   	pop    %esi
80105608:	5d                   	pop    %ebp
80105609:	c3                   	ret    
...
80105614:	e8 e7 c3 ff ff       	call   80101a00 <iunlockput>
    end_op();
80105619:	e8 82 d7 ff ff       	call   80102da0 <end_op>
    return -1;
8010561e:	83 c4 10             	add    $0x10,%esp
80105621:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105626:	eb db                	jmp    80105603 <sys_chdir+0x73>
80105628:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010562f:	90                   	nop
    end_op();
80105630:	e8 6b d7 ff ff       	call   80102da0 <end_op>
    return -1;
80105635:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010563a:	eb c7                	jmp    80105603 <sys_chdir+0x73>
...
80105649:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
{
8010564f:	53                   	push   %ebx
80105650:	81 ec a4 00 00 00    	sub    $0xa4,%esp
  if(argstr(0, &path) < 0 || argint(1, (int*)&uargv) < 0){
80105656:	50                   	push   %eax
80105657:	6a 00                	push   $0x0
80105659:	e8 f2 f4 ff ff       	call   80104b50 <argstr>
8010565e:	83 c4 10             	add    $0x10,%esp
80105661:	85 c0                	test   %eax,%eax
80105663:	0f 88 8b 00 00 00    	js     801056f4 <sys_exec+0xb4>
80105669:	83 ec 08             	sub    $0x8,%esp
8010566c:	8d 85 60 ff ff ff    	lea    -0xa0(%ebp),%eax
80105672:	50                   	push   %eax
80105673:	6a 01                	push   $0x1
80105675:	e8 26 f4 ff ff       	call   80104aa0 <argint>
8010567a:	83 c4 10             	add    $0x10,%esp
8010567d:	85 c0                	test   %eax,%eax
8010567f:	78 73                	js     801056f4 <sys_exec+0xb4>
    return -1;
  }
  memset(argv, 0, sizeof(argv));
80105681:	83 ec 04             	sub    $0x4,%esp
80105684:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
  for(i=0;; i++){
8010568a:	31 db                	xor    %ebx,%ebx
  memset(argv, 0, sizeof(argv));
8010568c:	68 80 00 00 00       	push   $0x80
80105691:	8d bd 64 ff ff ff    	lea    -0x9c(%ebp),%edi
80105697:	6a 00                	push   $0x0
80105699:	50                   	push   %eax
8010569a:	e8 21 f1 ff ff       	call   801047c0 <memset>
8010569f:	83 c4 10             	add    $0x10,%esp
801056a2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(i >= NELEM(argv))
      return -1;
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
801056a8:	8b 85 60 ff ff ff    	mov    -0xa0(%ebp),%eax
801056ae:	8d 34 9d 00 00 00 00 	lea    0x0(,%ebx,4),%esi
801056b5:	83 ec 08             	sub    $0x8,%esp
801056b8:	57                   	push   %edi
801056b9:	01 f0                	add    %esi,%eax
801056bb:	50                   	push   %eax
801056bc:	e8 3f f3 ff ff       	call   80104a00 <fetchint>
801056c1:	83 c4 10             	add    $0x10,%esp
801056c4:	85 c0                	test   %eax,%eax
801056c6:	78 2c                	js     801056f4 <sys_exec+0xb4>
      return -1;
    if(uarg == 0){
801056c8:	8b 85 64 ff ff ff    	mov    -0x9c(%ebp),%eax
801056ce:	85 c0                	test   %eax,%eax
801056d0:	74 36                	je     80105708 <sys_exec+0xc8>
      argv[i] = 0;
      break;
    }
    if(fetchstr(uarg, &argv[i]) < 0)
801056d2:	8d 8d 68 ff ff ff    	lea    -0x98(%ebp),%ecx
801056d8:	83 ec 08             	sub    $0x8,%esp
801056db:	8d 14 31             	lea    (%ecx,%esi,1),%edx
801056de:	52                   	push   %edx
801056df:	50                   	push   %eax
801056e0:	e8 5b f3 ff ff       	call   80104a40 <fetchstr>
801056e5:	83 c4 10             	add    $0x10,%esp
801056e8:	85 c0                	test   %eax,%eax
801056ea:	78 08                	js     801056f4 <sys_exec+0xb4>
  for(i=0;; i++){
801056ec:	83 c3 01             	add    $0x1,%ebx
    if(i >= NELEM(argv))
801056ef:	83 fb 20             	cmp    $0x20,%ebx
801056f2:	75 b4                	jne    801056a8 <sys_exec+0x68>
      return -1;
  }
  return exec(path, argv);
}
801056f4:	8d 65 f4             	lea    -0xc(%ebp),%esp
    return -1;
...
8010570b:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
      argv[i] = 0;
80105711:	c7 84 9d 68 ff ff ff 	movl   $0x0,-0x98(%ebp,%ebx,4)
80105718:	00 00 00 00 
  return exec(path, argv);
8010571c:	50                   	push   %eax
8010571d:	ff b5 5c ff ff ff    	pushl  -0xa4(%ebp)
80105723:	e8 58 b3 ff ff       	call   80100a80 <exec>
80105728:	83 c4 10             	add    $0x10,%esp
}
8010572b:	8d 65 f4             	lea    -0xc(%ebp),%esp
8010572e:	5b                   	pop    %ebx
8010572f:	5e                   	pop    %esi
80105730:	5f                   	pop    %edi
80105731:	5d                   	pop    %ebp
...
801057c7:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
801057ca:	e8 c1 e1 ff ff       	call   80103990 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801057de:	74 20                	je     80105800 <sys_pipe+0xc0>
  for(fd = 0; fd < NOFILE; fd++){
801057e0:	83 c2 01             	add    $0x1,%edx
801057e3:	83 fa 10             	cmp    $0x10,%edx
801057e6:	75 f0                	jne    801057d8 <sys_pipe+0x98>
      myproc()->ofile[fd0] = 0;
801057e8:	e8 a3 e1 ff ff       	call   80103990 <myproc>
801057ed:	c7 44 b0 08 00 00 00 	movl   $0x0,0x8(%eax,%esi,4)
801057f4:	00 
801057f5:	eb a1                	jmp    80105798 <sys_pipe+0x58>
...
80105820:	f3 0f 1e fb          	endbr32 
  return fork();
80105824:	e9 17 e3 ff ff       	jmp    80103b40 <fork>
...
80105837:	83 ec 08             	sub    $0x8,%esp
  exit();
8010583a:	e8 21 e6 ff ff       	call   80103e60 <exit>
...
80105850:	f3 0f 1e fb          	endbr32 
  return wait();
80105854:	e9 67 e8 ff ff       	jmp    801040c0 <wait>
...
80105870:	e8 2b f2 ff ff       	call   80104aa0 <argint>
...
80105882:	e8 a9 e9 ff ff       	call   80104230 <kill>
...
801058ea:	e8 d1 e1 ff ff       	call   80103ac0 <growproc>
...
80105921:	e8 7a f1 ff ff       	call   80104aa0 <argint>
...
80105934:	68 c0 4f 11 80       	push   $0x80114fc0
80105939:	e8 72 ed ff ff       	call   801046b0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010593e:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
80105941:	8b 1d 00 58 11 80    	mov    0x80115800,%ebx
  while(ticks - ticks0 < n){
...
80105953:	68 c0 4f 11 80       	push   $0x80114fc0
80105958:	68 00 58 11 80       	push   $0x80115800
8010595d:	e8 9e e6 ff ff       	call   80104000 <sleep>
  while(ticks - ticks0 < n){
80105962:	a1 00 58 11 80       	mov    0x80115800,%eax
...
8010596f:	73 2f                	jae    801059a0 <sys_sleep+0x90>
    if(myproc()->killed){
80105971:	e8 1a e0 ff ff       	call   80103990 <myproc>
...
80105980:	68 c0 4f 11 80       	push   $0x80114fc0
80105985:	e8 e6 ed ff ff       	call   80104770 <release>
  }
  release(&tickslock);
  return 0;
}
...
801059a3:	68 c0 4f 11 80       	push   $0x80114fc0
801059a8:	e8 c3 ed ff ff       	call   80104770 <release>
  return 0;
...
801059c8:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
801059cb:	68 c0 4f 11 80       	push   $0x80114fc0
801059d0:	e8 db ec ff ff       	call   801046b0 <acquire>
  xticks = ticks;
801059d5:	8b 1d 00 58 11 80    	mov    0x80115800,%ebx
  release(&tickslock);
801059db:	c7 04 24 c0 4f 11 80 	movl   $0x80114fc0,(%esp)
801059e2:	e8 89 ed ff ff       	call   80104770 <release>
  return xticks;
}
...
801059f0 <sys_memsize>:

/* add (jw) */

// get a size of called process memory (bytes)
// 호출한 프로세스의 메모리 사용량을 출력한다.
...
801059f7:	83 ec 08             	sub    $0x8,%esp
	...
	struct proc *curproc = myproc();
801059fa:	e8 91 df ff ff       	call   80103990 <myproc>
	size = curproc->sz;

	return size;
801059ff:	8b 00                	mov    (%eax),%eax
}
80105a01:	c9                   	leave  
80105a02:	c3                   	ret    
...
//user-level에서 kenerl-level로 int형 0번째 argument를 호출한 프로세스의 trace(mask)에 전달한다.
int sys_trace(void){
...
80105a17:	83 ec 08             	sub    $0x8,%esp
	...
	if (argint(0, &myproc()->trace) < 0)
80105a1a:	e8 71 df ff ff       	call   80103990 <myproc>
80105a1f:	83 ec 08             	sub    $0x8,%esp
80105a22:	83 c0 7c             	add    $0x7c,%eax
80105a25:	50                   	push   %eax
80105a26:	6a 00                	push   $0x0
80105a28:	e8 73 f0 ff ff       	call   80104aa0 <argint>
		return -1;
...
80105a2d:	c9                   	leave  
	if (argint(0, &myproc()->trace) < 0)
80105a2e:	c1 f8 1f             	sar    $0x1f,%eax
}
80105a31:	c3                   	ret    
80105a32:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80105a39:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

80105a40 <sys_weightset>:

// add by jw (hw3)
//매개변수로 입력받은 값을, sdebug 명령어에 의해 생성되는 프로세스의 weight 값으로 부여한다.
//단, weight = 0이면 에러처리한다. 
...
80105a4a:	e8 41 df ff ff       	call   80103990 <myproc>
80105a4f:	83 ec 08             	sub    $0x8,%esp
80105a52:	05 84 00 00 00       	add    $0x84,%eax
80105a57:	50                   	push   %eax
80105a58:	6a 00                	push   $0x0
80105a5a:	e8 41 f0 ff ff       	call   80104aa0 <argint>
	//	return -1;
...
80105a5f:	c9                   	leave  
	if (argint(0, &myproc()->weight) <0)
80105a60:	c1 f8 1f             	sar    $0x1f,%eax
}
80105a63:	c3                   	ret    
...
80105a65:	06                   	push   %es
  pushl %fs
80105a66:	0f a0                	push   %fs
  pushl %gs
80105a68:	0f a8                	push   %gs
  pushal
80105a6a:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105a6b:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80105a6f:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80105a71:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80105a73:	54                   	push   %esp
  call trap
80105a74:	e8 c7 00 00 00       	call   80105b40 <trap>
  addl $4, %esp
80105a79:	83 c4 04             	add    $0x4,%esp
...
80105a7c:	61                   	popa   
  popl %gs
80105a7d:	0f a9                	pop    %gs
  popl %fs
80105a7f:	0f a1                	pop    %fs
  popl %es
80105a81:	07                   	pop    %es
  popl %ds
80105a82:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80105a83:	83 c4 08             	add    $0x8,%esp
  iret
80105a86:	cf                   	iret   
...
80105aa0:	8b 14 85 80 a0 10 80 	mov    -0x7fef5f80(,%eax,4),%edx
80105aa7:	c7 04 c5 02 50 11 80 	movl   $0x8e000008,-0x7feeaffe(,%eax,8)
80105aae:	08 00 00 8e 
80105ab2:	66 89 14 c5 00 50 11 	mov    %dx,-0x7feeb000(,%eax,8)
80105ab9:	80 
80105aba:	c1 ea 10             	shr    $0x10,%edx
80105abd:	66 89 14 c5 06 50 11 	mov    %dx,-0x7feeaffa(,%eax,8)
80105ac4:	80 
  for(i = 0; i < 256; i++)
...
80105acf:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105ad2:	a1 80 a1 10 80       	mov    0x8010a180,%eax
80105ad7:	c7 05 02 52 11 80 08 	movl   $0xef000008,0x80115202
80105ade:	00 00 ef 
  initlock(&tickslock, "time");
80105ae1:	68 01 7a 10 80       	push   $0x80107a01
80105ae6:	68 c0 4f 11 80       	push   $0x80114fc0
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105aeb:	66 a3 00 52 11 80    	mov    %ax,0x80115200
80105af1:	c1 e8 10             	shr    $0x10,%eax
80105af4:	66 a3 06 52 11 80    	mov    %ax,0x80115206
  initlock(&tickslock, "time");
80105afa:	e8 31 ea ff ff       	call   80104530 <initlock>
}
...
80105b1f:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105b23:	b8 00 50 11 80       	mov    $0x80115000,%eax
...
80105b56:	0f 84 bc 01 00 00    	je     80105d18 <trap+0x1d8>
    if(myproc()->killed)
      exit();
    return;
  }
...
80105b64:	3e ff 24 85 a8 7b 10 	notrack jmp *-0x7fef8458(,%eax,4)
80105b6b:	80 
    lapiceoi();
    break;
...
80105b76:	0f 84 eb 01 00 00    	je     80105d67 <trap+0x227>
80105b7c:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80105b80:	0f 84 e1 01 00 00    	je     80105d67 <trap+0x227>
...
80105bc1:	68 64 7b 10 80       	push   $0x80107b64
...
80105bfa:	0f 84 50 01 00 00    	je     80105d50 <trap+0x210>
    exit();
...
80105c12:	0f 84 e8 00 00 00    	je     80105d00 <trap+0x1c0>
...
80105c38:	0f 84 03 01 00 00    	je     80105d41 <trap+0x201>
    exit();
}
...
80105c67:	68 c0 4f 11 80       	push   $0x80114fc0
80105c6c:	e8 3f ea ff ff       	call   801046b0 <acquire>
      wakeup(&ticks);
80105c71:	c7 04 24 00 58 11 80 	movl   $0x80115800,(%esp)
      ticks++;
80105c78:	83 05 00 58 11 80 01 	addl   $0x1,0x80115800
      wakeup(&ticks);
80105c7f:	e8 3c e5 ff ff       	call   801041c0 <wakeup>
      release(&tickslock);
80105c84:	c7 04 24 c0 4f 11 80 	movl   $0x80114fc0,(%esp)
80105c8b:	e8 e0 ea ff ff       	call   80104770 <release>
80105c90:	83 c4 10             	add    $0x10,%esp
    lapiceoi();
80105c93:	eb b6                	jmp    80105c4b <trap+0x10b>
    kbdintr();
80105c95:	e8 e6 ca ff ff       	call   80102780 <kbdintr>
    lapiceoi();
80105c9a:	e8 21 cc ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105c9f:	e8 ec dc ff ff       	call   80103990 <myproc>
80105ca4:	85 c0                	test   %eax,%eax
80105ca6:	0f 85 37 ff ff ff    	jne    80105be3 <trap+0xa3>
80105cac:	e9 4f ff ff ff       	jmp    80105c00 <trap+0xc0>
    uartintr();
80105cb1:	e8 4a 02 00 00       	call   80105f00 <uartintr>
    lapiceoi();
80105cb6:	e8 05 cc ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105cbb:	e8 d0 dc ff ff       	call   80103990 <myproc>
80105cc0:	85 c0                	test   %eax,%eax
80105cc2:	0f 85 1b ff ff ff    	jne    80105be3 <trap+0xa3>
80105cc8:	e9 33 ff ff ff       	jmp    80105c00 <trap+0xc0>
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105ccd:	8b 7b 38             	mov    0x38(%ebx),%edi
80105cd0:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
80105cd4:	e8 97 dc ff ff       	call   80103970 <cpuid>
80105cd9:	57                   	push   %edi
80105cda:	56                   	push   %esi
80105cdb:	50                   	push   %eax
80105cdc:	68 0c 7b 10 80       	push   $0x80107b0c
80105ce1:	e8 ca a9 ff ff       	call   801006b0 <cprintf>
    lapiceoi();
80105ce6:	e8 d5 cb ff ff       	call   801028c0 <lapiceoi>
    break;
80105ceb:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105cee:	e8 9d dc ff ff       	call   80103990 <myproc>
80105cf3:	85 c0                	test   %eax,%eax
80105cf5:	0f 85 e8 fe ff ff    	jne    80105be3 <trap+0xa3>
80105cfb:	e9 00 ff ff ff       	jmp    80105c00 <trap+0xc0>
  if(myproc() && myproc()->state == RUNNING &&
80105d00:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
80105d04:	0f 85 0e ff ff ff    	jne    80105c18 <trap+0xd8>
    yield();
80105d0a:	e8 a1 e2 ff ff       	call   80103fb0 <yield>
80105d0f:	e9 04 ff ff ff       	jmp    80105c18 <trap+0xd8>
80105d14:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(myproc()->killed)
80105d18:	e8 73 dc ff ff       	call   80103990 <myproc>
80105d1d:	8b 70 24             	mov    0x24(%eax),%esi
80105d20:	85 f6                	test   %esi,%esi
80105d22:	75 3c                	jne    80105d60 <trap+0x220>
    myproc()->tf = tf;
80105d24:	e8 67 dc ff ff       	call   80103990 <myproc>
80105d29:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105d2c:	e8 5f ee ff ff       	call   80104b90 <syscall>
    if(myproc()->killed)
80105d31:	e8 5a dc ff ff       	call   80103990 <myproc>
80105d36:	8b 48 24             	mov    0x24(%eax),%ecx
80105d39:	85 c9                	test   %ecx,%ecx
80105d3b:	0f 84 fd fe ff ff    	je     80105c3e <trap+0xfe>
}
...
80105d47:	5d                   	pop    %ebp
      exit();
80105d48:	e9 13 e1 ff ff       	jmp    80103e60 <exit>
80105d4d:	8d 76 00             	lea    0x0(%esi),%esi
    exit();
80105d50:	e8 0b e1 ff ff       	call   80103e60 <exit>
80105d55:	e9 a6 fe ff ff       	jmp    80105c00 <trap+0xc0>
80105d5a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105d60:	e8 fb e0 ff ff       	call   80103e60 <exit>
80105d65:	eb bd                	jmp    80105d24 <trap+0x1e4>
80105d67:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105d6a:	e8 01 dc ff ff       	call   80103970 <cpuid>
80105d6f:	83 ec 0c             	sub    $0xc,%esp
80105d72:	56                   	push   %esi
80105d73:	57                   	push   %edi
80105d74:	50                   	push   %eax
80105d75:	ff 73 30             	pushl  0x30(%ebx)
80105d78:	68 30 7b 10 80       	push   $0x80107b30
80105d7d:	e8 2e a9 ff ff       	call   801006b0 <cprintf>
      panic("trap");
80105d82:	83 c4 14             	add    $0x14,%esp
80105d85:	68 05 7b 10 80       	push   $0x80107b05
80105d8a:	e8 01 a6 ff ff       	call   80100390 <panic>
80105d8f:	90                   	nop
...
80105d90:	f3 0f 1e fb          	endbr32 
  if(!uart)
80105d94:	a1 1c a6 10 80       	mov    0x8010a61c,%eax
80105d99:	85 c0                	test   %eax,%eax
80105d9b:	74 1b                	je     80105db8 <uartgetc+0x28>
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80105d9d:	ba fd 03 00 00       	mov    $0x3fd,%edx
80105da2:	ec                   	in     (%dx),%al
    return -1;
  if(!(inb(COM1+5) & 0x01))
80105da3:	a8 01                	test   $0x1,%al
80105da5:	74 11                	je     80105db8 <uartgetc+0x28>
80105da7:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105dac:	ec                   	in     (%dx),%al
    return -1;
  return inb(COM1+0);
80105dad:	0f b6 c0             	movzbl %al,%eax
80105db0:	c3                   	ret    
...
80105dc7:	be fd 03 00 00       	mov    $0x3fd,%esi
80105dcc:	53                   	push   %ebx
80105dcd:	bb 80 00 00 00       	mov    $0x80,%ebx
...
80105de5:	e8 f6 ca ff ff       	call   801028e0 <microdelay>
...
80105e15:	31 c9                	xor    %ecx,%ecx
80105e17:	89 c8                	mov    %ecx,%eax
80105e19:	89 e5                	mov    %esp,%ebp
80105e1b:	57                   	push   %edi
80105e1c:	56                   	push   %esi
80105e1d:	53                   	push   %ebx
80105e1e:	bb fa 03 00 00       	mov    $0x3fa,%ebx
80105e23:	89 da                	mov    %ebx,%edx
80105e25:	83 ec 0c             	sub    $0xc,%esp
80105e28:	ee                   	out    %al,(%dx)
80105e29:	bf fb 03 00 00       	mov    $0x3fb,%edi
80105e2e:	b8 80 ff ff ff       	mov    $0xffffff80,%eax
80105e33:	89 fa                	mov    %edi,%edx
80105e35:	ee                   	out    %al,(%dx)
80105e36:	b8 0c 00 00 00       	mov    $0xc,%eax
80105e3b:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105e40:	ee                   	out    %al,(%dx)
80105e41:	be f9 03 00 00       	mov    $0x3f9,%esi
80105e46:	89 c8                	mov    %ecx,%eax
80105e48:	89 f2                	mov    %esi,%edx
80105e4a:	ee                   	out    %al,(%dx)
80105e4b:	b8 03 00 00 00       	mov    $0x3,%eax
80105e50:	89 fa                	mov    %edi,%edx
80105e52:	ee                   	out    %al,(%dx)
80105e53:	ba fc 03 00 00       	mov    $0x3fc,%edx
80105e58:	89 c8                	mov    %ecx,%eax
80105e5a:	ee                   	out    %al,(%dx)
80105e5b:	b8 01 00 00 00       	mov    $0x1,%eax
80105e60:	89 f2                	mov    %esi,%edx
80105e62:	ee                   	out    %al,(%dx)
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80105e63:	ba fd 03 00 00       	mov    $0x3fd,%edx
80105e68:	ec                   	in     (%dx),%al
  if(inb(COM1+5) == 0xFF)
80105e69:	3c ff                	cmp    $0xff,%al
80105e6b:	74 52                	je     80105ebf <uartinit+0xaf>
  uart = 1;
80105e6d:	c7 05 1c a6 10 80 01 	movl   $0x1,0x8010a61c
80105e74:	00 00 00 
80105e77:	89 da                	mov    %ebx,%edx
80105e79:	ec                   	in     (%dx),%al
80105e7a:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105e7f:	ec                   	in     (%dx),%al
  ioapicenable(IRQ_COM1, 0);
80105e80:	83 ec 08             	sub    $0x8,%esp
80105e83:	be 76 00 00 00       	mov    $0x76,%esi
  for(p="xv6...\n"; *p; p++)
80105e88:	bb 28 7c 10 80       	mov    $0x80107c28,%ebx
  ioapicenable(IRQ_COM1, 0);
80105e8d:	6a 00                	push   $0x0
80105e8f:	6a 04                	push   $0x4
80105e91:	e8 9a c5 ff ff       	call   80102430 <ioapicenable>
80105e96:	83 c4 10             	add    $0x10,%esp
  for(p="xv6...\n"; *p; p++)
80105e99:	b8 78 00 00 00       	mov    $0x78,%eax
80105e9e:	eb 04                	jmp    80105ea4 <uartinit+0x94>
80105ea0:	0f b6 73 01          	movzbl 0x1(%ebx),%esi
  if(!uart)
80105ea4:	8b 15 1c a6 10 80    	mov    0x8010a61c,%edx
80105eaa:	85 d2                	test   %edx,%edx
80105eac:	74 08                	je     80105eb6 <uartinit+0xa6>
    uartputc(*p);
80105eae:	0f be c0             	movsbl %al,%eax
80105eb1:	e8 0a ff ff ff       	call   80105dc0 <uartputc.part.0>
  for(p="xv6...\n"; *p; p++)
80105eb6:	89 f0                	mov    %esi,%eax
80105eb8:	83 c3 01             	add    $0x1,%ebx
80105ebb:	84 c0                	test   %al,%al
80105ebd:	75 e1                	jne    80105ea0 <uartinit+0x90>
}
...
80105ed4:	55                   	push   %ebp
  if(!uart)
80105ed5:	8b 15 1c a6 10 80    	mov    0x8010a61c,%edx
{
...
80105ee4:	5d                   	pop    %ebp
80105ee5:	e9 d6 fe ff ff       	jmp    80105dc0 <uartputc.part.0>
...
80105f0a:	68 90 5d 10 80       	push   $0x80105d90
80105f0f:	e8 4c a9 ff ff       	call   80100860 <consoleintr>
}
...
80105f1b:	6a 00                	push   $0x0
  jmp alltraps
80105f1d:	e9 42 fb ff ff       	jmp    80105a64 <alltraps>
...
80105f24:	6a 01                	push   $0x1
  jmp alltraps
80105f26:	e9 39 fb ff ff       	jmp    80105a64 <alltraps>
...
80105f2d:	6a 02                	push   $0x2
  jmp alltraps
80105f2f:	e9 30 fb ff ff       	jmp    80105a64 <alltraps>
...
80105f36:	6a 03                	push   $0x3
  jmp alltraps
80105f38:	e9 27 fb ff ff       	jmp    80105a64 <alltraps>
...
80105f3f:	6a 04                	push   $0x4
  jmp alltraps
80105f41:	e9 1e fb ff ff       	jmp    80105a64 <alltraps>
...
80105f48:	6a 05                	push   $0x5
  jmp alltraps
80105f4a:	e9 15 fb ff ff       	jmp    80105a64 <alltraps>
...
80105f51:	6a 06                	push   $0x6
  jmp alltraps
80105f53:	e9 0c fb ff ff       	jmp    80105a64 <alltraps>
...
80105f5a:	6a 07                	push   $0x7
  jmp alltraps
80105f5c:	e9 03 fb ff ff       	jmp    80105a64 <alltraps>
...
80105f61:	6a 08                	push   $0x8
  jmp alltraps
80105f63:	e9 fc fa ff ff       	jmp    80105a64 <alltraps>
...
80105f6a:	6a 09                	push   $0x9
  jmp alltraps
80105f6c:	e9 f3 fa ff ff       	jmp    80105a64 <alltraps>
...
80105f71:	6a 0a                	push   $0xa
  jmp alltraps
80105f73:	e9 ec fa ff ff       	jmp    80105a64 <alltraps>
...
80105f78:	6a 0b                	push   $0xb
  jmp alltraps
80105f7a:	e9 e5 fa ff ff       	jmp    80105a64 <alltraps>
...
80105f7f:	6a 0c                	push   $0xc
  jmp alltraps
80105f81:	e9 de fa ff ff       	jmp    80105a64 <alltraps>
...
80105f86:	6a 0d                	push   $0xd
  jmp alltraps
80105f88:	e9 d7 fa ff ff       	jmp    80105a64 <alltraps>
...
80105f8d:	6a 0e                	push   $0xe
  jmp alltraps
80105f8f:	e9 d0 fa ff ff       	jmp    80105a64 <alltraps>
...
80105f96:	6a 0f                	push   $0xf
  jmp alltraps
80105f98:	e9 c7 fa ff ff       	jmp    80105a64 <alltraps>
...
80105f9f:	6a 10                	push   $0x10
  jmp alltraps
80105fa1:	e9 be fa ff ff       	jmp    80105a64 <alltraps>
...
80105fa6:	6a 11                	push   $0x11
  jmp alltraps
80105fa8:	e9 b7 fa ff ff       	jmp    80105a64 <alltraps>
...
80105faf:	6a 12                	push   $0x12
  jmp alltraps
80105fb1:	e9 ae fa ff ff       	jmp    80105a64 <alltraps>
...
80105fb8:	6a 13                	push   $0x13
  jmp alltraps
80105fba:	e9 a5 fa ff ff       	jmp    80105a64 <alltraps>
...
80105fc1:	6a 14                	push   $0x14
  jmp alltraps
80105fc3:	e9 9c fa ff ff       	jmp    80105a64 <alltraps>
...
80105fca:	6a 15                	push   $0x15
  jmp alltraps
80105fcc:	e9 93 fa ff ff       	jmp    80105a64 <alltraps>
...
80105fd3:	6a 16                	push   $0x16
  jmp alltraps
80105fd5:	e9 8a fa ff ff       	jmp    80105a64 <alltraps>
...
80105fdc:	6a 17                	push   $0x17
  jmp alltraps
80105fde:	e9 81 fa ff ff       	jmp    80105a64 <alltraps>
...
80105fe5:	6a 18                	push   $0x18
  jmp alltraps
80105fe7:	e9 78 fa ff ff       	jmp    80105a64 <alltraps>
...
80105fee:	6a 19                	push   $0x19
  jmp alltraps
80105ff0:	e9 6f fa ff ff       	jmp    80105a64 <alltraps>
...
80105ff7:	6a 1a                	push   $0x1a
  jmp alltraps
80105ff9:	e9 66 fa ff ff       	jmp    80105a64 <alltraps>
...
80106000:	6a 1b                	push   $0x1b
  jmp alltraps
80106002:	e9 5d fa ff ff       	jmp    80105a64 <alltraps>
...
80106009:	6a 1c                	push   $0x1c
  jmp alltraps
8010600b:	e9 54 fa ff ff       	jmp    80105a64 <alltraps>
...
80106012:	6a 1d                	push   $0x1d
  jmp alltraps
80106014:	e9 4b fa ff ff       	jmp    80105a64 <alltraps>
...
8010601b:	6a 1e                	push   $0x1e
  jmp alltraps
8010601d:	e9 42 fa ff ff       	jmp    80105a64 <alltraps>
...
80106024:	6a 1f                	push   $0x1f
  jmp alltraps
80106026:	e9 39 fa ff ff       	jmp    80105a64 <alltraps>
...
8010602d:	6a 20                	push   $0x20
  jmp alltraps
8010602f:	e9 30 fa ff ff       	jmp    80105a64 <alltraps>
...
80106036:	6a 21                	push   $0x21
  jmp alltraps
80106038:	e9 27 fa ff ff       	jmp    80105a64 <alltraps>
...
8010603f:	6a 22                	push   $0x22
  jmp alltraps
80106041:	e9 1e fa ff ff       	jmp    80105a64 <alltraps>
...
80106048:	6a 23                	push   $0x23
  jmp alltraps
8010604a:	e9 15 fa ff ff       	jmp    80105a64 <alltraps>
...
80106051:	6a 24                	push   $0x24
  jmp alltraps
80106053:	e9 0c fa ff ff       	jmp    80105a64 <alltraps>
...
8010605a:	6a 25                	push   $0x25
  jmp alltraps
8010605c:	e9 03 fa ff ff       	jmp    80105a64 <alltraps>
...
80106063:	6a 26                	push   $0x26
  jmp alltraps
80106065:	e9 fa f9 ff ff       	jmp    80105a64 <alltraps>
...
8010606c:	6a 27                	push   $0x27
  jmp alltraps
8010606e:	e9 f1 f9 ff ff       	jmp    80105a64 <alltraps>
...
80106075:	6a 28                	push   $0x28
  jmp alltraps
80106077:	e9 e8 f9 ff ff       	jmp    80105a64 <alltraps>
...
8010607e:	6a 29                	push   $0x29
  jmp alltraps
80106080:	e9 df f9 ff ff       	jmp    80105a64 <alltraps>
...
80106087:	6a 2a                	push   $0x2a
  jmp alltraps
80106089:	e9 d6 f9 ff ff       	jmp    80105a64 <alltraps>
...
80106090:	6a 2b                	push   $0x2b
  jmp alltraps
80106092:	e9 cd f9 ff ff       	jmp    80105a64 <alltraps>
...
80106099:	6a 2c                	push   $0x2c
  jmp alltraps
8010609b:	e9 c4 f9 ff ff       	jmp    80105a64 <alltraps>
...
801060a2:	6a 2d                	push   $0x2d
  jmp alltraps
801060a4:	e9 bb f9 ff ff       	jmp    80105a64 <alltraps>
...
801060ab:	6a 2e                	push   $0x2e
  jmp alltraps
801060ad:	e9 b2 f9 ff ff       	jmp    80105a64 <alltraps>
...
801060b4:	6a 2f                	push   $0x2f
  jmp alltraps
801060b6:	e9 a9 f9 ff ff       	jmp    80105a64 <alltraps>
...
801060bd:	6a 30                	push   $0x30
  jmp alltraps
801060bf:	e9 a0 f9 ff ff       	jmp    80105a64 <alltraps>
...
801060c6:	6a 31                	push   $0x31
  jmp alltraps
801060c8:	e9 97 f9 ff ff       	jmp    80105a64 <alltraps>
...
801060cf:	6a 32                	push   $0x32
  jmp alltraps
801060d1:	e9 8e f9 ff ff       	jmp    80105a64 <alltraps>
...
801060d8:	6a 33                	push   $0x33
  jmp alltraps
801060da:	e9 85 f9 ff ff       	jmp    80105a64 <alltraps>
...
801060e1:	6a 34                	push   $0x34
  jmp alltraps
801060e3:	e9 7c f9 ff ff       	jmp    80105a64 <alltraps>
...
801060ea:	6a 35                	push   $0x35
  jmp alltraps
801060ec:	e9 73 f9 ff ff       	jmp    80105a64 <alltraps>
...
801060f3:	6a 36                	push   $0x36
  jmp alltraps
801060f5:	e9 6a f9 ff ff       	jmp    80105a64 <alltraps>
...
801060fc:	6a 37                	push   $0x37
  jmp alltraps
801060fe:	e9 61 f9 ff ff       	jmp    80105a64 <alltraps>
...
80106105:	6a 38                	push   $0x38
  jmp alltraps
80106107:	e9 58 f9 ff ff       	jmp    80105a64 <alltraps>
...
8010610e:	6a 39                	push   $0x39
  jmp alltraps
80106110:	e9 4f f9 ff ff       	jmp    80105a64 <alltraps>
...
80106117:	6a 3a                	push   $0x3a
  jmp alltraps
80106119:	e9 46 f9 ff ff       	jmp    80105a64 <alltraps>
...
80106120:	6a 3b                	push   $0x3b
  jmp alltraps
80106122:	e9 3d f9 ff ff       	jmp    80105a64 <alltraps>
...
80106129:	6a 3c                	push   $0x3c
  jmp alltraps
8010612b:	e9 34 f9 ff ff       	jmp    80105a64 <alltraps>
...
80106132:	6a 3d                	push   $0x3d
  jmp alltraps
80106134:	e9 2b f9 ff ff       	jmp    80105a64 <alltraps>
...
8010613b:	6a 3e                	push   $0x3e
  jmp alltraps
8010613d:	e9 22 f9 ff ff       	jmp    80105a64 <alltraps>
...
80106144:	6a 3f                	push   $0x3f
  jmp alltraps
80106146:	e9 19 f9 ff ff       	jmp    80105a64 <alltraps>
...
8010614d:	6a 40                	push   $0x40
  jmp alltraps
8010614f:	e9 10 f9 ff ff       	jmp    80105a64 <alltraps>
...
80106156:	6a 41                	push   $0x41
  jmp alltraps
80106158:	e9 07 f9 ff ff       	jmp    80105a64 <alltraps>
...
8010615f:	6a 42                	push   $0x42
  jmp alltraps
80106161:	e9 fe f8 ff ff       	jmp    80105a64 <alltraps>
...
80106168:	6a 43                	push   $0x43
  jmp alltraps
8010616a:	e9 f5 f8 ff ff       	jmp    80105a64 <alltraps>
...
80106171:	6a 44                	push   $0x44
  jmp alltraps
80106173:	e9 ec f8 ff ff       	jmp    80105a64 <alltraps>
...
8010617a:	6a 45                	push   $0x45
  jmp alltraps
8010617c:	e9 e3 f8 ff ff       	jmp    80105a64 <alltraps>
...
80106183:	6a 46                	push   $0x46
  jmp alltraps
80106185:	e9 da f8 ff ff       	jmp    80105a64 <alltraps>
...
8010618c:	6a 47                	push   $0x47
  jmp alltraps
8010618e:	e9 d1 f8 ff ff       	jmp    80105a64 <alltraps>
...
80106195:	6a 48                	push   $0x48
  jmp alltraps
80106197:	e9 c8 f8 ff ff       	jmp    80105a64 <alltraps>
...
8010619e:	6a 49                	push   $0x49
  jmp alltraps
801061a0:	e9 bf f8 ff ff       	jmp    80105a64 <alltraps>
...
801061a7:	6a 4a                	push   $0x4a
  jmp alltraps
801061a9:	e9 b6 f8 ff ff       	jmp    80105a64 <alltraps>
...
801061b0:	6a 4b                	push   $0x4b
  jmp alltraps
801061b2:	e9 ad f8 ff ff       	jmp    80105a64 <alltraps>
...
801061b9:	6a 4c                	push   $0x4c
  jmp alltraps
801061bb:	e9 a4 f8 ff ff       	jmp    80105a64 <alltraps>
...
801061c2:	6a 4d                	push   $0x4d
  jmp alltraps
801061c4:	e9 9b f8 ff ff       	jmp    80105a64 <alltraps>
...
801061cb:	6a 4e                	push   $0x4e
  jmp alltraps
801061cd:	e9 92 f8 ff ff       	jmp    80105a64 <alltraps>
...
801061d4:	6a 4f                	push   $0x4f
  jmp alltraps
801061d6:	e9 89 f8 ff ff       	jmp    80105a64 <alltraps>
...
801061dd:	6a 50                	push   $0x50
  jmp alltraps
801061df:	e9 80 f8 ff ff       	jmp    80105a64 <alltraps>
...
801061e6:	6a 51                	push   $0x51
  jmp alltraps
801061e8:	e9 77 f8 ff ff       	jmp    80105a64 <alltraps>
...
801061ef:	6a 52                	push   $0x52
  jmp alltraps
801061f1:	e9 6e f8 ff ff       	jmp    80105a64 <alltraps>
...
801061f8:	6a 53                	push   $0x53
  jmp alltraps
801061fa:	e9 65 f8 ff ff       	jmp    80105a64 <alltraps>
...
80106201:	6a 54                	push   $0x54
  jmp alltraps
80106203:	e9 5c f8 ff ff       	jmp    80105a64 <alltraps>
...
8010620a:	6a 55                	push   $0x55
  jmp alltraps
8010620c:	e9 53 f8 ff ff       	jmp    80105a64 <alltraps>
...
80106213:	6a 56                	push   $0x56
  jmp alltraps
80106215:	e9 4a f8 ff ff       	jmp    80105a64 <alltraps>
...
8010621c:	6a 57                	push   $0x57
  jmp alltraps
8010621e:	e9 41 f8 ff ff       	jmp    80105a64 <alltraps>
...
80106225:	6a 58                	push   $0x58
  jmp alltraps
80106227:	e9 38 f8 ff ff       	jmp    80105a64 <alltraps>
...
8010622e:	6a 59                	push   $0x59
  jmp alltraps
80106230:	e9 2f f8 ff ff       	jmp    80105a64 <alltraps>
...
80106237:	6a 5a                	push   $0x5a
  jmp alltraps
80106239:	e9 26 f8 ff ff       	jmp    80105a64 <alltraps>
...
80106240:	6a 5b                	push   $0x5b
  jmp alltraps
80106242:	e9 1d f8 ff ff       	jmp    80105a64 <alltraps>
...
80106249:	6a 5c                	push   $0x5c
  jmp alltraps
8010624b:	e9 14 f8 ff ff       	jmp    80105a64 <alltraps>
...
80106252:	6a 5d                	push   $0x5d
  jmp alltraps
80106254:	e9 0b f8 ff ff       	jmp    80105a64 <alltraps>
...
8010625b:	6a 5e                	push   $0x5e
  jmp alltraps
8010625d:	e9 02 f8 ff ff       	jmp    80105a64 <alltraps>
...
80106264:	6a 5f                	push   $0x5f
  jmp alltraps
80106266:	e9 f9 f7 ff ff       	jmp    80105a64 <alltraps>
...
8010626d:	6a 60                	push   $0x60
  jmp alltraps
8010626f:	e9 f0 f7 ff ff       	jmp    80105a64 <alltraps>
...
80106276:	6a 61                	push   $0x61
  jmp alltraps
80106278:	e9 e7 f7 ff ff       	jmp    80105a64 <alltraps>
...
8010627f:	6a 62                	push   $0x62
  jmp alltraps
80106281:	e9 de f7 ff ff       	jmp    80105a64 <alltraps>
...
80106288:	6a 63                	push   $0x63
  jmp alltraps
8010628a:	e9 d5 f7 ff ff       	jmp    80105a64 <alltraps>
...
80106291:	6a 64                	push   $0x64
  jmp alltraps
80106293:	e9 cc f7 ff ff       	jmp    80105a64 <alltraps>
...
8010629a:	6a 65                	push   $0x65
  jmp alltraps
8010629c:	e9 c3 f7 ff ff       	jmp    80105a64 <alltraps>
...
801062a3:	6a 66                	push   $0x66
  jmp alltraps
801062a5:	e9 ba f7 ff ff       	jmp    80105a64 <alltraps>
...
801062ac:	6a 67                	push   $0x67
  jmp alltraps
801062ae:	e9 b1 f7 ff ff       	jmp    80105a64 <alltraps>
...
801062b5:	6a 68                	push   $0x68
  jmp alltraps
801062b7:	e9 a8 f7 ff ff       	jmp    80105a64 <alltraps>
...
801062be:	6a 69                	push   $0x69
  jmp alltraps
801062c0:	e9 9f f7 ff ff       	jmp    80105a64 <alltraps>
...
801062c7:	6a 6a                	push   $0x6a
  jmp alltraps
801062c9:	e9 96 f7 ff ff       	jmp    80105a64 <alltraps>
...
801062d0:	6a 6b                	push   $0x6b
  jmp alltraps
801062d2:	e9 8d f7 ff ff       	jmp    80105a64 <alltraps>
...
801062d9:	6a 6c                	push   $0x6c
  jmp alltraps
801062db:	e9 84 f7 ff ff       	jmp    80105a64 <alltraps>
...
801062e2:	6a 6d                	push   $0x6d
  jmp alltraps
801062e4:	e9 7b f7 ff ff       	jmp    80105a64 <alltraps>
...
801062eb:	6a 6e                	push   $0x6e
  jmp alltraps
801062ed:	e9 72 f7 ff ff       	jmp    80105a64 <alltraps>
...
801062f4:	6a 6f                	push   $0x6f
  jmp alltraps
801062f6:	e9 69 f7 ff ff       	jmp    80105a64 <alltraps>
...
801062fd:	6a 70                	push   $0x70
  jmp alltraps
801062ff:	e9 60 f7 ff ff       	jmp    80105a64 <alltraps>
...
80106306:	6a 71                	push   $0x71
  jmp alltraps
80106308:	e9 57 f7 ff ff       	jmp    80105a64 <alltraps>
...
8010630f:	6a 72                	push   $0x72
  jmp alltraps
80106311:	e9 4e f7 ff ff       	jmp    80105a64 <alltraps>
...
80106318:	6a 73                	push   $0x73
  jmp alltraps
8010631a:	e9 45 f7 ff ff       	jmp    80105a64 <alltraps>
...
80106321:	6a 74                	push   $0x74
  jmp alltraps
80106323:	e9 3c f7 ff ff       	jmp    80105a64 <alltraps>
...
8010632a:	6a 75                	push   $0x75
  jmp alltraps
8010632c:	e9 33 f7 ff ff       	jmp    80105a64 <alltraps>
...
80106333:	6a 76                	push   $0x76
  jmp alltraps
80106335:	e9 2a f7 ff ff       	jmp    80105a64 <alltraps>
...
8010633c:	6a 77                	push   $0x77
  jmp alltraps
8010633e:	e9 21 f7 ff ff       	jmp    80105a64 <alltraps>
...
80106345:	6a 78                	push   $0x78
  jmp alltraps
80106347:	e9 18 f7 ff ff       	jmp    80105a64 <alltraps>
...
8010634e:	6a 79                	push   $0x79
  jmp alltraps
80106350:	e9 0f f7 ff ff       	jmp    80105a64 <alltraps>
...
80106357:	6a 7a                	push   $0x7a
  jmp alltraps
80106359:	e9 06 f7 ff ff       	jmp    80105a64 <alltraps>
...
80106360:	6a 7b                	push   $0x7b
  jmp alltraps
80106362:	e9 fd f6 ff ff       	jmp    80105a64 <alltraps>
...
80106369:	6a 7c                	push   $0x7c
  jmp alltraps
8010636b:	e9 f4 f6 ff ff       	jmp    80105a64 <alltraps>
...
80106372:	6a 7d                	push   $0x7d
  jmp alltraps
80106374:	e9 eb f6 ff ff       	jmp    80105a64 <alltraps>
...
8010637b:	6a 7e                	push   $0x7e
  jmp alltraps
8010637d:	e9 e2 f6 ff ff       	jmp    80105a64 <alltraps>
...
80106384:	6a 7f                	push   $0x7f
  jmp alltraps
80106386:	e9 d9 f6 ff ff       	jmp    80105a64 <alltraps>
...
8010638d:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80106392:	e9 cd f6 ff ff       	jmp    80105a64 <alltraps>
...
80106399:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010639e:	e9 c1 f6 ff ff       	jmp    80105a64 <alltraps>
...
801063a5:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801063aa:	e9 b5 f6 ff ff       	jmp    80105a64 <alltraps>
...
801063b1:	68 83 00 00 00       	push   $0x83
  jmp alltraps
801063b6:	e9 a9 f6 ff ff       	jmp    80105a64 <alltraps>
...
801063bd:	68 84 00 00 00       	push   $0x84
  jmp alltraps
801063c2:	e9 9d f6 ff ff       	jmp    80105a64 <alltraps>
...
801063c9:	68 85 00 00 00       	push   $0x85
  jmp alltraps
801063ce:	e9 91 f6 ff ff       	jmp    80105a64 <alltraps>
...
801063d5:	68 86 00 00 00       	push   $0x86
  jmp alltraps
801063da:	e9 85 f6 ff ff       	jmp    80105a64 <alltraps>
...
801063e1:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801063e6:	e9 79 f6 ff ff       	jmp    80105a64 <alltraps>
...
801063ed:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801063f2:	e9 6d f6 ff ff       	jmp    80105a64 <alltraps>
...
801063f9:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801063fe:	e9 61 f6 ff ff       	jmp    80105a64 <alltraps>
...
80106405:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
8010640a:	e9 55 f6 ff ff       	jmp    80105a64 <alltraps>
...
80106411:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106416:	e9 49 f6 ff ff       	jmp    80105a64 <alltraps>
...
8010641d:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80106422:	e9 3d f6 ff ff       	jmp    80105a64 <alltraps>
...
80106429:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010642e:	e9 31 f6 ff ff       	jmp    80105a64 <alltraps>
...
80106435:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
8010643a:	e9 25 f6 ff ff       	jmp    80105a64 <alltraps>
...
80106441:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106446:	e9 19 f6 ff ff       	jmp    80105a64 <alltraps>
...
8010644d:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80106452:	e9 0d f6 ff ff       	jmp    80105a64 <alltraps>
...
80106459:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010645e:	e9 01 f6 ff ff       	jmp    80105a64 <alltraps>
...
80106465:	68 92 00 00 00       	push   $0x92
  jmp alltraps
8010646a:	e9 f5 f5 ff ff       	jmp    80105a64 <alltraps>
...
80106471:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106476:	e9 e9 f5 ff ff       	jmp    80105a64 <alltraps>
...
8010647d:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80106482:	e9 dd f5 ff ff       	jmp    80105a64 <alltraps>
...
80106489:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010648e:	e9 d1 f5 ff ff       	jmp    80105a64 <alltraps>
...
80106495:	68 96 00 00 00       	push   $0x96
  jmp alltraps
8010649a:	e9 c5 f5 ff ff       	jmp    80105a64 <alltraps>
...
801064a1:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801064a6:	e9 b9 f5 ff ff       	jmp    80105a64 <alltraps>
...
801064ad:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801064b2:	e9 ad f5 ff ff       	jmp    80105a64 <alltraps>
...
801064b9:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801064be:	e9 a1 f5 ff ff       	jmp    80105a64 <alltraps>
...
801064c5:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801064ca:	e9 95 f5 ff ff       	jmp    80105a64 <alltraps>
...
801064d1:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801064d6:	e9 89 f5 ff ff       	jmp    80105a64 <alltraps>
...
801064dd:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801064e2:	e9 7d f5 ff ff       	jmp    80105a64 <alltraps>
...
801064e9:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801064ee:	e9 71 f5 ff ff       	jmp    80105a64 <alltraps>
...
801064f5:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801064fa:	e9 65 f5 ff ff       	jmp    80105a64 <alltraps>
...
80106501:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106506:	e9 59 f5 ff ff       	jmp    80105a64 <alltraps>
...
8010650d:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80106512:	e9 4d f5 ff ff       	jmp    80105a64 <alltraps>
...
80106519:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010651e:	e9 41 f5 ff ff       	jmp    80105a64 <alltraps>
...
80106525:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
8010652a:	e9 35 f5 ff ff       	jmp    80105a64 <alltraps>
...
80106531:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106536:	e9 29 f5 ff ff       	jmp    80105a64 <alltraps>
...
8010653d:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80106542:	e9 1d f5 ff ff       	jmp    80105a64 <alltraps>
...
80106549:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010654e:	e9 11 f5 ff ff       	jmp    80105a64 <alltraps>
...
80106555:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
8010655a:	e9 05 f5 ff ff       	jmp    80105a64 <alltraps>
...
80106561:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106566:	e9 f9 f4 ff ff       	jmp    80105a64 <alltraps>
...
8010656d:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80106572:	e9 ed f4 ff ff       	jmp    80105a64 <alltraps>
...
80106579:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010657e:	e9 e1 f4 ff ff       	jmp    80105a64 <alltraps>
...
80106585:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
8010658a:	e9 d5 f4 ff ff       	jmp    80105a64 <alltraps>
...
80106591:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106596:	e9 c9 f4 ff ff       	jmp    80105a64 <alltraps>
...
8010659d:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801065a2:	e9 bd f4 ff ff       	jmp    80105a64 <alltraps>
...
801065a9:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801065ae:	e9 b1 f4 ff ff       	jmp    80105a64 <alltraps>
...
801065b5:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801065ba:	e9 a5 f4 ff ff       	jmp    80105a64 <alltraps>
...
801065c1:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801065c6:	e9 99 f4 ff ff       	jmp    80105a64 <alltraps>
...
801065cd:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801065d2:	e9 8d f4 ff ff       	jmp    80105a64 <alltraps>
...
801065d9:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801065de:	e9 81 f4 ff ff       	jmp    80105a64 <alltraps>
...
801065e5:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801065ea:	e9 75 f4 ff ff       	jmp    80105a64 <alltraps>
...
801065f1:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801065f6:	e9 69 f4 ff ff       	jmp    80105a64 <alltraps>
...
801065fd:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80106602:	e9 5d f4 ff ff       	jmp    80105a64 <alltraps>
...
80106609:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010660e:	e9 51 f4 ff ff       	jmp    80105a64 <alltraps>
...
80106615:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
8010661a:	e9 45 f4 ff ff       	jmp    80105a64 <alltraps>
...
80106621:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106626:	e9 39 f4 ff ff       	jmp    80105a64 <alltraps>
...
8010662d:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80106632:	e9 2d f4 ff ff       	jmp    80105a64 <alltraps>
...
80106639:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010663e:	e9 21 f4 ff ff       	jmp    80105a64 <alltraps>
...
80106645:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
8010664a:	e9 15 f4 ff ff       	jmp    80105a64 <alltraps>
...
80106651:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106656:	e9 09 f4 ff ff       	jmp    80105a64 <alltraps>
...
8010665d:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80106662:	e9 fd f3 ff ff       	jmp    80105a64 <alltraps>
...
80106669:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010666e:	e9 f1 f3 ff ff       	jmp    80105a64 <alltraps>
...
80106675:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
8010667a:	e9 e5 f3 ff ff       	jmp    80105a64 <alltraps>
...
80106681:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106686:	e9 d9 f3 ff ff       	jmp    80105a64 <alltraps>
...
8010668d:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80106692:	e9 cd f3 ff ff       	jmp    80105a64 <alltraps>
...
80106699:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010669e:	e9 c1 f3 ff ff       	jmp    80105a64 <alltraps>
...
801066a5:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801066aa:	e9 b5 f3 ff ff       	jmp    80105a64 <alltraps>
...
801066b1:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801066b6:	e9 a9 f3 ff ff       	jmp    80105a64 <alltraps>
...
801066bd:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801066c2:	e9 9d f3 ff ff       	jmp    80105a64 <alltraps>
...
801066c9:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801066ce:	e9 91 f3 ff ff       	jmp    80105a64 <alltraps>
...
801066d5:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801066da:	e9 85 f3 ff ff       	jmp    80105a64 <alltraps>
...
801066e1:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801066e6:	e9 79 f3 ff ff       	jmp    80105a64 <alltraps>
...
801066ed:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801066f2:	e9 6d f3 ff ff       	jmp    80105a64 <alltraps>
...
801066f9:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801066fe:	e9 61 f3 ff ff       	jmp    80105a64 <alltraps>
...
80106705:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
8010670a:	e9 55 f3 ff ff       	jmp    80105a64 <alltraps>
...
80106711:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106716:	e9 49 f3 ff ff       	jmp    80105a64 <alltraps>
...
8010671d:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80106722:	e9 3d f3 ff ff       	jmp    80105a64 <alltraps>
...
80106729:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010672e:	e9 31 f3 ff ff       	jmp    80105a64 <alltraps>
...
80106735:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
8010673a:	e9 25 f3 ff ff       	jmp    80105a64 <alltraps>
...
80106741:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106746:	e9 19 f3 ff ff       	jmp    80105a64 <alltraps>
...
8010674d:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80106752:	e9 0d f3 ff ff       	jmp    80105a64 <alltraps>
...
80106759:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010675e:	e9 01 f3 ff ff       	jmp    80105a64 <alltraps>
...
80106765:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
8010676a:	e9 f5 f2 ff ff       	jmp    80105a64 <alltraps>
...
80106771:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106776:	e9 e9 f2 ff ff       	jmp    80105a64 <alltraps>
...
8010677d:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80106782:	e9 dd f2 ff ff       	jmp    80105a64 <alltraps>
...
80106789:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010678e:	e9 d1 f2 ff ff       	jmp    80105a64 <alltraps>
...
80106795:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
8010679a:	e9 c5 f2 ff ff       	jmp    80105a64 <alltraps>
...
801067a1:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801067a6:	e9 b9 f2 ff ff       	jmp    80105a64 <alltraps>
...
801067ad:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801067b2:	e9 ad f2 ff ff       	jmp    80105a64 <alltraps>
...
801067b9:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801067be:	e9 a1 f2 ff ff       	jmp    80105a64 <alltraps>
...
801067c5:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801067ca:	e9 95 f2 ff ff       	jmp    80105a64 <alltraps>
...
801067d1:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
801067d6:	e9 89 f2 ff ff       	jmp    80105a64 <alltraps>
...
801067dd:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
801067e2:	e9 7d f2 ff ff       	jmp    80105a64 <alltraps>
...
801067e9:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801067ee:	e9 71 f2 ff ff       	jmp    80105a64 <alltraps>
...
801067f5:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801067fa:	e9 65 f2 ff ff       	jmp    80105a64 <alltraps>
...
80106801:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106806:	e9 59 f2 ff ff       	jmp    80105a64 <alltraps>
...
8010680d:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80106812:	e9 4d f2 ff ff       	jmp    80105a64 <alltraps>
...
80106819:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010681e:	e9 41 f2 ff ff       	jmp    80105a64 <alltraps>
...
80106825:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
8010682a:	e9 35 f2 ff ff       	jmp    80105a64 <alltraps>
...
80106831:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106836:	e9 29 f2 ff ff       	jmp    80105a64 <alltraps>
...
8010683d:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80106842:	e9 1d f2 ff ff       	jmp    80105a64 <alltraps>
...
80106849:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010684e:	e9 11 f2 ff ff       	jmp    80105a64 <alltraps>
...
80106855:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
8010685a:	e9 05 f2 ff ff       	jmp    80105a64 <alltraps>
...
80106861:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106866:	e9 f9 f1 ff ff       	jmp    80105a64 <alltraps>
...
8010686d:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80106872:	e9 ed f1 ff ff       	jmp    80105a64 <alltraps>
...
80106879:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010687e:	e9 e1 f1 ff ff       	jmp    80105a64 <alltraps>
...
80106885:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
8010688a:	e9 d5 f1 ff ff       	jmp    80105a64 <alltraps>
...
80106891:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106896:	e9 c9 f1 ff ff       	jmp    80105a64 <alltraps>
...
8010689d:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801068a2:	e9 bd f1 ff ff       	jmp    80105a64 <alltraps>
...
801068a9:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801068ae:	e9 b1 f1 ff ff       	jmp    80105a64 <alltraps>
...
801068b5:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801068ba:	e9 a5 f1 ff ff       	jmp    80105a64 <alltraps>
...
801068c1:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
801068c6:	e9 99 f1 ff ff       	jmp    80105a64 <alltraps>
...
801068cd:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
801068d2:	e9 8d f1 ff ff       	jmp    80105a64 <alltraps>
...
801068d9:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
801068de:	e9 81 f1 ff ff       	jmp    80105a64 <alltraps>
...
801068e5:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
801068ea:	e9 75 f1 ff ff       	jmp    80105a64 <alltraps>
...
801068f1:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
801068f6:	e9 69 f1 ff ff       	jmp    80105a64 <alltraps>
...
801068fd:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80106902:	e9 5d f1 ff ff       	jmp    80105a64 <alltraps>
...
80106909:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010690e:	e9 51 f1 ff ff       	jmp    80105a64 <alltraps>
...
80106915:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
8010691a:	e9 45 f1 ff ff       	jmp    80105a64 <alltraps>
...
80106921:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106926:	e9 39 f1 ff ff       	jmp    80105a64 <alltraps>
...
8010692d:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80106932:	e9 2d f1 ff ff       	jmp    80105a64 <alltraps>
...
80106939:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010693e:	e9 21 f1 ff ff       	jmp    80105a64 <alltraps>
...
80106945:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
8010694a:	e9 15 f1 ff ff       	jmp    80105a64 <alltraps>
...
80106951:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106956:	e9 09 f1 ff ff       	jmp    80105a64 <alltraps>
...
8010695d:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80106962:	e9 fd f0 ff ff       	jmp    80105a64 <alltraps>
...
80106969:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010696e:	e9 f1 f0 ff ff       	jmp    80105a64 <alltraps>
...
80106975:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
8010697a:	e9 e5 f0 ff ff       	jmp    80105a64 <alltraps>
...
80106981:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106986:	e9 d9 f0 ff ff       	jmp    80105a64 <alltraps>
...
801069d4:	e8 57 bc ff ff       	call   80102630 <kalloc>
...
801069ea:	e8 d1 dd ff ff       	call   801047c0 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106a8d:	68 30 7c 10 80       	push   $0x80107c30
...
80106abe:	73 5b                	jae    80106b1b <deallocuvm.part.0+0x7b>
80106ac0:	89 5d e4             	mov    %ebx,-0x1c(%ebp)
80106ac3:	89 d7                	mov    %edx,%edi
80106ac5:	eb 14                	jmp    80106adb <deallocuvm.part.0+0x3b>
80106ac7:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80106ace:	66 90                	xchg   %ax,%ax
80106ad0:	81 c7 00 10 00 00    	add    $0x1000,%edi
80106ad6:	39 7d e4             	cmp    %edi,-0x1c(%ebp)
80106ad9:	76 40                	jbe    80106b1b <deallocuvm.part.0+0x7b>
    pte = walkpgdir(pgdir, (char*)a, 0);
80106adb:	31 c9                	xor    %ecx,%ecx
80106add:	89 fa                	mov    %edi,%edx
80106adf:	89 f0                	mov    %esi,%eax
80106ae1:	e8 aa fe ff ff       	call   80106990 <walkpgdir>
80106ae6:	89 c3                	mov    %eax,%ebx
    if(!pte)
80106ae8:	85 c0                	test   %eax,%eax
80106aea:	74 44                	je     80106b30 <deallocuvm.part.0+0x90>
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
    else if((*pte & PTE_P) != 0){
80106aec:	8b 00                	mov    (%eax),%eax
80106aee:	a8 01                	test   $0x1,%al
80106af0:	74 de                	je     80106ad0 <deallocuvm.part.0+0x30>
      pa = PTE_ADDR(*pte);
      if(pa == 0)
80106af2:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80106af7:	74 47                	je     80106b40 <deallocuvm.part.0+0xa0>
        panic("kfree");
      char *v = P2V(pa);
      kfree(v);
80106af9:	83 ec 0c             	sub    $0xc,%esp
      char *v = P2V(pa);
80106afc:	05 00 00 00 80       	add    $0x80000000,%eax
80106b01:	81 c7 00 10 00 00    	add    $0x1000,%edi
      kfree(v);
80106b07:	50                   	push   %eax
80106b08:	e8 63 b9 ff ff       	call   80102470 <kfree>
      *pte = 0;
80106b0d:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
80106b13:	83 c4 10             	add    $0x10,%esp
  for(; a  < oldsz; a += PGSIZE){
80106b16:	39 7d e4             	cmp    %edi,-0x1c(%ebp)
80106b19:	77 c0                	ja     80106adb <deallocuvm.part.0+0x3b>
    }
  }
  return newsz;
}
80106b1b:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106b1e:	8d 65 f4             	lea    -0xc(%ebp),%esp
80106b21:	5b                   	pop    %ebx
80106b22:	5e                   	pop    %esi
80106b23:	5f                   	pop    %edi
80106b24:	5d                   	pop    %ebp
...
80106b2d:	8d 76 00             	lea    0x0(%esi),%esi
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
80106b30:	89 fa                	mov    %edi,%edx
80106b32:	81 e2 00 00 c0 ff    	and    $0xffc00000,%edx
80106b38:	8d ba 00 00 40 00    	lea    0x400000(%edx),%edi
80106b3e:	eb 96                	jmp    80106ad6 <deallocuvm.part.0+0x36>
        panic("kfree");
80106b40:	83 ec 0c             	sub    $0xc,%esp
80106b43:	68 46 75 10 80       	push   $0x80107546
...
80106b57:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106b5a:	e8 11 ce ff ff       	call   80103970 <cpuid>
  pd[0] = size-1;
80106b5f:	ba 2f 00 00 00       	mov    $0x2f,%edx
80106b64:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
80106b6a:	66 89 55 f2          	mov    %dx,-0xe(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80106b6e:	c7 80 58 28 11 80 ff 	movl   $0xffff,-0x7feed7a8(%eax)
80106b75:	ff 00 00 
80106b78:	c7 80 5c 28 11 80 00 	movl   $0xcf9a00,-0x7feed7a4(%eax)
80106b7f:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106b82:	c7 80 60 28 11 80 ff 	movl   $0xffff,-0x7feed7a0(%eax)
80106b89:	ff 00 00 
80106b8c:	c7 80 64 28 11 80 00 	movl   $0xcf9200,-0x7feed79c(%eax)
80106b93:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106b96:	c7 80 68 28 11 80 ff 	movl   $0xffff,-0x7feed798(%eax)
80106b9d:	ff 00 00 
80106ba0:	c7 80 6c 28 11 80 00 	movl   $0xcffa00,-0x7feed794(%eax)
80106ba7:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106baa:	c7 80 70 28 11 80 ff 	movl   $0xffff,-0x7feed790(%eax)
80106bb1:	ff 00 00 
80106bb4:	c7 80 74 28 11 80 00 	movl   $0xcff200,-0x7feed78c(%eax)
80106bbb:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
80106bbe:	05 50 28 11 80       	add    $0x80112850,%eax
  pd[1] = (uint)p;
...
80106be4:	a1 04 58 11 80       	mov    0x80115804,%eax
80106be9:	05 00 00 00 80       	add    $0x80000000,%eax
}
...
80106c0d:	8b 75 08             	mov    0x8(%ebp),%esi
  if(p == 0)
80106c10:	85 f6                	test   %esi,%esi
80106c12:	0f 84 cb 00 00 00    	je     80106ce3 <switchuvm+0xe3>
  if(p->kstack == 0)
80106c18:	8b 46 08             	mov    0x8(%esi),%eax
80106c1b:	85 c0                	test   %eax,%eax
80106c1d:	0f 84 da 00 00 00    	je     80106cfd <switchuvm+0xfd>
  if(p->pgdir == 0)
80106c23:	8b 46 04             	mov    0x4(%esi),%eax
80106c26:	85 c0                	test   %eax,%eax
80106c28:	0f 84 c2 00 00 00    	je     80106cf0 <switchuvm+0xf0>
  pushcli();
80106c2e:	e8 7d d9 ff ff       	call   801045b0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106c33:	e8 c8 cc ff ff       	call   80103900 <mycpu>
80106c38:	89 c3                	mov    %eax,%ebx
80106c3a:	e8 c1 cc ff ff       	call   80103900 <mycpu>
80106c3f:	89 c7                	mov    %eax,%edi
80106c41:	e8 ba cc ff ff       	call   80103900 <mycpu>
80106c46:	83 c7 08             	add    $0x8,%edi
80106c49:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106c4c:	e8 af cc ff ff       	call   80103900 <mycpu>
80106c51:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80106c54:	ba 67 00 00 00       	mov    $0x67,%edx
80106c59:	66 89 bb 9a 00 00 00 	mov    %di,0x9a(%ebx)
80106c60:	83 c0 08             	add    $0x8,%eax
80106c63:	66 89 93 98 00 00 00 	mov    %dx,0x98(%ebx)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106c6a:	bf ff ff ff ff       	mov    $0xffffffff,%edi
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106c6f:	83 c1 08             	add    $0x8,%ecx
80106c72:	c1 e8 18             	shr    $0x18,%eax
80106c75:	c1 e9 10             	shr    $0x10,%ecx
80106c78:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
80106c7e:	88 8b 9c 00 00 00    	mov    %cl,0x9c(%ebx)
80106c84:	b9 99 40 00 00       	mov    $0x4099,%ecx
80106c89:	66 89 8b 9d 00 00 00 	mov    %cx,0x9d(%ebx)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80106c90:	bb 10 00 00 00       	mov    $0x10,%ebx
  mycpu()->gdt[SEG_TSS].s = 0;
80106c95:	e8 66 cc ff ff       	call   80103900 <mycpu>
80106c9a:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80106ca1:	e8 5a cc ff ff       	call   80103900 <mycpu>
80106ca6:	66 89 58 10          	mov    %bx,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80106caa:	8b 5e 08             	mov    0x8(%esi),%ebx
80106cad:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106cb3:	e8 48 cc ff ff       	call   80103900 <mycpu>
80106cb8:	89 58 0c             	mov    %ebx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106cbb:	e8 40 cc ff ff       	call   80103900 <mycpu>
80106cc0:	66 89 78 6e          	mov    %di,0x6e(%eax)
  asm volatile("ltr %0" : : "r" (sel));
80106cc4:	b8 28 00 00 00       	mov    $0x28,%eax
80106cc9:	0f 00 d8             	ltr    %ax
  lcr3(V2P(p->pgdir));  // switch to process's address space
80106ccc:	8b 46 04             	mov    0x4(%esi),%eax
80106ccf:	05 00 00 00 80       	add    $0x80000000,%eax
  asm volatile("movl %0,%%cr3" : : "r" (val));
80106cd4:	0f 22 d8             	mov    %eax,%cr3
}
80106cd7:	8d 65 f4             	lea    -0xc(%ebp),%esp
80106cda:	5b                   	pop    %ebx
80106cdb:	5e                   	pop    %esi
80106cdc:	5f                   	pop    %edi
80106cdd:	5d                   	pop    %ebp
  popcli();
80106cde:	e9 1d d9 ff ff       	jmp    80104600 <popcli>
    panic("switchuvm: no process");
80106ce3:	83 ec 0c             	sub    $0xc,%esp
80106ce6:	68 36 7c 10 80       	push   $0x80107c36
80106ceb:	e8 a0 96 ff ff       	call   80100390 <panic>
    panic("switchuvm: no pgdir");
80106cf0:	83 ec 0c             	sub    $0xc,%esp
80106cf3:	68 61 7c 10 80       	push   $0x80107c61
80106cf8:	e8 93 96 ff ff       	call   80100390 <panic>
    panic("switchuvm: no kstack");
80106cfd:	83 ec 0c             	sub    $0xc,%esp
80106d00:	68 4c 7c 10 80       	push   $0x80107c4c
80106d05:	e8 86 96 ff ff       	call   80100390 <panic>
...
80106d20:	8b 75 10             	mov    0x10(%ebp),%esi
80106d23:	8b 7d 08             	mov    0x8(%ebp),%edi
80106d26:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(sz >= PGSIZE)
80106d29:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
80106d2f:	77 4b                	ja     80106d7c <inituvm+0x6c>
  mem = kalloc();
80106d31:	e8 fa b8 ff ff       	call   80102630 <kalloc>
  memset(mem, 0, PGSIZE);
80106d36:	83 ec 04             	sub    $0x4,%esp
80106d39:	68 00 10 00 00       	push   $0x1000
  mem = kalloc();
80106d3e:	89 c3                	mov    %eax,%ebx
  memset(mem, 0, PGSIZE);
80106d40:	6a 00                	push   $0x0
80106d42:	50                   	push   %eax
80106d43:	e8 78 da ff ff       	call   801047c0 <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
80106d48:	58                   	pop    %eax
80106d49:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106d4f:	5a                   	pop    %edx
80106d50:	6a 06                	push   $0x6
80106d52:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106d57:	31 d2                	xor    %edx,%edx
80106d59:	50                   	push   %eax
80106d5a:	89 f8                	mov    %edi,%eax
80106d5c:	e8 af fc ff ff       	call   80106a10 <mappages>
  memmove(mem, init, sz);
80106d61:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106d64:	89 75 10             	mov    %esi,0x10(%ebp)
80106d67:	83 c4 10             	add    $0x10,%esp
80106d6a:	89 5d 08             	mov    %ebx,0x8(%ebp)
80106d6d:	89 45 0c             	mov    %eax,0xc(%ebp)
}
...
80106d76:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106d77:	e9 e4 da ff ff       	jmp    80104860 <memmove>
    panic("inituvm: more than a page");
80106d7c:	83 ec 0c             	sub    $0xc,%esp
80106d7f:	68 75 7c 10 80       	push   $0x80107c75
...
80106da0:	8b 75 18             	mov    0x18(%ebp),%esi
  if((uint) addr % PGSIZE != 0)
80106da3:	a9 ff 0f 00 00       	test   $0xfff,%eax
80106da8:	0f 85 99 00 00 00    	jne    80106e47 <loaduvm+0xb7>
  for(i = 0; i < sz; i += PGSIZE){
80106dae:	01 f0                	add    %esi,%eax
80106db0:	89 f3                	mov    %esi,%ebx
80106db2:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(readi(ip, P2V(pa), offset+i, n) != n)
80106db5:	8b 45 14             	mov    0x14(%ebp),%eax
80106db8:	01 f0                	add    %esi,%eax
80106dba:	89 45 e0             	mov    %eax,-0x20(%ebp)
  for(i = 0; i < sz; i += PGSIZE){
80106dbd:	85 f6                	test   %esi,%esi
80106dbf:	75 15                	jne    80106dd6 <loaduvm+0x46>
80106dc1:	eb 6d                	jmp    80106e30 <loaduvm+0xa0>
80106dc3:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80106dc7:	90                   	nop
80106dc8:	81 eb 00 10 00 00    	sub    $0x1000,%ebx
80106dce:	89 f0                	mov    %esi,%eax
80106dd0:	29 d8                	sub    %ebx,%eax
80106dd2:	39 c6                	cmp    %eax,%esi
80106dd4:	76 5a                	jbe    80106e30 <loaduvm+0xa0>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80106dd6:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80106dd9:	8b 45 08             	mov    0x8(%ebp),%eax
80106ddc:	31 c9                	xor    %ecx,%ecx
80106dde:	29 da                	sub    %ebx,%edx
80106de0:	e8 ab fb ff ff       	call   80106990 <walkpgdir>
80106de5:	85 c0                	test   %eax,%eax
80106de7:	74 51                	je     80106e3a <loaduvm+0xaa>
    pa = PTE_ADDR(*pte);
80106de9:	8b 00                	mov    (%eax),%eax
    if(readi(ip, P2V(pa), offset+i, n) != n)
80106deb:	8b 4d e0             	mov    -0x20(%ebp),%ecx
    if(sz - i < PGSIZE)
80106dee:	bf 00 10 00 00       	mov    $0x1000,%edi
    pa = PTE_ADDR(*pte);
80106df3:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    if(sz - i < PGSIZE)
80106df8:	81 fb ff 0f 00 00    	cmp    $0xfff,%ebx
80106dfe:	0f 46 fb             	cmovbe %ebx,%edi
    if(readi(ip, P2V(pa), offset+i, n) != n)
80106e01:	29 d9                	sub    %ebx,%ecx
80106e03:	05 00 00 00 80       	add    $0x80000000,%eax
80106e08:	57                   	push   %edi
80106e09:	51                   	push   %ecx
80106e0a:	50                   	push   %eax
80106e0b:	ff 75 10             	pushl  0x10(%ebp)
80106e0e:	e8 4d ac ff ff       	call   80101a60 <readi>
80106e13:	83 c4 10             	add    $0x10,%esp
80106e16:	39 f8                	cmp    %edi,%eax
80106e18:	74 ae                	je     80106dc8 <loaduvm+0x38>
}
...
80106e3d:	68 8f 7c 10 80       	push   $0x80107c8f
80106e42:	e8 49 95 ff ff       	call   80100390 <panic>
    panic("loaduvm: addr must be page aligned");
80106e47:	83 ec 0c             	sub    $0xc,%esp
80106e4a:	68 30 7d 10 80       	push   $0x80107d30
80106e4f:	e8 3c 95 ff ff       	call   80100390 <panic>
...
80106e6a:	83 ec 1c             	sub    $0x1c,%esp
  if(newsz >= KERNBASE)
80106e6d:	8b 45 10             	mov    0x10(%ebp),%eax
{
80106e70:	8b 7d 08             	mov    0x8(%ebp),%edi
  if(newsz >= KERNBASE)
80106e73:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106e76:	85 c0                	test   %eax,%eax
80106e78:	0f 88 b2 00 00 00    	js     80106f30 <allocuvm+0xd0>
  if(newsz < oldsz)
80106e7e:	3b 45 0c             	cmp    0xc(%ebp),%eax
    return oldsz;
80106e81:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(newsz < oldsz)
80106e84:	0f 82 96 00 00 00    	jb     80106f20 <allocuvm+0xc0>
  a = PGROUNDUP(oldsz);
80106e8a:	8d b0 ff 0f 00 00    	lea    0xfff(%eax),%esi
80106e90:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
  for(; a < newsz; a += PGSIZE){
80106e96:	39 75 10             	cmp    %esi,0x10(%ebp)
80106e99:	77 40                	ja     80106edb <allocuvm+0x7b>
80106e9b:	e9 83 00 00 00       	jmp    80106f23 <allocuvm+0xc3>
    memset(mem, 0, PGSIZE);
80106ea0:	83 ec 04             	sub    $0x4,%esp
80106ea3:	68 00 10 00 00       	push   $0x1000
80106ea8:	6a 00                	push   $0x0
80106eaa:	50                   	push   %eax
80106eab:	e8 10 d9 ff ff       	call   801047c0 <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
80106eb0:	58                   	pop    %eax
80106eb1:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106eb7:	5a                   	pop    %edx
80106eb8:	6a 06                	push   $0x6
80106eba:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106ebf:	89 f2                	mov    %esi,%edx
80106ec1:	50                   	push   %eax
80106ec2:	89 f8                	mov    %edi,%eax
80106ec4:	e8 47 fb ff ff       	call   80106a10 <mappages>
80106ec9:	83 c4 10             	add    $0x10,%esp
80106ecc:	85 c0                	test   %eax,%eax
80106ece:	78 78                	js     80106f48 <allocuvm+0xe8>
  for(; a < newsz; a += PGSIZE){
80106ed0:	81 c6 00 10 00 00    	add    $0x1000,%esi
80106ed6:	39 75 10             	cmp    %esi,0x10(%ebp)
80106ed9:	76 48                	jbe    80106f23 <allocuvm+0xc3>
    mem = kalloc();
80106edb:	e8 50 b7 ff ff       	call   80102630 <kalloc>
80106ee0:	89 c3                	mov    %eax,%ebx
    if(mem == 0){
80106ee2:	85 c0                	test   %eax,%eax
80106ee4:	75 ba                	jne    80106ea0 <allocuvm+0x40>
      cprintf("allocuvm out of memory\n");
80106ee6:	83 ec 0c             	sub    $0xc,%esp
80106ee9:	68 ad 7c 10 80       	push   $0x80107cad
80106eee:	e8 bd 97 ff ff       	call   801006b0 <cprintf>
  if(newsz >= oldsz)
80106ef3:	8b 45 0c             	mov    0xc(%ebp),%eax
80106ef6:	83 c4 10             	add    $0x10,%esp
80106ef9:	39 45 10             	cmp    %eax,0x10(%ebp)
80106efc:	74 32                	je     80106f30 <allocuvm+0xd0>
80106efe:	8b 55 10             	mov    0x10(%ebp),%edx
80106f01:	89 c1                	mov    %eax,%ecx
80106f03:	89 f8                	mov    %edi,%eax
80106f05:	e8 96 fb ff ff       	call   80106aa0 <deallocuvm.part.0>
      return 0;
80106f0a:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
}
...
80106f2e:	66 90                	xchg   %ax,%ax
    return 0;
80106f30:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
}
...
80106f4b:	68 c5 7c 10 80       	push   $0x80107cc5
80106f50:	e8 5b 97 ff ff       	call   801006b0 <cprintf>
  if(newsz >= oldsz)
80106f55:	8b 45 0c             	mov    0xc(%ebp),%eax
80106f58:	83 c4 10             	add    $0x10,%esp
80106f5b:	39 45 10             	cmp    %eax,0x10(%ebp)
80106f5e:	74 0c                	je     80106f6c <allocuvm+0x10c>
80106f60:	8b 55 10             	mov    0x10(%ebp),%edx
80106f63:	89 c1                	mov    %eax,%ecx
80106f65:	89 f8                	mov    %edi,%eax
80106f67:	e8 34 fb ff ff       	call   80106aa0 <deallocuvm.part.0>
      kfree(mem);
80106f6c:	83 ec 0c             	sub    $0xc,%esp
80106f6f:	53                   	push   %ebx
80106f70:	e8 fb b4 ff ff       	call   80102470 <kfree>
      return 0;
80106f75:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
...
80106f97:	8b 55 0c             	mov    0xc(%ebp),%edx
80106f9a:	8b 4d 10             	mov    0x10(%ebp),%ecx
80106f9d:	8b 45 08             	mov    0x8(%ebp),%eax
  if(newsz >= oldsz)
80106fa0:	39 d1                	cmp    %edx,%ecx
80106fa2:	73 0c                	jae    80106fb0 <deallocuvm+0x20>
}
80106fa4:	5d                   	pop    %ebp
80106fa5:	e9 f6 fa ff ff       	jmp    80106aa0 <deallocuvm.part.0>
...
80106fd2:	74 55                	je     80107029 <freevm+0x69>
  if(newsz >= oldsz)
80106fd4:	31 c9                	xor    %ecx,%ecx
80106fd6:	ba 00 00 00 80       	mov    $0x80000000,%edx
80106fdb:	89 f0                	mov    %esi,%eax
80106fdd:	89 f3                	mov    %esi,%ebx
80106fdf:	e8 bc fa ff ff       	call   80106aa0 <deallocuvm.part.0>
    panic("freevm: no pgdir");
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
80106fe4:	8d be 00 10 00 00    	lea    0x1000(%esi),%edi
80106fea:	eb 0b                	jmp    80106ff7 <freevm+0x37>
80106fec:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80106ff0:	83 c3 04             	add    $0x4,%ebx
80106ff3:	39 df                	cmp    %ebx,%edi
...
8010700e:	e8 5d b4 ff ff       	call   80102470 <kfree>
80107013:	83 c4 10             	add    $0x10,%esp
  for(i = 0; i < NPDENTRIES; i++){
80107016:	39 df                	cmp    %ebx,%edi
...
80107023:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80107024:	e9 47 b4 ff ff       	jmp    80102470 <kfree>
    panic("freevm: no pgdir");
...
80107047:	56                   	push   %esi
80107048:	53                   	push   %ebx
  if((pgdir = (pde_t*)kalloc()) == 0)
80107049:	e8 e2 b5 ff ff       	call   80102630 <kalloc>
8010704e:	89 c6                	mov    %eax,%esi
80107050:	85 c0                	test   %eax,%eax
80107052:	74 42                	je     80107096 <setupkvm+0x56>
  memset(pgdir, 0, PGSIZE);
80107054:	83 ec 04             	sub    $0x4,%esp
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107057:	bb 80 a4 10 80       	mov    $0x8010a480,%ebx
  memset(pgdir, 0, PGSIZE);
8010705c:	68 00 10 00 00       	push   $0x1000
80107061:	6a 00                	push   $0x0
80107063:	50                   	push   %eax
80107064:	e8 57 d7 ff ff       	call   801047c0 <memset>
80107069:	83 c4 10             	add    $0x10,%esp
                (uint)k->phys_start, k->perm) < 0) {
8010706c:	8b 43 04             	mov    0x4(%ebx),%eax
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
8010706f:	83 ec 08             	sub    $0x8,%esp
80107072:	8b 4b 08             	mov    0x8(%ebx),%ecx
80107075:	ff 73 0c             	pushl  0xc(%ebx)
80107078:	8b 13                	mov    (%ebx),%edx
8010707a:	50                   	push   %eax
8010707b:	29 c1                	sub    %eax,%ecx
8010707d:	89 f0                	mov    %esi,%eax
8010707f:	e8 8c f9 ff ff       	call   80106a10 <mappages>
80107084:	83 c4 10             	add    $0x10,%esp
80107087:	85 c0                	test   %eax,%eax
80107089:	78 15                	js     801070a0 <setupkvm+0x60>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
8010708b:	83 c3 10             	add    $0x10,%ebx
8010708e:	81 fb c0 a4 10 80    	cmp    $0x8010a4c0,%ebx
80107094:	75 d6                	jne    8010706c <setupkvm+0x2c>
}
80107096:	8d 65 f8             	lea    -0x8(%ebp),%esp
...
801070c7:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
801070ca:	e8 71 ff ff ff       	call   80107040 <setupkvm>
801070cf:	a3 04 58 11 80       	mov    %eax,0x80115804
  lcr3(V2P(kpgdir));   // switch to the kernel page table
801070d4:	05 00 00 00 80       	add    $0x80000000,%eax
801070d9:	0f 22 d8             	mov    %eax,%cr3
}
801070dc:	c9                   	leave  
801070dd:	c3                   	ret    
...
801070f2:	e8 99 f8 ff ff       	call   80106990 <walkpgdir>
  if(pte == 0)
801070f7:	85 c0                	test   %eax,%eax
801070f9:	74 05                	je     80107100 <clearpteu+0x20>
    panic("clearpteu");
  *pte &= ~PTE_U;
801070fb:	83 20 fb             	andl   $0xfffffffb,(%eax)
}
801070fe:	c9                   	leave  
801070ff:	c3                   	ret    
    panic("clearpteu");
80107100:	83 ec 0c             	sub    $0xc,%esp
80107103:	68 f2 7c 10 80       	push   $0x80107cf2
...
8010711a:	83 ec 1c             	sub    $0x1c,%esp
  ...
  if((d = setupkvm()) == 0)
8010711d:	e8 1e ff ff ff       	call   80107040 <setupkvm>
80107122:	89 45 e0             	mov    %eax,-0x20(%ebp)
80107125:	85 c0                	test   %eax,%eax
80107127:	0f 84 9b 00 00 00    	je     801071c8 <copyuvm+0xb8>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
8010712d:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80107130:	85 c9                	test   %ecx,%ecx
80107132:	0f 84 90 00 00 00    	je     801071c8 <copyuvm+0xb8>
80107138:	31 f6                	xor    %esi,%esi
8010713a:	eb 46                	jmp    80107182 <copyuvm+0x72>
...
80107143:	81 c7 00 00 00 80    	add    $0x80000000,%edi
80107149:	68 00 10 00 00       	push   $0x1000
8010714e:	57                   	push   %edi
8010714f:	50                   	push   %eax
80107150:	e8 0b d7 ff ff       	call   80104860 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
80107155:	58                   	pop    %eax
80107156:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
8010715c:	5a                   	pop    %edx
8010715d:	ff 75 e4             	pushl  -0x1c(%ebp)
80107160:	b9 00 10 00 00       	mov    $0x1000,%ecx
80107165:	89 f2                	mov    %esi,%edx
80107167:	50                   	push   %eax
80107168:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010716b:	e8 a0 f8 ff ff       	call   80106a10 <mappages>
80107170:	83 c4 10             	add    $0x10,%esp
80107173:	85 c0                	test   %eax,%eax
80107175:	78 61                	js     801071d8 <copyuvm+0xc8>
  for(i = 0; i < sz; i += PGSIZE){
80107177:	81 c6 00 10 00 00    	add    $0x1000,%esi
8010717d:	39 75 0c             	cmp    %esi,0xc(%ebp)
80107180:	76 46                	jbe    801071c8 <copyuvm+0xb8>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80107182:	8b 45 08             	mov    0x8(%ebp),%eax
80107185:	31 c9                	xor    %ecx,%ecx
80107187:	89 f2                	mov    %esi,%edx
80107189:	e8 02 f8 ff ff       	call   80106990 <walkpgdir>
8010718e:	85 c0                	test   %eax,%eax
80107190:	74 61                	je     801071f3 <copyuvm+0xe3>
    if(!(*pte & PTE_P))
80107192:	8b 00                	mov    (%eax),%eax
80107194:	a8 01                	test   $0x1,%al
80107196:	74 4e                	je     801071e6 <copyuvm+0xd6>
    pa = PTE_ADDR(*pte);
80107198:	89 c7                	mov    %eax,%edi
    flags = PTE_FLAGS(*pte);
8010719a:	25 ff 0f 00 00       	and    $0xfff,%eax
8010719f:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    pa = PTE_ADDR(*pte);
801071a2:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
801071a8:	e8 83 b4 ff ff       	call   80102630 <kalloc>
801071ad:	89 c3                	mov    %eax,%ebx
801071af:	85 c0                	test   %eax,%eax
801071b1:	75 8d                	jne    80107140 <copyuvm+0x30>
    }
  }
  return d;
...
801071b6:	ff 75 e0             	pushl  -0x20(%ebp)
801071b9:	e8 02 fe ff ff       	call   80106fc0 <freevm>
  return 0;
801071be:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
801071c5:	83 c4 10             	add    $0x10,%esp
}
801071c8:	8b 45 e0             	mov    -0x20(%ebp),%eax
801071cb:	8d 65 f4             	lea    -0xc(%ebp),%esp
801071ce:	5b                   	pop    %ebx
801071cf:	5e                   	pop    %esi
801071d0:	5f                   	pop    %edi
801071d1:	5d                   	pop    %ebp
...
801071dc:	e8 8f b2 ff ff       	call   80102470 <kfree>
      goto bad;
801071e1:	83 c4 10             	add    $0x10,%esp
801071e4:	eb cd                	jmp    801071b3 <copyuvm+0xa3>
      panic("copyuvm: page not present");
801071e6:	83 ec 0c             	sub    $0xc,%esp
801071e9:	68 16 7d 10 80       	push   $0x80107d16
801071ee:	e8 9d 91 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
801071f3:	83 ec 0c             	sub    $0xc,%esp
801071f6:	68 fc 7c 10 80       	push   $0x80107cfc
...
80107212:	e8 79 f7 ff ff       	call   80106990 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
80107219:	c9                   	leave  
  if((*pte & PTE_U) == 0)
8010721a:	89 c2                	mov    %eax,%edx
  return (char*)P2V(PTE_ADDR(*pte));
8010721c:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  if((*pte & PTE_U) == 0)
80107221:	83 e2 05             	and    $0x5,%edx
  return (char*)P2V(PTE_ADDR(*pte));
80107224:	05 00 00 00 80       	add    $0x80000000,%eax
80107229:	83 fa 05             	cmp    $0x5,%edx
8010722c:	ba 00 00 00 00       	mov    $0x0,%edx
80107231:	0f 45 c2             	cmovne %edx,%eax
}
80107234:	c3                   	ret    
...
8010724d:	8b 75 14             	mov    0x14(%ebp),%esi
80107250:	8b 55 0c             	mov    0xc(%ebp),%edx
  ...
  buf = (char*)p;
  while(len > 0){
80107253:	85 f6                	test   %esi,%esi
80107255:	75 3c                	jne    80107293 <copyout+0x53>
80107257:	eb 67                	jmp    801072c0 <copyout+0x80>
...
80107265:	29 d3                	sub    %edx,%ebx
80107267:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    if(n > len)
8010726d:	39 f3                	cmp    %esi,%ebx
8010726f:	0f 47 de             	cmova  %esi,%ebx
      n = len;
    memmove(pa0 + (va - va0), buf, n);
80107272:	29 fa                	sub    %edi,%edx
80107274:	83 ec 04             	sub    $0x4,%esp
80107277:	01 c2                	add    %eax,%edx
80107279:	53                   	push   %ebx
8010727a:	ff 75 10             	pushl  0x10(%ebp)
8010727d:	52                   	push   %edx
8010727e:	e8 dd d5 ff ff       	call   80104860 <memmove>
    len -= n;
    buf += n;
80107283:	01 5d 10             	add    %ebx,0x10(%ebp)
    va = va0 + PGSIZE;
80107286:	8d 97 00 10 00 00    	lea    0x1000(%edi),%edx
  while(len > 0){
8010728c:	83 c4 10             	add    $0x10,%esp
8010728f:	29 de                	sub    %ebx,%esi
80107291:	74 2d                	je     801072c0 <copyout+0x80>
    va0 = (uint)PGROUNDDOWN(va);
80107293:	89 d7                	mov    %edx,%edi
    pa0 = uva2ka(pgdir, (char*)va0);
80107295:	83 ec 08             	sub    $0x8,%esp
    va0 = (uint)PGROUNDDOWN(va);
80107298:	89 55 0c             	mov    %edx,0xc(%ebp)
8010729b:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    pa0 = uva2ka(pgdir, (char*)va0);
801072a1:	57                   	push   %edi
801072a2:	ff 75 08             	pushl  0x8(%ebp)
801072a5:	e8 56 ff ff ff       	call   80107200 <uva2ka>
    if(pa0 == 0)
801072aa:	83 c4 10             	add    $0x10,%esp
801072ad:	85 c0                	test   %eax,%eax
801072af:	75 af                	jne    80107260 <copyout+0x20>
  }
  return 0;
}
801072b1:	8d 65 f4             	lea    -0xc(%ebp),%esp
      return -1;
