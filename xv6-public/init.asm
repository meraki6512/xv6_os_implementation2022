...
main(void)
{
  ...
  ab:	68 59 08 00 00       	push   $0x859
  b0:	e8 d6 02 00 00       	call   38b <exec>
      printf(1, "init: exec sh failed\n");
  b5:	5a                   	pop    %edx
  b6:	59                   	pop    %ecx
  b7:	68 5c 08 00 00       	push   $0x85c
  bc:	6a 01                	push   $0x1
...
printf(int fd, const char *fmt, ...)
{
 ...
 644:	eb 1a                	jmp    660 <printf+0x1a0>
          s = "(null)";
 646:	bb 7b 08 00 00       	mov    $0x87b,%ebx
        while(*s != 0){
 ...
 6b6:	73 10                	jae    6c8 <free+0x38>
{
 ...
 6e1:	5b                   	pop    %ebx
  freep = p;
 6e2:	a3 38 0b 00 00       	mov    %eax,0xb38
}
 6e7:	5e                   	pop    %esi
 6e8:	5f                   	pop    %edi
 6e9:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 72d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 730:	8b 3d 38 0b 00 00    	mov    0xb38,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 779:	8b 3d 38 0b 00 00    	mov    0xb38,%edi
 ...
 7a2:	e8 e9 fe ff ff       	call   690 <free>
  return freep;
 7a7:	a1 38 0b 00 00       	mov    0xb38,%eax
 ...
 7d4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 7d7:	a3 38 0b 00 00       	mov    %eax,0xb38
}
 ...
 7ee:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 7f0:	c7 05 38 0b 00 00 3c 	movl   $0xb3c,0xb38
 7f7:	0b 00 00 
    base.s.size = 0;
 7fa:	bf 3c 0b 00 00       	mov    $0xb3c,%edi
    base.s.ptr = freep = prevp = &base;
 7ff:	c7 05 3c 0b 00 00 3c 	movl   $0xb3c,0xb3c
 806:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 809:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 80b:	c7 05 40 0b 00 00 00 	movl   $0x0,0xb40
 812:	00 00 00 
    if(p->s.size >= nunits){
