...
_ssu_trace:     file format elf32-i386
...
int main(int argc, char**argv){
  ...
  31:	50                   	push   %eax
  32:	e8 84 03 00 00       	call   3bb <trace>
	
	if ((pid = fork())<0){
  37:	e8 cf 02 00 00       	call   30b <fork>
  3c:	83 c4 10             	add    $0x10,%esp
  3f:	85 c0                	test   %eax,%eax
  41:	78 3a                	js     7d <main+0x7d>
		printf(1, "ERROR: fork failed\n"); //2?check
		exit();
	}
	else if (pid==0){
  43:	75 2e                	jne    73 <main+0x73>
		//trace(mask);
		exec(argv[2], &argv[2]);
  45:	83 ec 08             	sub    $0x8,%esp
  48:	8d 43 08             	lea    0x8(%ebx),%eax
  4b:	50                   	push   %eax
  4c:	ff 73 08             	pushl  0x8(%ebx)
  4f:	e8 f7 02 00 00       	call   34b <exec>
	else{
		wait();
		exit();
	}
  ...
  60:	51                   	push   %ecx
  61:	51                   	push   %ecx
  62:	68 e8 07 00 00       	push   $0x7e8
  67:	6a 01                	push   $0x1
  69:	e8 12 04 00 00       	call   480 <printf>
		exit();
  6e:	e8 a0 02 00 00       	call   313 <exit>
		wait();
  73:	e8 a3 02 00 00       	call   31b <wait>
		exit();
  78:	e8 96 02 00 00       	call   313 <exit>
		printf(1, "ERROR: fork failed\n"); //2?check
  7d:	50                   	push   %eax
  7e:	50                   	push   %eax
  7f:	68 fd 07 00 00       	push   $0x7fd
  84:	6a 01                	push   $0x1
  ...
  90:	52                   	push   %edx
  91:	52                   	push   %edx
  92:	68 14 08 00 00       	push   $0x814
  97:	6a 01                	push   $0x1
  99:	e8 e2 03 00 00       	call   480 <printf>
		exit();
  9e:	e8 70 02 00 00       	call   313 <exit>
  a3:	66 90                	xchg   %ax,%ax
  a5:	66 90                	xchg   %ax,%ax
  a7:	66 90                	xchg   %ax,%ax
  a9:	66 90                	xchg   %ax,%ax
 ...
 3dc:	89 d1                	mov    %edx,%ecx
{
 ...
 409:	0f b6 92 40 08 00 00 	movzbl 0x840(%edx),%edx
 ...
 44e:	56                   	push   %esi
 44f:	57                   	push   %edi
 450:	e8 de fe ff ff       	call   333 <write>
  while(--i >= 0)
...
printf(int fd, const char *fmt, ...)
{
 ...
 4c9:	e8 65 fe ff ff       	call   333 <write>
 ...
 529:	e8 05 fe ff ff       	call   333 <write>
        putc(fd, c);
      } else {
 ...
 53d:	e8 f1 fd ff ff       	call   333 <write>
  for(i = 0; fmt[i]; i++){
 ...
 5b1:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 5b4:	e8 7a fd ff ff       	call   333 <write>
        ap++;
 ...
 604:	eb 1a                	jmp    620 <printf+0x1a0>
          s = "(null)";
 606:	bb 37 08 00 00       	mov    $0x837,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 655:	a1 fc 0a 00 00       	mov    0xafc,%eax
{
 ...
 676:	73 10                	jae    688 <free+0x38>
{
 ...
 6a1:	5b                   	pop    %ebx
  freep = p;
 6a2:	a3 fc 0a 00 00       	mov    %eax,0xafc
}
 6a7:	5e                   	pop    %esi
 6a8:	5f                   	pop    %edi
 6a9:	5d                   	pop    %ebp
 ...
 6c7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ca:	a3 fc 0a 00 00       	mov    %eax,0xafc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6ed:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6f0:	8b 3d fc 0a 00 00    	mov    0xafc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 739:	8b 3d fc 0a 00 00    	mov    0xafc,%edi
 ...
 74b:	e8 4b fc ff ff       	call   39b <sbrk>
  if(p == (char*)-1) 
 ...
 762:	e8 e9 fe ff ff       	call   650 <free>
  return freep;
 767:	a1 fc 0a 00 00       	mov    0xafc,%eax
 ...
 794:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 797:	a3 fc 0a 00 00       	mov    %eax,0xafc
}
 ...
 7ae:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 7b0:	c7 05 fc 0a 00 00 00 	movl   $0xb00,0xafc
 7b7:	0b 00 00 
    base.s.size = 0;
 7ba:	bf 00 0b 00 00       	mov    $0xb00,%edi
    base.s.ptr = freep = prevp = &base;
 7bf:	c7 05 00 0b 00 00 00 	movl   $0xb00,0xb00
 7c6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
