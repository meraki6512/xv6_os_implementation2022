...
_memsizetest:     file format elf32-i386
...
int main(void){
  ...
  12:	51                   	push   %ecx
	int msize = memsize();
  13:	e8 7b 03 00 00       	call   393 <memsize>
	printf(1, "The process is using %dB\n", msize);
  18:	83 ec 04             	sub    $0x4,%esp
  1b:	50                   	push   %eax
  1c:	68 c8 07 00 00       	push   $0x7c8
  21:	6a 01                	push   $0x1
  23:	e8 38 04 00 00       	call   460 <printf>

	char *tmp = (char*) malloc (SIZE* sizeof(char));
  28:	c7 04 24 00 08 00 00 	movl   $0x800,(%esp)
  2f:	e8 8c 06 00 00       	call   6c0 <malloc>
  34:	89 c3                	mov    %eax,%ebx
	printf(1, "Allocating more memory\n");
  36:	58                   	pop    %eax
  37:	5a                   	pop    %edx
  38:	68 e2 07 00 00       	push   $0x7e2
  3d:	6a 01                	push   $0x1
  3f:	e8 1c 04 00 00       	call   460 <printf>
	msize = memsize();
  44:	e8 4a 03 00 00       	call   393 <memsize>
	printf(1, "The process is using %dB\n", msize);
  49:	83 c4 0c             	add    $0xc,%esp
  4c:	50                   	push   %eax
  4d:	68 c8 07 00 00       	push   $0x7c8
  52:	6a 01                	push   $0x1
  54:	e8 07 04 00 00       	call   460 <printf>

	free(tmp);
  59:	89 1c 24             	mov    %ebx,(%esp)
  5c:	e8 cf 05 00 00       	call   630 <free>
	printf(1, "Freeing memory\n");
  61:	59                   	pop    %ecx
  62:	5b                   	pop    %ebx
  63:	68 fa 07 00 00       	push   $0x7fa
  68:	6a 01                	push   $0x1
  6a:	e8 f1 03 00 00       	call   460 <printf>
	msize = memsize();
  6f:	e8 1f 03 00 00       	call   393 <memsize>
	printf(1, "The process is using %dB\n", msize);
  74:	83 c4 0c             	add    $0xc,%esp
  77:	50                   	push   %eax
  78:	68 c8 07 00 00       	push   $0x7c8
  7d:	6a 01                	push   $0x1
  7f:	e8 dc 03 00 00       	call   460 <printf>

	exit();
  84:	e8 6a 02 00 00       	call   2f3 <exit>
  89:	66 90                	xchg   %ax,%ax
  8b:	66 90                	xchg   %ax,%ax
  8d:	66 90                	xchg   %ax,%ax
  8f:	90                   	nop
...
printf(int fd, const char *fmt, ...)
{
 ...
 5e4:	eb 1a                	jmp    600 <printf+0x1a0>
          s = "(null)";
 5e6:	bb 0a 08 00 00       	mov    $0x80a,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 635:	a1 c0 0a 00 00       	mov    0xac0,%eax
{
 ...
 656:	73 10                	jae    668 <free+0x38>
{
 ...
 681:	5b                   	pop    %ebx
  freep = p;
 682:	a3 c0 0a 00 00       	mov    %eax,0xac0
}
 687:	5e                   	pop    %esi
 688:	5f                   	pop    %edi
 689:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 6cd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6d0:	8b 3d c0 0a 00 00    	mov    0xac0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 719:	8b 3d c0 0a 00 00    	mov    0xac0,%edi
 ...
 742:	e8 e9 fe ff ff       	call   630 <free>
  return freep;
 747:	a1 c0 0a 00 00       	mov    0xac0,%eax
 ...
 774:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 777:	a3 c0 0a 00 00       	mov    %eax,0xac0
}
 ...
 797:	0a 00 00 
    base.s.size = 0;
 79a:	bf c4 0a 00 00       	mov    $0xac4,%edi
    base.s.ptr = freep = prevp = &base;
 79f:	c7 05 c4 0a 00 00 c4 	movl   $0xac4,0xac4
 7a6:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7a9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7ab:	c7 05 c8 0a 00 00 00 	movl   $0x0,0xac8
 7b2:	00 00 00 
    if(p->s.size >= nunits){
